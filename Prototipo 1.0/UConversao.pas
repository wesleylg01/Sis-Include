...
procedure TForm1.SpeedButton2Click(Sender: TObject);
 var
  B : TBitmap;
  textoAtual: String;
  I, contador, limite: Integer;
begin
if memo1.Text = '' then
   begin
   Application.MessageBox('Favor carregar um arquivo antes de converter!','Atenção.',MB_ICONWARNING+MB_OK);
   exit;
   end;
...
limite:= StrToInt(Edit1.Text);
  for I := 0 to Memo1.Lines.Count -1 do
      ...
      if Length(textoAtual) >=limite then
         begin
         B := TQRCode.GetBitmapImage(textoAtual, 1, 3);
      ...
      end;      // salva o restante do texto que não ultrapassou os 1100 caracter
      B := TQRCode.GetBitmapImage(textoAtual, 1, 3);
         image1.Picture.Bitmap.Assign(B);
         B.Free;
