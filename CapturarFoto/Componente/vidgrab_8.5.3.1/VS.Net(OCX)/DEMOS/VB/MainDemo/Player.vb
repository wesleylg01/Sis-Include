...
#End Region
    ...
    Public Sub RefreshControls()
        updPlayerSpeedRatio.Value = MainForm.DefInstance.AxVideoGrabberNET1.PlayerSpeedRatio * 10
        updPlayerFastSeekSpeed.Value = MainForm.DefInstance.AxVideoGrabberNET1.PlayerFastSeekSpeedRatio
        btnAutoPlay.Checked = MainForm.DefInstance.AxVideoGrabberNET1.AutoStartPlayer
        chkPlayerAudioRendering.Checked = MainForm.DefInstance.AxVideoGrabberNET1.PlayerAudioRendering
        chkUseClock.Checked = MainForm.DefInstance.AxVideoGrabberNET1.UseClock
        chkRefreshPausedDisplay.Checked = MainForm.DefInstance.AxVideoGrabberNET1.PlayerRefreshPausedDisplay
    End Sub
    ...
    Private Sub btnAutoPlay_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAutoPlay.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AutoStartPlayer = btnAutoPlay.Checked
    End Sub
    ...
    Private Sub btnClipDuration_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClipDuration.Click
        ...
        If MainForm.DefInstance.AxVideoGrabberNET1.AVIDuration(edtPlayerFileName.Text, AVIDuration, AVIFrameCount) Then
    ...
    Private Sub btnClipGeneralInfo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClipGeneralInfo.Click
        ...
        If MainForm.DefInstance.AxVideoGrabberNET1.AVIInfo(edtPlayerFileName.Text, AVIDuration, AVIFrameCount, VideoWidth, VideoHeight, VideoFrameRateFps, AvgBitRate, AudioChannels, AudioSamplesPerSec, AudioBitsPerSample, VideoCodec, AudioCodec) Then
    ...
    Private Sub btnOpenLastClipPlayed_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenLastClipPlayed.Click
        If MainForm.DefInstance.AxVideoGrabberNET1.Last_Clip_Played <> "" Then
            edtPlayerFileName.Text = MainForm.DefInstance.AxVideoGrabberNET1.Last_Clip_Played
            MainForm.DefInstance.AxVideoGrabberNET1.PlayerFileName = edtPlayerFileName.Text
            MainForm.DefInstance.AxVideoGrabberNET1.OpenPlayer()
        End If
    End Sub
    ...
    Private Sub btnOpenLastClipRecorded_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenLastClipRecorded.Click
        If MainForm.DefInstance.AxVideoGrabberNET1.Last_Recording_FileName <> "" Then
            edtPlayerFileName.Text = MainForm.DefInstance.AxVideoGrabberNET1.Last_Recording_FileName
            MainForm.DefInstance.AxVideoGrabberNET1.PlayerFileName = edtPlayerFileName.Text
            MainForm.DefInstance.AxVideoGrabberNET1.OpenPlayer()
        End If
    End Sub
    ...
    Private Sub btnPlayerCloseFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPlayerCloseFile.Click
        MainForm.DefInstance.AxVideoGrabberNET1.ClosePlayer()
    End Sub
    ...
    Private Sub chkPlayerAudioRendering_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPlayerAudioRendering.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.PlayerAudioRendering = chkPlayerAudioRendering.Checked
    End Sub
    ...
    Private Sub chkRefreshPausedDisplay_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkRefreshPausedDisplay.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.PlayerRefreshPausedDisplay = chkRefreshPausedDisplay.Checked
    End Sub
    ...
    Private Sub updPlayerSpeedRatio_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles updPlayerSpeedRatio.ValueChanged
        MainForm.DefInstance.AxVideoGrabberNET1.PlayerSpeedRatio = updPlayerSpeedRatio.Value / 10
        updSpeedRadioValue.Text = MainForm.DefInstance.AxVideoGrabberNET1.PlayerSpeedRatio.ToString("0.0")
    End Sub
    ...
    Private Sub updPlayerFastSeekSpeed_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles updPlayerFastSeekSpeed.ValueChanged
        MainForm.DefInstance.AxVideoGrabberNET1.PlayerFastSeekSpeedRatio = updPlayerFastSeekSpeed.Value
    End Sub
    ...
    Private Sub btnHeaderInfo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHeaderInfo.Click
        ...
        AddLog(MainForm.DefInstance.mmoLog, "Title: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Title))
        AddLog(MainForm.DefInstance.mmoLog, "Description: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Description))
        AddLog(MainForm.DefInstance.mmoLog, "Author: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Author))
        AddLog(MainForm.DefInstance.mmoLog, "Copyright: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Copyright))
        AddLog(MainForm.DefInstance.mmoLog, "Album Artist: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_AlbumArtist))
        AddLog(MainForm.DefInstance.mmoLog, "Album Title: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_AlbumTitle))
        AddLog(MainForm.DefInstance.mmoLog, "Composer: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Composer))
        AddLog(MainForm.DefInstance.mmoLog, "Content Distributor: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_ContentDistributor))
        AddLog(MainForm.DefInstance.mmoLog, "Director: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Director))
        AddLog(MainForm.DefInstance.mmoLog, "Encoding Time: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_EncodingTime))
        AddLog(MainForm.DefInstance.mmoLog, "Genre: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Genre))
        AddLog(MainForm.DefInstance.mmoLog, "Language: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Language))
        AddLog(MainForm.DefInstance.mmoLog, "Parental Rating: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_ParentalRating))
        AddLog(MainForm.DefInstance.mmoLog, "Producer: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Producer))
        AddLog(MainForm.DefInstance.mmoLog, "Provider: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Provider))
        AddLog(MainForm.DefInstance.mmoLog, "ToolName: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_ToolName))
        AddLog(MainForm.DefInstance.mmoLog, "Tool Version: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_ToolVersion))
        AddLog(MainForm.DefInstance.mmoLog, "Writer: " + MainForm.DefInstance.AxVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, vidgrab_NET.TxHeaderAttribute.ha_Writer))
    ...
    Private Sub chkUseClock_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkUseClock.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.UseClock = chkUseClock.Checked
    End Sub
    ...
    Private Sub chkLoop_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkLoop.CheckedChanged
        ' the code is in the AxVideoGrabberNET1_OnPlayerEndOfStream event of MainForm
    End Sub
    ...
    Private Sub btnPlaylistAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPlaylistAdd.Click
        ...
        If fd.ShowDialog() = Windows.Forms.DialogResult.OK Then
            For i = 0 To fd.FileNames.Length - 1
                MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Add, fd.FileNames.GetValue(i))
    ...
    Private Sub btnPlaylistPlay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPlaylistPlay.Click
        MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Play, "")
    End Sub
    ...
    Private Sub btnPlaylistNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPlaylistNext.Click
        MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Next, "")
    End Sub
    ...
    Private Sub btnPlaylistPrevious_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPlaylistPrevious.Click
        MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Previous, "")
    End Sub
    ...
    Private Sub btnPlaylistStopAfterCurrent_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPlaylistStopAfterCurrent.Click
        MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Stop, "")
    End Sub
    ...
    Private Sub chkPlaylistLoop_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPlaylistLoop.CheckedChanged
        If chkPlaylistLoop.Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Loop, "")
        Else
            MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_NoLoop, "")
        End If
    End Sub
    ...
    Private Sub chkPlaylistRandom_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPlaylistRandom.CheckedChanged
        If chkPlaylistRandom.Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Random, "")
        Else
            MainForm.DefInstance.AxVideoGrabberNET1.Playlist(vidgrab_NET.TxPlaylist.pl_Sequential, "")
        End If
    End Sub
    ...
    Private Sub btnOpenAtFrames_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenAtFrames.Click
        ...
        If IsNumeric(txtStartFrame.Text) And IsNumeric(txtStopFrame.Text) Then
            MainForm.DefInstance.AxVideoGrabberNET1.OpenPlayerAtFramePositions(Convert.ToDouble(txtStartFrame.Text), Convert.ToDouble(txtStopFrame.Text), chkKeepBounds.Checked, chkReopen.Checked)
        End If
    End Sub
    ...
    Private Sub btnOpenAtTimes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenAtTimes.Click
        ...
        If IsNumeric(txtStartTime.Text) And IsNumeric(txtStopTime.Text) Then
            MainForm.DefInstance.AxVideoGrabberNET1.OpenPlayerAtTimePositions(Convert.ToDouble(txtStartTime.Text), Convert.ToDouble(txtStopTime.Text), chkKeepBounds.Checked, chkReopen.Checked)
        End If
    End Sub
    ...
    Private Sub btnOpenDVD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenDVD.Click
        If edtPlayerFileName.Text = "Choose a video or audio clip..." Then
            MainForm.DefInstance.AxVideoGrabberNET1.PlayerFileName = ""  ' this will use the default DVD
        Else
            MainForm.DefInstance.AxVideoGrabberNET1.PlayerFileName = edtPlayerFileName.Text
        End If
        If MainForm.DefInstance.AxVideoGrabberNET1.OpenDVD() Then
            edtPlayerFileName.Text = MainForm.DefInstance.AxVideoGrabberNET1.PlayerFileName ' to reflect the real DVD file path used
        End If
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        AddLog(MainForm.DefInstance.mmoLog, "total DVD duration: " + Str(MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_TotalDuration, 0)))

        NumberOfTitles = MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, vidgrab_NET.TxDVDInfoType.dvd_NumberOfTitles, 0)
        AddLog(MainForm.DefInstance.mmoLog, "number of titles: " + Str(MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_NumberOfTitles, 0)))

        For i = 1 To NumberOfTitles
            AddLog(MainForm.DefInstance.mmoLog, "TITLE " + Str(i) + ":")
            AddLog(MainForm.DefInstance.mmoLog, "duration in seconds: " + Str(MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, vidgrab_NET.TxDVDInfoType.dvd_TotalDuration, i)))
            AddLog(MainForm.DefInstance.mmoLog, "frame count: " + Str(MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, vidgrab_NET.TxDVDInfoType.dvd_TitleFrameCount, i)))
            AddLog(MainForm.DefInstance.mmoLog, "frame rate: " + Str(MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, vidgrab_NET.TxDVDInfoType.dvd_TitleFrameRate, i)))
            AddLog(MainForm.DefInstance.mmoLog, "video resolution X: " + Str(MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, vidgrab_NET.TxDVDInfoType.dvd_SourceResolutionX, i)))
            AddLog(MainForm.DefInstance.mmoLog, "video resolution Y: " + Str(MainForm.DefInstance.AxVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, vidgrab_NET.TxDVDInfoType.dvd_SourceResolutionY, i)))
        Next
