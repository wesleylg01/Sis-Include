...
#End Region
    ...
    Public Sub RefreshControls()
        lblFirstSelectIPCamera.Visible = (MainForm.DefInstance.AxVideoGrabberNET1.VideoSource <> vidgrab_NET.TxVideoSource.vs_IPCamera)
    End Sub
    ...
    Private Sub edtIPCameraURL_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtIPCameraURL.TextChanged
        MainForm.DefInstance.AxVideoGrabberNET1.IPCameraURL = edtIPCameraURL.Text
    End Sub
    ...
    Private Sub edtIPCamUserName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtIPCamUserName.TextChanged
        MainForm.DefInstance.AxVideoGrabberNET1.SetAuthentication(vidgrab_NET.TxAuthenticationType.at_IPCamera, edtIPCamUserName.Text, edtIPCamPassword.Text)
    End Sub
    ...
    Private Sub edtIPCamConnectionTimeout_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtIPCamConnectionTimeout.TextChanged
        If IsNumeric(edtIPCamConnectionTimeout.Text) Then
            MainForm.DefInstance.AxVideoGrabberNET1.SetIPCameraSetting(vidgrab_NET.TxIPCameraSetting.ips_ConnectionTimeout, Convert.ToInt32(edtIPCamConnectionTimeout.Text))
        End If
    End Sub
    ...
    Private Sub edtIPCamReceiveTimeout_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtIPCamReceiveTimeout.TextChanged
        If (IsNumeric(edtIPCamReceiveTimeout.Text)) Then
            MainForm.DefInstance.AxVideoGrabberNET1.SetIPCameraSetting(vidgrab_NET.TxIPCameraSetting.ips_ReceiveTimeout, Convert.ToInt32(edtIPCamReceiveTimeout.Text))
        End If
    End Sub
    ...
    Private Sub btnIPCamStartPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIPCamStartPreview.Click
        If MainForm.DefInstance.AxVideoGrabberNET1.VideoSource <> vidgrab_NET.TxVideoSource.vs_IPCamera Then
            MainForm.DefInstance.AxVideoGrabberNET1.VideoSource = vidgrab_NET.TxVideoSource.vs_IPCamera
    ...
    Private Sub btnIPCamSendCommand_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIPCamSendCommand.Click
        If MainForm.DefInstance.AxVideoGrabberNET1.SendIPCameraCommand(edtIPCamCommand.Text) Then
