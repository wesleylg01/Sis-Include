...
#End Region
    ...
    Public Sub RefreshControls()
        SetRadioButtonInGroupUsingTag((rdgRecordingMethod), MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod)
        SetRadioButtonInGroupUsingTag((rdgCompressMode), MainForm.DefInstance.AxVideoGrabberNET1.CompressionMode)
        SetRadioButtonInGroupUsingTag((rdgCompressType), MainForm.DefInstance.AxVideoGrabberNET1.CompressionType)
        SetRadioButtonInGroupUsingTag((rdgRecordingTimer), MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimer)

        edtPreallocSize.Text = MainForm.DefInstance.AxVideoGrabberNET1.PreallocCapFileSizeInMB
        chkRecordingCanPause.Checked = MainForm.DefInstance.AxVideoGrabberNET1.RecordingCanPause
        chkPauseCreatesNewFile.Checked = MainForm.DefInstance.AxVideoGrabberNET1.RecordingPauseCreatesNewFile
        chkRecordingOnMotion.Checked = MainForm.DefInstance.AxVideoGrabberNET1.RecordingOnMotion_Enabled

        chkPreallocFile.Checked = MainForm.DefInstance.AxVideoGrabberNET1.PreallocCapFileEnabled
        chkOpenDML.Checked = MainForm.DefInstance.AxVideoGrabberNET1.AVIFormatOpenDML
        chkPreserveNativeFormat.Checked = MainForm.DefInstance.AxVideoGrabberNET1.RecordingInNativeFormat

        chkAudioRecording.Checked = MainForm.DefInstance.AxVideoGrabberNET1.AudioRecording

        AssignListToComboBox((cboVideoCompressors), MainForm.DefInstance.AxVideoGrabberNET1.VideoCompressors, MainForm.DefInstance.AxVideoGrabberNET1.VideoCompressor)
        AssignListToComboBox((cboAudioCompressors), MainForm.DefInstance.AxVideoGrabberNET1.AudioCompressors, MainForm.DefInstance.AxVideoGrabberNET1.AudioCompressor)
        AssignListToComboBox((cboMultiplexers), MainForm.DefInstance.AxVideoGrabberNET1.Multiplexers, MainForm.DefInstance.AxVideoGrabberNET1.Multiplexer)

        AssignListToComboBox(cboAudioFormats, MainForm.DefInstance.AxVideoGrabberNET1.AudioFormats, MainForm.DefInstance.AxVideoGrabberNET1.AudioFormat)

        btnPauseRecording.Enabled = MainForm.DefInstance.AxVideoGrabberNET1.RecordingCanPause
        btnResumeRecording.Enabled = MainForm.DefInstance.AxVideoGrabberNET1.RecordingCanPause

        rdgCompressMode.Enabled = True
        rdgCompressType.Enabled = True

        chkScreenRecordWindow.Enabled = IIf(MainForm.DefInstance.AxVideoGrabberNET1.VideoSource = Vidgrab_NET.TxVideoSource.vs_ScreenRecording, True, False)

        If Not MainForm.DefInstance.AxVideoGrabberNET1.AudioRecording Then
            'Recording.rdgCompressType.ItemIndex = 0
            rdgCompressType.Enabled = False
        End If

        chkOpenDML.Enabled = IIf(MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod = Vidgrab_NET.TxRecordingMethod.rm_AVI, True, False)

        Dim CanUseCompressors As Boolean = (MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod <> Vidgrab_NET.TxRecordingMethod.rm_ASF) _
            And (MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod <> Vidgrab_NET.TxRecordingMethod.rm_SendToDV)

        Dim CanUseMultiplexer As Boolean = CanUseCompressors And (MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod <> Vidgrab_NET.TxRecordingMethod.rm_AVI)
    ...
    Private Sub btnVideoCompressorSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVideoCompressorSettings.Click
        MainForm.DefInstance.AxVideoGrabberNET1.ShowDialog(Vidgrab_NET.TxDialog.dlg_VideoCompressor)
    End Sub
    ...
    Private Sub btnAudioCompressorSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAudioCompressorSettings.Click
        MainForm.DefInstance.AxVideoGrabberNET1.ShowDialog(Vidgrab_NET.TxDialog.dlg_AudioCompressor)
    End Sub

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        MainForm.DefInstance.AxVideoGrabberNET1.ShowDialog(Vidgrab_NET.TxDialog.dlg_Multiplexer)
    End Sub
    ...
    Private Sub btnSaveVideoCompressorSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveVideoCompressorSettings.Click
        ...
        SaveDlg.FileName = MainForm.AxVideoGrabberNET1.VideoCompressorName + " (" + MainForm.AxVideoGrabberNET1.RecordingMethod.ToString() + ").txt"
        If SaveDlg.ShowDialog() = DialogResult.OK Then
            ' be sure to have selected the RecordingMethod and VideoCompressor before invoking SaveCompressorSettings...

            MainForm.AxVideoGrabberNET1.SaveCompressorSettingsToTextFile(True, MainForm.AxVideoGrabberNET1.VideoCompressor, SaveDlg.FileName)
    ...
    Private Sub btnSaveAudioCompressorSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveAudioCompressorSettings.Click
        Dim SaveDlg As SaveFileDialog = New SaveFileDialog
        SaveDlg.FileName = MainForm.AxVideoGrabberNET1.AudioCompressorName + " (" + MainForm.AxVideoGrabberNET1.RecordingMethod.ToString() + ").txt"
        If SaveDlg.ShowDialog() = DialogResult.OK Then
            ' be sure to have selected the RecordingMethod and AudioCompressor before invoking SaveCompressorSettings...

            MainForm.AxVideoGrabberNET1.SaveCompressorSettingsToTextFile(False, MainForm.AxVideoGrabberNET1.AudioCompressor, SaveDlg.FileName)
    ...
    Private Sub btnReloadVideoCompressorSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReloadVideoCompressorSettings.Click
        ...
        If OpenDlg.ShowDialog = DialogResult.OK Then
            ...
            MainForm.AxVideoGrabberNET1.LoadCompressorSettingsFromTextFile(True, MainForm.AxVideoGrabberNET1.VideoCompressor, OpenDlg.FileName)
    ...
    Private Sub btnReloadAudioCompressorSettings_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReloadAudioCompressorSettings.Click
        ...
        If OpenDlg.ShowDialog = DialogResult.OK Then
            ...
            MainForm.AxVideoGrabberNET1.LoadCompressorSettingsFromTextFile(False, MainForm.AxVideoGrabberNET1.AudioCompressor, OpenDlg.FileName)
    ...
    Private Sub btnCreatePreallocFileNow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreatePreallocFileNow.Click
        MainForm.DefInstance.AxVideoGrabberNET1.CreatePreallocCapFile()
    End Sub
    ...
    Private Sub btnPauseRecording_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPauseRecording.Click
        MainForm.DefInstance.AxVideoGrabberNET1.PauseRecording()
    End Sub
    ...
    Private Sub btnRenewRecordingFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRenewRecordingFile.Click
        If chkAVISaveToThisFile.Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.RecordingFileName = edtRecordingFileName.Text
        Else
            MainForm.DefInstance.AxVideoGrabberNET1.RecordingFileName = ""
        End If
        MainForm.DefInstance.AxVideoGrabberNET1.RecordToNewFileNow("", True)
    End Sub
    ...
    Private Sub btnResumeRecording_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnResumeRecording.Click
        MainForm.DefInstance.AxVideoGrabberNET1.ResumeRecording()
    End Sub
    ...
    Private Sub btnStartRecordingControlled_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartRecordingControlled.Click
        ...
        MainForm.DefInstance.AxVideoGrabberNET1.HoldRecording = True
        MainForm.DefInstance.AxVideoGrabberNET1.StartRecording()
        ...
        If (MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimer = Vidgrab_NET.TxRecordingTimer.rt_StartRecording) And (MainForm.DefInstance.AxVideoGrabberNET1.VideoSource = Vidgrab_NET.TxVideoSource.vs_ScreenRecording) And (chkScreenRecordWindow.Checked = True) And (lngScreenRecordingWindow > 0) Then
    ...
    Private Sub rdgRecordingTimer1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgRecordingTimer1.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimer = Vidgrab_NET.TxRecordingTimer.rt_Disabled
    End Sub
    ...
    Private Sub rdgRecordingTimer2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgRecordingTimer2.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimer = Vidgrab_NET.TxRecordingTimer.rt_RecordToNewFile
    End Sub
    ...
    Private Sub rdgRecordingTimer3_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgRecordingTimer3.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimer = Vidgrab_NET.TxRecordingTimer.rt_StopRecording
    End Sub
    ...
    Private Sub rdgRecordingTimer4_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgRecordingTimer4.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimer = Vidgrab_NET.TxRecordingTimer.rt_StartRecording
    End Sub
    ...
    Private Sub edtRecordingTimer_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtRecordingTimer.TextChanged
        If Val(edtRecordingTimer.Text) > 0 Then
            MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimerInterval = Val(edtRecordingTimer.Text)
        Else
            MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimerInterval = 0
        End If
    End Sub
    ...
    Private Sub btnStartRecordingImmediately_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartRecordingImmediately.Click
        ...
        '  after RecordingTimerInterval regardless of HoldRecording setting,
        '  and OnRecordingReadyToStart event is not fired
        MainForm.DefInstance.AxVideoGrabberNET1.HoldRecording = False ' let's start recording as soon as the graph is built.
        If (MainForm.DefInstance.AxVideoGrabberNET1.RecordingTimer = Vidgrab_NET.TxRecordingTimer.rt_StartRecording) And (MainForm.DefInstance.AxVideoGrabberNET1.VideoSource = Vidgrab_NET.TxVideoSource.vs_ScreenRecording) And (chkScreenRecordWindow.Checked = True) And (lngScreenRecordingWindow > 0) Then
            ' for screen recording of a window, this code will make it the top window before recording start;
            '  window handle was gathered by EnumerateWindows in OnEnumerateWindows
            ' (see demo procedures in VideoSource form btnScreenRecordingWindow and SetEnumerateWindows)
    ...
    Private Sub btnStopRecording_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStopRecording.Click
        MainForm.DefInstance.AxVideoGrabberNET1.StopRecording()
    End Sub
    ...
    Private Sub cboAudioCompressors_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboAudioCompressors.SelectedIndexChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioCompressor = cboAudioCompressors.SelectedIndex
    End Sub
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboMultiplexers.SelectedIndexChanged
        MainForm.DefInstance.AxVideoGrabberNET1.Multiplexer = cboMultiplexers.SelectedIndex
    End Sub
    ...
    Private Sub cboAudioFormats_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboAudioFormats.SelectedIndexChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioFormat = cboAudioFormats.SelectedIndex
    End Sub
    ...
    Private Sub cboVideoCompressors_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboVideoCompressors.SelectedIndexChanged
        MainForm.DefInstance.AxVideoGrabberNET1.VideoCompressor = cboVideoCompressors.SelectedIndex
    End Sub
    ...
    Private Sub chkAudioRecording_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkAudioRecording.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioRecording = chkAudioRecording.Checked
    ...
    Private Sub chkOpenDML_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkOpenDML.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AVIFormatOpenDML = chkOpenDML.Checked
    End Sub
    ...
    Private Sub chkPreallocFile_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPreallocFile.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.PreallocCapFileEnabled = chkPreallocFile.Checked
    End Sub
    ...
    Private Sub chkPreserveNativeFormat_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPreserveNativeFormat.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingInNativeFormat = chkPreserveNativeFormat.Checked
    End Sub
    ...
    Private Sub chkRecordingCanPause_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkRecordingCanPause.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingCanPause = chkRecordingCanPause.Checked
        btnPauseRecording.Enabled = MainForm.DefInstance.AxVideoGrabberNET1.RecordingCanPause
        btnResumeRecording.Enabled = MainForm.DefInstance.AxVideoGrabberNET1.RecordingCanPause
    End Sub
    ...
    Private Sub chkPauseCreatesNewFile_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPauseCreatesNewFile.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingPauseCreatesNewFile = chkPauseCreatesNewFile.Checked
    End Sub
    ...
    Private Sub chkRecordingOnMotion_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkRecordingOnMotion.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingOnMotion_Enabled = chkRecordingOnMotion.Checked
    ...
    Private Sub edtPreallocSize_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtPreallocSize.TextChanged
        If IsNumeric(edtPreallocSize.Text) Then
            MainForm.DefInstance.AxVideoGrabberNET1.PreallocCapFileSizeInMB = edtPreallocSize.Text
        End If
    End Sub
    ...
    Private Sub rdgCompressMode_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgCompressModeAfterCapture.CheckedChanged
        If CType(sender, RadioButton).Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.CompressionMode = sender.Tag
        End If
    End Sub
    ...
    Private Sub rdgCompressType_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgCompressTypeAudio.CheckedChanged
        If CType(sender, RadioButton).Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.CompressionType = sender.Tag
        End If
    End Sub
    ...
    Private Sub rdgRecordingMethod_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgRecordingMethodAVI.CheckedChanged, rdgRecordingMethodWMV.CheckedChanged, rdgRecordingMethodSendToDV.CheckedChanged, rdgRecordingMethodMKV.CheckedChanged, rdgRecordingMethodFLV.CheckedChanged, rdgRecordingMethodMP4.CheckedChanged, rdgRecordingMethod_WebM.CheckedChanged
        If CType(sender, RadioButton).Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod = sender.Tag
            RefreshControls()
        End If
    End Sub
