...
#End Region
    ...
    Public Sub RefreshControls()
        SetRadioButtonInGroupUsingTag((rdgVideoRotation), MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Rotation)
        edtCustomRotationAngle.Text = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_RotationCustomAngle

        SetRadioButtonInGroupUsingTag((rdgDeinterlacing), MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Deinterlacing)

        updVideoPixelization.Value = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Pixellization()

        tbrBrightness.Value = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Brightness
        tbrContrast.Value = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Contrast
        tbrSaturation.Value = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Saturation
        tbrHue.Value = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Hue

        chkGreyScale.Checked = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_GrayScale
        chkInvertColors.Checked = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_InvertColors
        chkFlipVertical.Checked = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_FlipVertical
        chkFlipHorizontal.Checked = MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_FlipHorizontal

        chkCroppingEnabled.Checked = MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Enabled
        chkCroppingOutbounds.Checked = MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Outbounds
        edtCroppingWidth.Text = MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Width
        edtCroppingHeight.Text = MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Height
        trkCroppingZoom.Value = MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Zoom * 100

        ' trkCroppingX.Max and trkCroppingY.Max are will be set from the OnResizeVideo event
        trkCroppingY.Value = MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Y
        trkCroppingX.Value = MainForm.DefInstance.AxVideoGrabberNET1.Cropping_X

        lblSWVideoProcessingRequiresFrameGrabber.Visible = IIf(MainForm.DefInstance.AxVideoGrabberNET1.FrameGrabber = vidgrab_NET.TxFrameGrabber.fg_Disabled, True, False)
    ...
    Public Sub RefreshVMR9Processing()
        ...
        If MainForm.DefInstance.AxVideoGrabberNET1.IsVMR9ImageAdjustmentAvailable(True) Then
            With tbrVMR9Brightness
                .Enabled = MainForm.DefInstance.AxVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(True, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Brightness, MinValue, MaxValue, StepSize, DefaultValue, CurrentValue)
                If .Enabled Then
                    .Minimum = MinValue
                    .Maximum = MaxValue
            ...
            With tbrVMR9Contrast
                .Enabled = MainForm.DefInstance.AxVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(True, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Contrast, MinValue, MaxValue, StepSize, DefaultValue, CurrentValue)
                If .Enabled Then
                    .Minimum = MinValue
                    .Maximum = MaxValue
                    .SmallChange = StepSize
            ...
            End With
            With tbrVMR9Hue
                .Enabled = MainForm.DefInstance.AxVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(True, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Hue, MinValue, MaxValue, StepSize, DefaultValue, CurrentValue)
                If .Enabled Then
                    .Minimum = MinValue
                    .Maximum = MaxValue
                    .SmallChange = StepSize
            ...
            With tbrVMR9Saturation
                .Enabled = MainForm.DefInstance.AxVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(True, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Saturation, MinValue, MaxValue, StepSize, DefaultValue, CurrentValue)
                If .Enabled Then
                    .Minimum = MinValue
                    .Maximum = MaxValue
                    .SmallChange = StepSize
    ...
    Private Sub btnCroppingZoomReset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCroppingZoomReset.Click
        ...
        MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Zoom = trkCroppingZoom.Value / 100
    End Sub
    ...
    Private Sub btnResetAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnResetAll.Click
        ...
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Brightness = -tbrBrightness.Value
        tbrContrast.Value = 0
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Contrast = -tbrContrast.Value
        tbrSaturation.Value = 0
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Saturation = -tbrSaturation.Value
        tbrHue.Value = 0
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Hue = -tbrHue.Value
    ...
    Private Sub chkCroppingEnabled_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkCroppingEnabled.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Enabled = chkCroppingEnabled.Checked
    End Sub
    ...
    Private Sub chkCroppingOutbounds_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkCroppingOutbounds.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Outbounds = chkCroppingOutbounds.Checked
    End Sub
    ...
    Private Sub chkFlipHorizontal_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkFlipHorizontal.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_FlipHorizontal = chkFlipHorizontal.Checked
    End Sub
    ...
    Private Sub chkFlipVertical_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkFlipVertical.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_FlipVertical = chkFlipVertical.Checked
    End Sub
    ...
    Private Sub chkGreyScale_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkGreyScale.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_GrayScale = chkGreyScale.Checked
    End Sub
    ...
    Private Sub chkInvertColors_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkInvertColors.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_InvertColors = chkInvertColors.Checked
    End Sub
    ...
    Private Sub edtCroppingHeight_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtCroppingHeight.TextChanged
        If IsNumeric(edtCroppingHeight.Text) Then
            MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Height = edtCroppingHeight.Text
        End If
    End Sub
    ...
    Private Sub edtCroppingWidth_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtCroppingWidth.TextChanged
        If IsNumeric(edtCroppingWidth.Text) Then
            MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Width = edtCroppingWidth.Text
        End If
    End Sub
    ...
    Private Sub rdgDeinterlacing_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgDeinterlacingDisabled.CheckedChanged, rdgDeinterlacingHalfSize.CheckedChanged, rdgDeinterlacingFullSize.CheckedChanged
        If CType(sender, RadioButton).Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Deinterlacing = sender.Tag
        End If
    End Sub
    ...
    Private Sub rdgVideoRotation_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgVideoRotation0.CheckedChanged, rdgVideoRotation1.CheckedChanged, rdgVideoRotation2.CheckedChanged, rdgVideoRotation3.CheckedChanged, rdgVideoRotation4.CheckedChanged, rdgVideoRotation5.CheckedChanged, rdgVideoRotation6.CheckedChanged, rdgVideoRotation7.CheckedChanged, rdgVideoRotation8.CheckedChanged, rdgVideoRotation9.CheckedChanged
        If CType(sender, RadioButton).Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Rotation = sender.Tag
        End If
    End Sub
    ...
    Private Sub trkCroppingX_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles trkCroppingX.Scroll
        ...
        MainForm.DefInstance.AxVideoGrabberNET1.Cropping_X = trkCroppingX.Value
    End Sub

    Private Sub trkCroppingY_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles trkCroppingY.Scroll
        ' trkCroppingX.Max and trkCroppingY.Max are set from the OnResizeVideo event
        MainForm.DefInstance.AxVideoGrabberNET1.Cropping_Y = trkCroppingY.Value
    End Sub
    ...
    Private Sub edtCustomRotationAngle_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles edtCustomRotationAngle.TextChanged
        If IsNumeric(edtCustomRotationAngle.Text) Then
            MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_RotationCustomAngle = edtCustomRotationAngle.Text
        End If
    End Sub
    ...
    Private Sub tbrVMR9Brightness_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrVMR9Brightness.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.SetVMR9ImageAdjustmentValue(True, vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Brightness, tbrVMR9Brightness.Value, False)
    End Sub
    ...
    Private Sub tbrVMR9Contrast_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrVMR9Contrast.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.SetVMR9ImageAdjustmentValue(True, vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Contrast, tbrVMR9Contrast.Value, vmr9FixRange.Checked)
    End Sub
    ...
    Private Sub tbrVMR9Saturation_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrVMR9Saturation.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.SetVMR9ImageAdjustmentValue(True, vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Saturation, tbrVMR9Saturation.Value, vmr9FixRange.Checked)
    End Sub

    Private Sub tbrVMR9Hue_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrVMR9Hue.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.SetVMR9ImageAdjustmentValue(True, vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Hue, tbrVMR9Hue.Value, False)
    End Sub
    ...
    Private Sub updVideoPixelization_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles updVideoPixelization.ValueChanged
        MainForm.DefInstance.AxVideoGrabberNET1.VideoProcessing_Pixellization() = updVideoPixelization.Value
    End Sub
End Class
