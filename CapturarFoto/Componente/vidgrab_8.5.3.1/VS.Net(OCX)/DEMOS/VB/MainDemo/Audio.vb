...
#End Region
    Public Sub RefreshControls()
        AssignListToComboBox(cboAudioDevices, MainForm.DefInstance.AxVideoGrabberNET1.AudioDevices, MainForm.DefInstance.AxVideoGrabberNET1.AudioDevice)

        If MainForm.DefInstance.AxVideoGrabberNET1.AudioDevice >= 0 Then ' if an audio capture device has been selected
            AssignListToComboBox(cboAudioInputs, MainForm.DefInstance.AxVideoGrabberNET1.AudioInputs, MainForm.DefInstance.AxVideoGrabberNET1.AudioInput)
        End If

        tbrAudioInputLevel.Value = MainForm.DefInstance.AxVideoGrabberNET1.AudioInputLevel
        tbrAudioInputBalance.Value = MainForm.DefInstance.AxVideoGrabberNET1.AudioInputBalance
        chkAudioInputMono.Checked = IIf(MainForm.DefInstance.AxVideoGrabberNET1.AudioInputMono, System.Windows.Forms.CheckState.Checked, System.Windows.Forms.CheckState.Unchecked)

        AssignListToComboBox(cboAudioRenderers, MainForm.DefInstance.AxVideoGrabberNET1.AudioRenderers, MainForm.DefInstance.AxVideoGrabberNET1.AudioRenderer)

        chkRenderAudioDevice.Checked = MainForm.DefInstance.AxVideoGrabberNET1.AudioDeviceRendering
        chkMuteAudioRendering.Checked = MainForm.DefInstance.AxVideoGrabberNET1.MuteAudioRendering

        If MainForm.DefInstance.AxVideoGrabberNET1.AudioDevice = -1 Then
            cboAudioDevices.Text = "SELECT AND AUDIO CAPTURE DEVICE IN THIS LIST"
        End If
        If MainForm.DefInstance.AxVideoGrabberNET1.AudioRenderer = -1 Then
    ...
    Private Sub cboAudioDevices_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboAudioDevices.SelectedIndexChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioDevice = cboAudioDevices.SelectedIndex
    End Sub
    ...
    Private Sub btnAudioDeviceDialog_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAudioDeviceDialog.Click
        MainForm.DefInstance.AxVideoGrabberNET1.ShowDialog(vidgrab_NET.TxDialog.dlg_AudioDevice)
    End Sub
    ...
    Private Sub cboAudioInputs_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboAudioInputs.SelectedIndexChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioInput = cboAudioInputs.SelectedIndex
    End Sub
    ...
    Private Sub chkAudioInputMono_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkAudioInputMono.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioInputMono = chkAudioInputMono.Checked
    End Sub
    ...
    Private Sub chkRenderAudioDevice_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkRenderAudioDevice.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioDeviceRendering = chkRenderAudioDevice.Checked
    End Sub
    ...
    Private Sub chkMuteAudioRendering_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkMuteAudioRendering.CheckedChanged
        MainForm.DefInstance.AxVideoGrabberNET1.MuteAudioRendering = chkMuteAudioRendering.Checked
    End Sub
    ...
    Private Sub cboAudioRenderers_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboAudioRenderers.SelectedIndexChanged
        MainForm.DefInstance.AxVideoGrabberNET1.AudioRenderer = cboAudioRenderers.SelectedIndex
    End Sub
    ...
    Private Sub tbrAudioVolume_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrAudioVolume.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.AudioVolume = tbrAudioVolume.Value
    End Sub
    ...
    Private Sub tbrAudioInputLevel_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrAudioInputLevel.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.AudioInputLevel = tbrAudioInputLevel.Value
    End Sub
    ...
    Private Sub tbrAudioInputBalance_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrAudioInputBalance.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.AudioInputBalance = tbrAudioInputBalance.Value
    End Sub
    ...
    Private Sub tbrAudioBalance_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrAudioBalance.Scroll
        MainForm.DefInstance.AxVideoGrabberNET1.AudioBalance = tbrAudioBalance.Value
    End Sub
    ...
    Private Sub rdgVUMeters_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgVUDisabled.CheckedChanged, rdgVUAnalog.CheckedChanged, rdgVUBargraph.CheckedChanged
        ...
        If CType(sender, RadioButton).Checked Then
            Select Case sender.Tag
                Case 0
                    MainForm.DefInstance.AxVideoGrabberNET1.VuMeter = vidgrab_NET.TxVuMeter.vu_Disabled
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_LEFT), vidgrab_NET.TxVUMeterSetting.vu_Handle, Convert.ToUInt32(0))
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_RIGHT), vidgrab_NET.TxVUMeterSetting.vu_Handle, Convert.ToUInt32(0))
                Case 1
                    pnlVUMeterLeft.Width = (pnlVUMeterLeft.Height * 4) / 3
                    pnlVUMeterRight.Width = (pnlVUMeterRight.Height * 4) / 3

                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_LEFT), vidgrab_NET.TxVUMeterSetting.vu_BkgndColor, Convert.ToUInt32(&H0))
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_RIGHT), vidgrab_NET.TxVUMeterSetting.vu_BkgndColor, Convert.ToUInt32(&H0))
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_LEFT), vidgrab_NET.TxVUMeterSetting.vu_Handle, Convert.ToUInt32(pnlVUMeterLeft.Handle.ToInt32()))
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_RIGHT), vidgrab_NET.TxVUMeterSetting.vu_Handle, Convert.ToUInt32(pnlVUMeterRight.Handle.ToInt32()))
                Case 2
                    MainForm.DefInstance.AxVideoGrabberNET1.VuMeter = vidgrab_NET.TxVuMeter.vu_Bargraph

                    pnlVUMeterLeft.Width = (pnlVUMeterLeft.Height * 2) / 10
                    pnlVUMeterRight.Width = (pnlVUMeterRight.Height * 2) / 10

                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_LEFT), vidgrab_NET.TxVUMeterSetting.vu_BkgndColor, Convert.ToUInt32(&H404040))
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_RIGHT), vidgrab_NET.TxVUMeterSetting.vu_BkgndColor, Convert.ToUInt32(&H404040))
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_LEFT), vidgrab_NET.TxVUMeterSetting.vu_Handle, Convert.ToUInt32(pnlVUMeterLeft.Handle.ToInt32()))
                    MainForm.DefInstance.AxVideoGrabberNET1.SetVUMeterSetting(Convert.ToUInt32(VU_RIGHT), vidgrab_NET.TxVUMeterSetting.vu_Handle, Convert.ToUInt32(pnlVUMeterRight.Handle.ToInt32()))
            End Select
        End If
    ...
    Private Sub btnStartAudioRendering_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartAudioRendering.Click
        MainForm.DefInstance.AxVideoGrabberNET1.StartAudioRendering()
        If Not MainForm.DefInstance.AxVideoGrabberNET1.AudioDeviceRendering Then
    ...
    Private Sub btnStartWavRecording_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartWavRecording.Click
        MainForm.DefInstance.AxVideoGrabberNET1.CompressionMode = vidgrab_NET.TxCompressionMode.cm_NoCompression
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod = vidgrab_NET.TxRecordingMethod.rm_AVI
        MainForm.DefInstance.AxVideoGrabberNET1.StartAudioRecording()
    End Sub
    ...
    Private Sub btnSartMP3Recording_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSartMP3Recording.Click
        MainForm.DefInstance.AxVideoGrabberNET1.CompressionMode = vidgrab_NET.TxCompressionMode.cm_CompressOnTheFly
        MainForm.DefInstance.AxVideoGrabberNET1.CompressionType = vidgrab_NET.TxCompressionType.ct_Audio
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod = vidgrab_NET.TxRecordingMethod.rm_AVI
        MainForm.DefInstance.AxVideoGrabberNET1.AudioCompressor = MainForm.DefInstance.AxVideoGrabberNET1.FindIndexInListByName(MainForm.DefInstance.AxVideoGrabberNET1.AudioCompressors, "LAME Audio Encoder", False, True)
        If MainForm.DefInstance.AxVideoGrabberNET1.AudioCompressor = -1 Then
    ...
    Private Sub btnStartWMVRecording_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStartWMVRecording.Click
        MainForm.DefInstance.AxVideoGrabberNET1.CompressionMode = vidgrab_NET.TxCompressionMode.cm_NoCompression
        MainForm.DefInstance.AxVideoGrabberNET1.RecordingMethod = vidgrab_NET.TxRecordingMethod.rm_ASF
        MainForm.DefInstance.AxVideoGrabberNET1.StartAudioRecording()
    End Sub

    Private Sub btnStopAudio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStopAudio.Click
        MainForm.DefInstance.AxVideoGrabberNET1.Stop()
    End Sub
    ...
    Private Sub chkUseAudioOfVideoCaptureDevice_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkUseAudioOfVideoCaptureDevice.CheckedChanged
        If chkUseAudioOfVideoCaptureDevice.Checked Then
            MainForm.DefInstance.AxVideoGrabberNET1.VideoDevice = 0 ' in this demo, by default we choose the 1st
        Else
            MainForm.DefInstance.AxVideoGrabberNET1.VideoDevice = -1 ' this deactivates the video capture device
        End If
    End Sub
