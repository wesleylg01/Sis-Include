...
#End Region
    ...
    Public Sub RefreshControls()
        grbDVCommands.Enabled = MainForm.DefInstance.AxVideoGrabberNET1.IsDigitalVideoIn
    End Sub

    Private Sub SendDVCommand(ByRef DvCommand As vidgrab_NET.TxDVCommand)
        If MainForm.DefInstance.AxVideoGrabberNET1.SendDVCommand(DvCommand) Then
