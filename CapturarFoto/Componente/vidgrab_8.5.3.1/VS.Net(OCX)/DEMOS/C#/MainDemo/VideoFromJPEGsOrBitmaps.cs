...
namespace MainDemo
{
	...
	public class VideoFromJPEGsOrBitmaps : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
        ...
        {
            lblFirstSelectJPEGsOrBitmaps.Visible = (cMainForm.axVideoGrabberNET1.VideoSource != Vidgrab_NET.TxVideoSource.vs_JPEGsOrBitmaps);
        }
        ...
        private void btnStartPreview_Click(object sender, System.EventArgs e)
        {
            ...
            if (cMainForm.axVideoGrabberNET1.VideoSource != Vidgrab_NET.TxVideoSource.vs_JPEGsOrBitmaps) 
            {
                cMainForm.axVideoGrabberNET1.VideoSource = Vidgrab_NET.TxVideoSource.vs_JPEGsOrBitmaps;
