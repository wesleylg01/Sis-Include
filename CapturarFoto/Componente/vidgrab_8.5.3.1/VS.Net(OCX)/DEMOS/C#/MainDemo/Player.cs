...
namespace MainDemo
{
	...
	public class Player : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{
			updPlayerSpeedRatio.Value = (decimal) cMainForm.axVideoGrabberNET1.PlayerSpeedRatio * 10;
			updPlayerFastSeekSpeed.Value = cMainForm.axVideoGrabberNET1.PlayerFastSeekSpeedRatio;
			btnAutoPlay.Checked = cMainForm.axVideoGrabberNET1.AutoStartPlayer;
			chkPlayerAudioRendering.Checked = cMainForm.axVideoGrabberNET1.PlayerAudioRendering;
			chkUseClock.Checked = cMainForm.axVideoGrabberNET1.UseClock;
			chkRefreshPausedDisplay.Checked = cMainForm.axVideoGrabberNET1.PlayerRefreshPausedDisplay;
		}

		private void btnAutoPlay_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.AutoStartPlayer = btnAutoPlay.Checked;
		}
		...
		private void btnClipDuration_Click(object sender, System.EventArgs e)
		{
			...
			if (cMainForm.axVideoGrabberNET1.AVIDuration(edtPlayerFileName.Text,out AVIDuration,out AVIFrameCount)) 
			{
		...
		private void btnClipGeneralInfo_Click(object sender, System.EventArgs e)
		{
			...
			if (cMainForm.axVideoGrabberNET1.AVIInfo(edtPlayerFileName.Text, out AVIDuration, out AVIFrameCount, out VideoWidth, out VideoHeight, out VideoFrameRateFps, out AvgBitRate, out AudioChannels, out AudioSamplesPerSec, out AudioBitsPerSample, out VideoCodec, out AudioCodec))
			{
		...
		{
			if (cMainForm.axVideoGrabberNET1.Last_Clip_Played != "") 
			{
				edtPlayerFileName.Text = cMainForm.axVideoGrabberNET1.Last_Clip_Played;
				cMainForm.axVideoGrabberNET1.PlayerFileName = edtPlayerFileName.Text;
				cMainForm.axVideoGrabberNET1.OpenPlayer();
			}
		}

		private void btnOpenLastClipRecorded_Click(object sender, System.EventArgs e)
		{
			if (cMainForm.axVideoGrabberNET1.Last_Recording_FileName != "") {
				edtPlayerFileName.Text = cMainForm.axVideoGrabberNET1.Last_Recording_FileName;
				cMainForm.axVideoGrabberNET1.PlayerFileName = edtPlayerFileName.Text;
				cMainForm.axVideoGrabberNET1.OpenPlayer();
			}
		}
		...
		{
			cMainForm.axVideoGrabberNET1.ClosePlayer();
		}
		...
		{
			cMainForm.axVideoGrabberNET1.PlayerAudioRendering = chkPlayerAudioRendering.Checked;
		}

		private void chkRefreshPausedDisplay_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.PlayerRefreshPausedDisplay = chkRefreshPausedDisplay.Checked;
		}

		private void updPlayerSpeedRatio_ValueChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.PlayerSpeedRatio = ((double) updPlayerSpeedRatio.Value) / 10;
            updSpeedRadioValue.Text = cMainForm.axVideoGrabberNET1.PlayerSpeedRatio.ToString("0.0");
		}

		private void updPlayerFastSeekSpeed_ValueChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.PlayerFastSeekSpeedRatio = (int) updPlayerFastSeekSpeed.Value;
		}
		...
		private void btnHeaderInfo_Click(object sender, System.EventArgs e)
		{
			...
			AddLog(cMainForm.mmoLog, "Title: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Title));
			AddLog(cMainForm.mmoLog, "Description: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Description));
			AddLog(cMainForm.mmoLog, "Author: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Author));
			AddLog(cMainForm.mmoLog, "Copyright: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Copyright));
			AddLog(cMainForm.mmoLog, "Album Artist: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_AlbumArtist));
			AddLog(cMainForm.mmoLog, "Album Title: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_AlbumTitle));
			AddLog(cMainForm.mmoLog, "Composer: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Composer));
			AddLog(cMainForm.mmoLog, "Content Distributor: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_ContentDistributor));
			AddLog(cMainForm.mmoLog, "Director: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Director));
			AddLog(cMainForm.mmoLog, "Encoding Time: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_EncodingTime));
			AddLog(cMainForm.mmoLog, "Genre: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Genre));
			AddLog(cMainForm.mmoLog, "Language: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Language));
			AddLog(cMainForm.mmoLog, "Parental Rating: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_ParentalRating));
			AddLog(cMainForm.mmoLog, "Producer: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Producer));
			AddLog(cMainForm.mmoLog, "Provider: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Provider));
			AddLog(cMainForm.mmoLog, "ToolName: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_ToolName));
			AddLog(cMainForm.mmoLog, "Tool Version: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_ToolVersion));
			AddLog(cMainForm.mmoLog, "Writer: " + cMainForm.axVideoGrabberNET1.AVIHeaderInfo(edtPlayerFileName.Text, Vidgrab_NET.TxHeaderAttribute.ha_Writer));

		}

		private void chkUseClock_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.UseClock = chkUseClock.Checked;
		}
		...
		private void btnPlaylistAdd_Click(object sender, System.EventArgs e)
		{
			...
			if (fd.ShowDialog() == DialogResult.OK) 
			{
				...
				{
					cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Add, fd.FileNames.GetValue(i).ToString());
		...
		{
			cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Play, "");
		}

		private void btnPlaylistNext_Click(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Next, "");
		}

		private void btnPlaylistPrevious_Click(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Previous, "");
		}

		private void btnPlaylistStopAfterCurrent_Click(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Stop, "");
		}
		...
		private void chkPlaylistLoop_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Loop, "");
			}
			else 
			{
				cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_NoLoop, "");
			}
		}
		...
		private void chkPlaylistRandom_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Random, "");
			}
			else 
			{
				cMainForm.axVideoGrabberNET1.Playlist(Vidgrab_NET.TxPlaylist.pl_Sequential, "");
			}
		}
		...
		private void btnOpenAtFrames_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.OpenPlayerAtFramePositions (Convert.ToDouble (txtStartFrame.Text), Convert.ToDouble (txtStopFrame.Text), chkKeepBounds.Checked, chkReopen.Checked);
			}
		}
		...
		private void btnOpenAtTimes_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.OpenPlayerAtTimePositions (Convert.ToDouble (txtStartTime.Text), Convert.ToDouble (txtStopTime.Text), chkKeepBounds.Checked, chkReopen.Checked);
			}
		}
        ...
        private void btnOpenDVD_Click(object sender, EventArgs e)
        {
            if (edtPlayerFileName.Text == "Choose a video or audio clip...") {
                cMainForm.axVideoGrabberNET1.PlayerFileName = ""; // this will use the default DVD
            }
            else {
                cMainForm.axVideoGrabberNET1.PlayerFileName = edtPlayerFileName.Text;
            }
            if (cMainForm.axVideoGrabberNET1.OpenDVD()) {
                edtPlayerFileName.Text = cMainForm.axVideoGrabberNET1.PlayerFileName; // to reflect the real DVD path name used
            }
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            AddLog(cMainForm.mmoLog, "total DVD duration: " + cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_TotalDuration, 0).ToString());

            NumberOfTitles = Convert.ToInt32 (cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_NumberOfTitles, 0));
            AddLog(cMainForm.mmoLog, "number of titles: " + cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_NumberOfTitles, 0).ToString());

            for (i = 1; i <= NumberOfTitles; i++) {
                AddLog(cMainForm.mmoLog, "TITLE " + i.ToString() + ":");
                AddLog(cMainForm.mmoLog, "duration in seconds: " + cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_TotalDuration, i).ToString());
                AddLog(cMainForm.mmoLog, "frame count: " + cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_TitleFrameCount, i).ToString());
                AddLog(cMainForm.mmoLog, "frame rate: " + cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_TitleFrameRate, i).ToString());
                AddLog(cMainForm.mmoLog, "video resolution X: " + cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_SourceResolutionX, i).ToString());
                AddLog(cMainForm.mmoLog, "video resolution Y: " + cMainForm.axVideoGrabberNET1.DVDInfo(edtPlayerFileName.Text, Vidgrab_NET.TxDVDInfoType.dvd_SourceResolutionY, i).ToString());
            }
