...
namespace MainDemo
{
	...
	public class miscCameraControl : SubForm  // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
	{
		...
		private void InitTrackBar(CheckBox chkAuto, Button btnDefault, TrackBar tbrValue, Vidgrab_NET.TxCameraControl Setting)
		{
			...
			if (! cMainForm.axVideoGrabberNET1.IsCameraControlSettingAvailable(Setting)) 
			{
			...
			else 
			{
				...
				chkAuto.Checked = cMainForm.axVideoGrabberNET1.CameraControlAuto(Setting);
				tbrValue.Enabled = ! chkAuto.Checked;
				btnDefault.Enabled = ! chkAuto.Checked;

                int MinValue = cMainForm.axVideoGrabberNET1.CameraControlMin(Setting);
                int MaxValue = cMainForm.axVideoGrabberNET1.CameraControlMax(Setting);
                int CurrentValue = cMainForm.axVideoGrabberNET1.CameraControlValue(Setting);
                ...
                tbrValue.TickFrequency = cMainForm.axVideoGrabberNET1.CameraControlStep(Setting);
		...
		private void tbrSetValue (System.Object sender, System.EventArgs e)
		{
			...
			cMainForm.axVideoGrabberNET1.SetCameraControl((Vidgrab_NET.TxCameraControl) Setting, FSettingGroup[Setting].chkAuto.Checked, false, FSettingGroup[Setting].tbrValue.Value);
		...
		private void btnSetDefault (System.Object sender, System.EventArgs e)
		{
			...
			cMainForm.axVideoGrabberNET1.SetCameraControl((Vidgrab_NET.TxCameraControl) Setting, FSettingGroup[Setting].chkAuto.Checked, true, FSettingGroup[Setting].tbrValue.Value);
			FSettingGroup[Setting].tbrValue.Value = cMainForm.axVideoGrabberNET1.CameraControlValue((Vidgrab_NET.TxCameraControl) Setting);
		}
