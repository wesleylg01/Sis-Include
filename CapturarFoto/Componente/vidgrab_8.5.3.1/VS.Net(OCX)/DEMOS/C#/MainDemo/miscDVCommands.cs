...
{
	/// <summary>
	/// Summary description for miscDVCommands.
	/// </summary>
	public class miscDVCommands : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
	{
		...
		{
			grbDVCommands.Enabled = cMainForm.axVideoGrabberNET1.IsDigitalVideoIn;
		}
		
		private void SendDVCommand(Vidgrab_NET.TxDVCommand DvCommand)
		{
			if (cMainForm.axVideoGrabberNET1.SendDVCommand(DvCommand))
			{
