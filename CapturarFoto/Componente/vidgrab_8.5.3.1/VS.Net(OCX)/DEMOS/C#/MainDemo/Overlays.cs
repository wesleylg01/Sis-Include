...
namespace MainDemo
{
	...
	public class Overlays : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
        ...
        private AxVidgrab_NET.AxVideoGrabberNET PIPVideoGrabber;
        //private Vidgrab_NET.VideoGrabberNET PIPVideoGrabber = null;
		...
		public void RefreshControls()
		{
            ...
            chkAdjustOverlayAspectRatio.Checked = cMainForm.axVideoGrabberNET1.AdjustOverlayAspectRatio;
		}
		...
		private void btnFreeHandErase_Click(object sender, System.EventArgs e)
		{
            ...
            cMainForm.axVideoGrabberNET1.RefreshPlayerOverlays();
        }

		private void chkTextOverlayEnabled_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.TextOverlay_Enabled = chkTextOverlayEnabled.Checked;
        ...
        {
            cMainForm.axVideoGrabberNET1.AdjustOverlayAspectRatio = chkAdjustOverlayAspectRatio.Checked;
        }

        private void chkTextOverlayTransparent_CheckedChanged(object sender, EventArgs e)
        {
            cMainForm.axVideoGrabberNET1.TextOverlay_Transparent = chkTextOverlayTransparent.Checked;
        }

        private void chkTextOverlayShadow_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.TextOverlay_Shadow = chkTextOverlayShadow.Checked;
		}
        ...
        private void btnSelectShadowColor_Click(object sender, EventArgs e)
        {
            ...
            {
                cMainForm.axVideoGrabberNET1.TextOverlay_ShadowColor = cd.Color;
            }
        }
        ...
        private void edtTextOverlayTop_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.TextOverlay_Top = Convert.ToInt32 (edtTextOverlayTop.Text);
			}
		}
		...
		private void edtTextOverlayLeft_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.TextOverlay_Left = Convert.ToInt32 (edtTextOverlayLeft.Text);
			}
		}
        ...
        private void edtTextOverlayRight_TextChanged(object sender, System.EventArgs e)
        {
            ...
            {
                cMainForm.axVideoGrabberNET1.TextOverlay_Right = Convert.ToInt32 (edtTextOverlayRight.Text);
            }
        }

    	private void mmoTextOverlayString_TextChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.TextOverlay_String = mmoTextOverlayString.Text;
		}

		private void rdgTextOverlayAlign_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
				cMainForm.axVideoGrabberNET1.TextOverlay_Align = (Vidgrab_NET.TxTextOverlayAlign) Convert.ToInt32 ((sender as Control).Tag);
			}
		...
		private void btnSelectFont_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.TextOverlay_Font = fd.Font.ToHfont().ToInt32();
			}
        }
		...
		private void btnSelectFontColor_Click(object sender, System.EventArgs e)
		{
			...
			if (cd.ShowDialog() == DialogResult.OK) 
			{
				cMainForm.axVideoGrabberNET1.TextOverlay_FontColor = cd.Color;
			}
		}
		...
		private void btnBackColor_Click(object sender, System.EventArgs e)
		{
			...
			if (cd.ShowDialog() == DialogResult.OK) 
			{
				cMainForm.axVideoGrabberNET1.TextOverlay_BkColor = cd.Color;
			}
		}
        ...
        private void edtTextOverlayScrollingSpeed_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                cMainForm.axVideoGrabberNET1.TextOverlay_ScrollingSpeed = Convert.ToInt32(edtTextOverlayScrollingSpeed.Text);
            }
        ...
        {
            cMainForm.axVideoGrabberNET1.TextOverlay_Scrolling = chkTextOverlayScrolling.Checked;
        }
		...
		private void OverlaySelector_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.axVideoGrabberNET1.TextOverlay_Selector = Convert.ToInt32 ((sender as Control).Tag);

				// as we have selected another set, let's reload the corresponding values;
				chkTextOverlayEnabled.Checked = cMainForm.axVideoGrabberNET1.TextOverlay_Enabled;

				mmoTextOverlayString.Text = cMainForm.axVideoGrabberNET1.TextOverlay_String;
				edtTextOverlayLeft.Text = cMainForm.axVideoGrabberNET1.TextOverlay_Left.ToString();
				edtTextOverlayTop.Text = cMainForm.axVideoGrabberNET1.TextOverlay_Top.ToString();
				edtTextOverlayRight.Text = cMainForm.axVideoGrabberNET1.TextOverlay_Right.ToString();
                edtTextOverlayScrollingSpeed.Text = cMainForm.axVideoGrabberNET1.TextOverlay_ScrollingSpeed.ToString();

				SetRadioButtonInGroupUsingTag(rdgTextOverlayAlign, (short) cMainForm.axVideoGrabberNET1.TextOverlay_Align);
				chkTextOverlayTransparent.Checked = cMainForm.axVideoGrabberNET1.TextOverlay_Transparent;
                chkAdjustOverlayAspectRatio.Checked = cMainForm.axVideoGrabberNET1.AdjustOverlayAspectRatio;
				chkTextOverlayShadow.Checked = cMainForm.axVideoGrabberNET1.TextOverlay_Shadow;
                chkTextOverlayScrolling.Checked = cMainForm.axVideoGrabberNET1.TextOverlay_Scrolling;
				SetRadioButtonInGroupUsingTag(rgdTextOverlayShadowDirection, (short) cMainForm.axVideoGrabberNET1.TextOverlay_ShadowDirection);
			}	
        }
		...
		private void rgdShadow_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.axVideoGrabberNET1.TextOverlay_ShadowDirection = (Vidgrab_NET.TxCardinalDirection) Convert.ToInt32 ((sender as Control).Tag);
			}
		}
        ...
        private void btnPIP_Click(object sender, EventArgs e)
        {
            ...
            if (dlgOpen.ShowDialog() == DialogResult.OK)
            {
                if (PIPVideoGrabber == null)
                {
                    ...
                    cMainForm.axVideoGrabberNET1.Mixer_SetupPIPFromSource(PIPVideoGrabber.UniqueID, 0, 0, 0, 0, true, 10, 10, 200, 150, false);
                }
		...
		private void btnImageOverlayFromFile_Click(object sender, System.EventArgs e)
		{
			...
			if (fd.ShowDialog() == DialogResult.OK) 
			{
				cMainForm.axVideoGrabberNET1.SetImageOverlayFromImageFile(fd.FileName);
			}
		}

		private void chkImageOverlayEnabled_CheckedChanged(object sender, System.EventArgs e)
		{
            cMainForm.axVideoGrabberNET1.ImageOverlayEnabled = chkImageOverlayEnabled.Checked;
		}

		private void ImageSelector_CheckedChanged(object sender, System.EventArgs e)
		{
            cMainForm.axVideoGrabberNET1.ImageOverlaySelector = Convert.ToInt32 ((sender as Control).Tag);

            chkImageOverlayEnabled.Checked = cMainForm.axVideoGrabberNET1.ImageOverlayEnabled;
            edtImageOverlayLeft.Text = cMainForm.axVideoGrabberNET1.ImageOverlay_LeftLocation.ToString();
            edtImageOverlayTop.Text = cMainForm.axVideoGrabberNET1.ImageOverlay_TopLocation.ToString();
            edtImageOverlayWidth.Text = cMainForm.axVideoGrabberNET1.ImageOverlay_Width.ToString();
            edtImageOverlayHeight.Text = cMainForm.axVideoGrabberNET1.ImageOverlay_Height.ToString();

            chkImageOverlayTransparent.Checked = cMainForm.axVideoGrabberNET1.ImageOverlay_Transparent;
            chkImageOverlayUseTransparentColor.Checked = cMainForm.axVideoGrabberNET1.ImageOverlay_UseTransparentColor;
            edtImageOverlayTransparentColorValue.Text = "0x" + cMainForm.axVideoGrabberNET1.ImageOverlay_TransparentColorValue.ToString("X000000");
            chkImageOverlayAlphaBlend.Checked = cMainForm.axVideoGrabberNET1.ImageOverlay_AlphaBlend;
            tbrImageOverlayAlphaBlending.Value = cMainForm.axVideoGrabberNET1.ImageOverlay_AlphaBlendValue;

            chkImageOverlayChromaKey.Checked = cMainForm.axVideoGrabberNET1.ImageOverlay_ChromaKey;
            edtImageOverlayChromaKeyColorValue.Text = "0x" + cMainForm.axVideoGrabberNET1.ImageOverlay_ChromaKeyRGBColor.ToString("X000000");
            tbrChromaKeyLeeway.Value = cMainForm.axVideoGrabberNET1.ImageOverlay_ChromaKeyLeewayPercent;
		}

		private void edtImageOverlayLeft_TextChanged(object sender, System.EventArgs e)
		{
        if (IsNumeric(edtImageOverlayLeft.Text)) {
            cMainForm.axVideoGrabberNET1.ImageOverlay_LeftLocation = Convert.ToInt32 (edtImageOverlayLeft.Text);
        }
        ...
        if (IsNumeric(edtImageOverlayTop.Text)) {
            cMainForm.axVideoGrabberNET1.ImageOverlay_TopLocation = Convert.ToInt32 (edtImageOverlayTop.Text);
        }
		}
        ...
        if (IsNumeric(edtImageOverlayWidth.Text)) {
            cMainForm.axVideoGrabberNET1.ImageOverlay_Width = Convert.ToInt32(edtImageOverlayWidth.Text);
        }
		}
		...
		private void edtImageOverlayHeight_TextChanged(object sender, System.EventArgs e)
		{
            if (IsNumeric(edtImageOverlayHeight.Text)) {
                cMainForm.axVideoGrabberNET1.ImageOverlay_Height = Convert.ToInt32(edtImageOverlayHeight.Text);
            }
		}

        private void chkImageOverlayTransparent_CheckedChanged(object sender, System.EventArgs e)
        {
            cMainForm.axVideoGrabberNET1.ImageOverlay_Transparent = chkImageOverlayTransparent.Checked;
        }

        private void chkImageOverlayUseTransparentColor_CheckedChanged(object sender, EventArgs e)
        {
            cMainForm.axVideoGrabberNET1.ImageOverlay_UseTransparentColor = chkImageOverlayUseTransparentColor.Checked;
        }
        ...
        private void edtImageOverlayTransparentColorValue_TextChanged(object sender, System.EventArgs e)
        {
            ...
            {
                cMainForm.axVideoGrabberNET1.ImageOverlay_TransparentColorValue = Convert.ToInt32(edtImageOverlayTransparentColorValue.Text);
            }
        }
        ...
        private void btnImageOverlayPickupTransparentColor_Click(object sender, System.EventArgs e)
        {
            ...
            {
                cMainForm.axVideoGrabberNET1.ImageOverlay_TransparentColorValue = cMainForm.cPickupColor.LastRGBPixelValueAtMousePosition;
        ...
        {
            cMainForm.axVideoGrabberNET1.ImageOverlay_AlphaBlend = chkImageOverlayAlphaBlend.Checked;
        }

        private void tbrImageOverlayAlphaBlending_Scroll(object sender, System.EventArgs e)
        {
            cMainForm.axVideoGrabberNET1.ImageOverlay_AlphaBlendValue = Convert.ToInt32(tbrImageOverlayAlphaBlending.Value);
        }

        private void chkImageOverlayChromaKey_CheckedChanged(object sender, System.EventArgs e)
        {
            cMainForm.axVideoGrabberNET1.ImageOverlay_ChromaKey = chkImageOverlayChromaKey.Checked;
        }
        ...
        private void edtImageOverlayChromaKeyColorValue_TextChanged(object sender, System.EventArgs e)
        {
            ...
            {
                cMainForm.axVideoGrabberNET1.ImageOverlay_ChromaKeyRGBColor = Convert.ToInt32(edtImageOverlayChromaKeyColorValue.Text);
            }
        }
        ...
        private void btnImageOverlayPickupChromaKeyColor_Click(object sender, System.EventArgs e)
        {
            if (cMainForm.cPickupColor.LastRGBPixelValueAtMousePosition != -1) 
            {
                cMainForm.axVideoGrabberNET1.ImageOverlay_ChromaKeyRGBColor = cMainForm.cPickupColor.LastRGBPixelValueAtMousePosition;
        ...
        {
            cMainForm.axVideoGrabberNET1.ImageOverlay_ChromaKeyLeewayPercent = tbrChromaKeyLeeway.Value;
        }
