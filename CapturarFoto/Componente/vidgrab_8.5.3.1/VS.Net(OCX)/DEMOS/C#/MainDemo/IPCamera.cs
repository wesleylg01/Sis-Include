...
namespace MainDemo
{
	...
	public class IPCamera : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{	
			lblFirstSelectIPCamera.Visible = (cMainForm.axVideoGrabberNET1.VideoSource != Vidgrab_NET.TxVideoSource.vs_IPCamera);
		}
		...
		{
			cMainForm.axVideoGrabberNET1.IPCameraURL = edtIPCameraURL.Text;
		}

        private void edtIPCamUserName_TextChanged(object sender, System.EventArgs e)
        {
            cMainForm.axVideoGrabberNET1.SetAuthentication (Vidgrab_NET.TxAuthenticationType.at_IPCamera, edtIPCamUserName.Text, edtIPCamPassword.Text);
        }
        ...
        private void edtIPCamConnectionTimeout_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.SetIPCameraSetting (Vidgrab_NET.TxIPCameraSetting.ips_ConnectionTimeout , Convert.ToInt32 (edtIPCamConnectionTimeout.Text));
			}
		}
		...
		private void edtIPCamReceiveTimeout_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.SetIPCameraSetting (Vidgrab_NET.TxIPCameraSetting.ips_ReceiveTimeout , Convert.ToInt32 (edtIPCamReceiveTimeout.Text));
			}
		}

		private void btnIPCamStartPreview_Click(object sender, System.EventArgs e)
		{
            if (cMainForm.axVideoGrabberNET1.VideoSource != Vidgrab_NET.TxVideoSource.vs_IPCamera) {
                cMainForm.axVideoGrabberNET1.VideoSource = Vidgrab_NET.TxVideoSource.vs_IPCamera;
        ...
        {
            if (cMainForm.axVideoGrabberNET1.SendIPCameraCommand(edtIPCamCommand.Text)) 
            {
