...
namespace MainDemo
{
	...
	public class VideoProcessing : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
	{
		...
		{
			SetRadioButtonInGroupUsingTag(rdgVideoRotation, (short) cMainForm.axVideoGrabberNET1.VideoProcessing_Rotation);
			edtCustomRotationAngle.Text = cMainForm.axVideoGrabberNET1.VideoProcessing_RotationCustomAngle.ToString();

			SetRadioButtonInGroupUsingTag(rdgDeinterlacing, (short) cMainForm.axVideoGrabberNET1.VideoProcessing_Deinterlacing);

            updVideoPixelization.Value = cMainForm.axVideoGrabberNET1.VideoProcessing_Pixellization;

            tbrBrightness.Value = cMainForm.axVideoGrabberNET1.VideoProcessing_Brightness;
			tbrContrast.Value = cMainForm.axVideoGrabberNET1.VideoProcessing_Contrast;
			tbrSaturation.Value = cMainForm.axVideoGrabberNET1.VideoProcessing_Saturation;
			tbrHue.Value = cMainForm.axVideoGrabberNET1.VideoProcessing_Hue;

			chkGreyScale.Checked = cMainForm.axVideoGrabberNET1.VideoProcessing_GrayScale;
			chkInvertColors.Checked = cMainForm.axVideoGrabberNET1.VideoProcessing_InvertColors;
			chkFlipVertical.Checked = cMainForm.axVideoGrabberNET1.VideoProcessing_FlipVertical;
			chkFlipHorizontal.Checked = cMainForm.axVideoGrabberNET1.VideoProcessing_FlipHorizontal;

			chkCroppingEnabled.Checked = cMainForm.axVideoGrabberNET1.Cropping_Enabled;
			chkCroppingOutbounds.Checked = cMainForm.axVideoGrabberNET1.Cropping_Outbounds;
			edtCroppingWidth.Text = cMainForm.axVideoGrabberNET1.Cropping_Width.ToString();
			edtCroppingHeight.Text = cMainForm.axVideoGrabberNET1.Cropping_Height.ToString();
			trkCroppingZoom.Value = (int) cMainForm.axVideoGrabberNET1.Cropping_Zoom * 100;

			// trkCroppingX.Max and trkCroppingY.Max are will be set from the OnResizeVideo event;
			trkCroppingY.Value = cMainForm.axVideoGrabberNET1.Cropping_Y;
			trkCroppingX.Value = cMainForm.axVideoGrabberNET1.Cropping_X;

            lblSWVideoProcessingRequiresFrameGrabber.Visible = cMainForm.axVideoGrabberNET1.FrameGrabber == Vidgrab_NET.TxFrameGrabber.fg_Disabled;
        ...
        public void RefreshVMR9Processing()
        {
            ...
            if (cMainForm.axVideoGrabberNET1.IsVMR9ImageAdjustmentAvailable(true))
            {
                tbrVMR9Brightness.Enabled = cMainForm.axVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Brightness,out MinValue,out MaxValue,out StepSize,out DefaultValue,out CurrentValue);
                ...
                tbrVMR9Contrast.Enabled = cMainForm.axVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Contrast, out MinValue, out MaxValue, out StepSize, out DefaultValue, out CurrentValue);
                ...
                tbrVMR9Hue.Enabled = cMainForm.axVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Hue, out MinValue, out MaxValue, out StepSize, out DefaultValue, out CurrentValue);
                ...
                tbrVMR9Saturation.Enabled = cMainForm.axVideoGrabberNET1.GetVMR9ImageAdjustmentBounds(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Saturation, out MinValue, out MaxValue, out StepSize, out DefaultValue, out CurrentValue);
		...
		private void btnCroppingZoomReset_Click(object sender, System.EventArgs e)
		{
            ...
            cMainForm.axVideoGrabberNET1.Cropping_Zoom = trkCroppingZoom.Value / 100;
		}
		...
		{
			cMainForm.axVideoGrabberNET1.Cropping_Enabled = chkCroppingEnabled.Checked;
		}

		private void chkCroppingOutbounds_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.Cropping_Outbounds = chkCroppingOutbounds.Checked;
		}

		private void chkFlipHorizontal_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_FlipHorizontal = chkFlipHorizontal.Checked;
		}

		private void chkFlipVertical_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_FlipVertical = chkFlipVertical.Checked;
		}

		private void chkGreyScale_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_GrayScale = chkGreyScale.Checked;
		}

		private void chkInvertColors_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_InvertColors = chkInvertColors.Checked;
		}
		...
		private void edtCroppingHeight_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.Cropping_Height = Convert.ToInt32 (edtCroppingHeight.Text);
			}
		}
		...
		private void edtCroppingWidth_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				;
				cMainForm.axVideoGrabberNET1.Cropping_Width = Convert.ToInt32 (edtCroppingWidth.Text);
			};
		}
		...
		private void rdgDeinterlacing_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.VideoProcessing_Deinterlacing = (Vidgrab_NET.TxVideoDeinterlacing) Convert.ToInt32 ((sender as Control).Tag);
			}
		}
		...
		private void rdgVideoRotation_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.axVideoGrabberNET1.VideoProcessing_Rotation = (Vidgrab_NET.TxVideoRotation) Convert.ToInt32 ((sender as Control).Tag);
			}
		}

		private void tbrBrightness_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_Brightness = -tbrBrightness.Value;
		}

		private void tbrContrast_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_Contrast = -tbrContrast.Value;
		}

		private void tbrSaturation_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_Hue = -tbrHue.Value;
		}

		private void tbrHue_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.VideoProcessing_Saturation = -tbrSaturation.Value;
		}

		private void tbrVMR9Brightness_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.SetVMR9ImageAdjustmentValue(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Brightness, tbrVMR9Brightness.Value, false);
		}

		private void tbrVMR9Contrast_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.SetVMR9ImageAdjustmentValue(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Contrast, tbrVMR9Contrast.Value, vmr9FixRange.Checked);
		}

		private void tbrVMR9Saturation_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.SetVMR9ImageAdjustmentValue(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Hue, tbrVMR9Hue.Value, false);
		}

		private void tbrVMR9Hue_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.SetVMR9ImageAdjustmentValue(true, Vidgrab_NET.TxVMR9ImageAdjustment.vmr9_Saturation, tbrVMR9Saturation.Value, vmr9FixRange.Checked);
		}
		...
		private void trkCroppingX_Scroll(object sender, System.EventArgs e)
		{
			...
			cMainForm.axVideoGrabberNET1.Cropping_X = trkCroppingX.Value;
		}

		private void trkCroppingY_Scroll(object sender, System.EventArgs e)
		{
			// trkCroppingX.Max and trkCroppingY.Max are set from the OnResizeVideo event;
			cMainForm.axVideoGrabberNET1.Cropping_Y = trkCroppingY.Value;
		}
		...
		private void edtCustomRotationAngle_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.axVideoGrabberNET1.VideoProcessing_RotationCustomAngle = Convert.ToDouble (edtCustomRotationAngle.Text);
			}
		}
        ...
        {
            cMainForm.axVideoGrabberNET1.VideoProcessing_Pixellization =Convert.ToInt32(updVideoPixelization.Value);
        }
