...
namespace MainDemo
{
	...
	public class miscSpecialControl : SubForm  // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
	{
		...
		{
			cMainForm.axVideoGrabberNET1.SendCameraCommand(0, 0, false);
		}

		private void btnPanTiltUp_Click(object sender, System.EventArgs e)
		{
			cMainForm.axVideoGrabberNET1.SendCameraCommand(0, 1, true);
		}
		...
		{
			cMainForm.axVideoGrabberNET1.SendCameraCommand(-1, 0, true);
		}
		...
		private void rdgGpio0_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				if (Convert.ToInt32 ((sender as Control).Tag) == 0) {
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 0, 0);
				}
				else {
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 0, 1);
				}
			}
		}
		...
		private void rdgGpio1_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				if (Convert.ToInt32 ((sender as Control).Tag) == 0) 
				{
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 1, 0);
				}
				else 
				{
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 1, 1);
				}
			}
		}
		...
		private void rdgGpio2_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				if (Convert.ToInt32 ((sender as Control).Tag) == 0) 
				{
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 2, 0);
				}
				else 
				{
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 2, 1);
				}
			}
		}
		...
		private void rdgGpio3_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				if (Convert.ToInt32 ((sender as Control).Tag) == 0) 
				{
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 3, 0);
				}
				else 
				{
					cMainForm.axVideoGrabberNET1.PutMiscDeviceControl (Vidgrab_NET.TxMiscDeviceControl.mdc_GPIO, 3, 1);
				}
			}
		}
