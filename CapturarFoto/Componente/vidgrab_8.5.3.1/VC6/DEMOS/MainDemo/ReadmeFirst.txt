 ...
 Be sure to register the vidgrab_VC6.OCX component before using the VC6 demo projects:

 Start -> Execute -> RegSvr32 [path to the ocx]\vidbgrab_VC6.OCX

 E.g. RegSvr32 c:\vidgrab\VC6\vidgrab_VC6.OCX
