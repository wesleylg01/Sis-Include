...
// (DO NOT EDIT: machine generated header) 'VidGrab.pas' rev: 23.00 (Win32)
...
enum TFrameGrabber : unsigned int { fg_BothStreams, fg_PreviewStream, fg_CaptureStream, fg_Disabled };
#pragma option pop

#pragma option push -b
enum TFrameGrabberRGBFormat : unsigned int { fgf_Default, fgf_RGB32, fgf_RGB24, fgf_RGB565, fgf_RGB555, fgf_RGB8 };
#pragma option pop

#pragma option push -b
enum TAutoFileName : unsigned int { fn_Sequential, fn_DateTime, fn_Counter };
#pragma option pop

#pragma option push -b
enum TCompressionMode : unsigned int { cm_NoCompression, cm_CompressOnTheFly, cm_CompressAfterRecording };
#pragma option pop

#pragma option push -b
enum TCompressionType : unsigned int { ct_Video, ct_Audio, ct_AudioVideo };
#pragma option pop

#pragma option push -b
enum TCurrentState : unsigned int { cs_Down, cs_Preview, cs_Recording, cs_Playback, cs_Reencoding };
#pragma option pop

#pragma option push -b
enum TFrameCaptureDest : unsigned int { fc_TBitmap, fc_BmpFile, fc_JpegFile, fc_Clipboard };
#pragma option pop

#pragma option push -b
enum TDVSize : unsigned int { dv_Full, dv_Half, dv_Quarter, dv_DC };
#pragma option pop

#pragma option push -b
enum TTVChannelInfo : unsigned int { tci_Channel, tci_DefaultVideoFrequency, tci_OverriddenVideoFrequency, tci_TunerVideoFrequency, tci_TunerAudioFrequency, tci_Locked };
#pragma option pop

#pragma option push -b
enum TWebcamStillCaptureButton : unsigned int { wb_Disabled, wb_Enabled };
#pragma option pop

#pragma option push -b
enum TDVVideoStandard : unsigned int { dvs_Default, dvs_PAL, dvs_NTSC };
#pragma option pop

#pragma option push -b
enum TDVVideoFormat : unsigned int { dvf_Default, dvf_DVSD, dvf_DVHD, dvf_DVSL };
#pragma option pop

#pragma option push -b
enum TAVIInfoType : unsigned int { av_Duration, av_FrameCount, av_VideoWidth, av_VideoHeight, av_VideoFrameRateFps, av_VideoCodec, av_AudioCodec, av_AvgBitRate, av_AudioChannels, av_AudioSamplesPerSec, av_AudioBitsPerSample, av_FileSizeInKB, av_AudioStreams };
#pragma option pop

#pragma option push -b
enum TDVDInfoType : unsigned int { dvd_NumberOfVolumes, dvd_TotalDuration, dvd_NumberOfTitles, dvd_TitleDuration, dvd_TitleFrameRate, dvd_SourceResolutionX, dvd_SourceResolutionY, dvd_TitleFrameCount };
#pragma option pop

#pragma option push -b
enum THeaderAttribute : unsigned int { ha_Title, ha_Description, ha_Author, ha_Copyright, ha_AlbumArtist, ha_AlbumTitle, ha_Composer, ha_ContentDistributor, ha_Director, ha_EncodingTime, ha_Genre, ha_Language, ha_ParentalRating, ha_Producer, ha_Provider, ha_ToolName, ha_ToolVersion, ha_Writer, ha_IARL, ha_ICMS, ha_ICMT, ha_ICRD, ha_ICRP, ha_IDIM, ha_IDPI, ha_IENG, ha_IGNR, ha_IKEY, ha_ILGT, ha_IMED, ha_IPLT, ha_IPRD, ha_ISFT, ha_ISHP, ha_ISRC, ha_ISRF, ha_ITCH };
#pragma option pop

#pragma option push -b
enum TDVCommand : unsigned int { dv_Play, dv_Stop, dv_Freeze, dv_Thaw, dv_Ff, dv_Rew, dv_Record, dv_RecordFreeze, dv_RecordStrobe, dv_StepFwd, dv_StepRev, dv_ModeShuttle, dv_PlayFastestFwd, dv_PlaySlowestFwd, dv_PlayFastestRev, dv_PlaySlowestRev };
#pragma option pop

#pragma option push -b
enum TDialog : unsigned int { dlg_VideoDevice, dlg_VideoCompressor, dlg_AudioCompressor, dlg_StreamConfig, dlg_VfwFormat, dlg_VfwSource, dlg_vfwDisplay, dlg_VideoCrossbar, dlg_AudioCrossbar, dlg_TVTuner, dlg_TVAudio, dlg_AudioDevice, dlg_NetShowConfig, dlg_DScaler, dlg_FFDShowVideo, dlg_FFDShowAudio, dlg_Multiplexer, dlg_None };
#pragma option pop

#pragma option push -b
enum TTriState : unsigned int { ts_Undefined, ts_False, ts_True };
#pragma option pop

#pragma option push -b
enum TLogoLayout : unsigned int { lg_Centered, lg_Stretched, lg_Repeated, lg_TopLeft, lg_TopRight, lg_BottomLeft, lg_BottomRight, lg_Boxed };
#pragma option pop

#pragma option push -b
enum TNotificationMethod : unsigned int { nm_Timer, nm_Thread };
#pragma option pop

#pragma option push -b
enum TVideoControl : unsigned int { vc_FlipHorizontal, vc_FlipVertical, vc_ExternalTriggerEnable, vc_Trigger };
#pragma option pop

#pragma option push -b
enum TCardinalDirection : unsigned int { cd_North, cd_NorthEast, cd_East, cd_SouthEast, cd_South, cd_SouthWest, cd_West, cd_NorthWest, cd_Center };
#pragma option pop

#pragma option push -b
enum TVideoRotation : unsigned int { rt_0_deg, rt_90_deg, rt_180_deg, rt_270_deg, rt_0_deg_mirror, rt_90_deg_mirror, rt_180_deg_mirror, rt_270_deg_mirror, rt_custom_angle, rt_custom_angle_mirror };
#pragma option pop

#pragma option push -b
enum TVideoDeinterlacing : unsigned int { di_Disabled, di_HalfSize, di_FullSize, di_DScaler, di_AVISynth, di_FFDShow, di_ThirdPartyDeinterlacer };
#pragma option pop

#pragma option push -b
enum TThirdPartyFilterList : unsigned int { tpf_VideoSource, tpf_VideoPreview, tpf_VideoRecording, tpf_AudioSource, tpf_AudioRendering, tpf_AudioRecording, tpf_VideoRendering, tpf_VideoRenderer, tpf_AudioRenderer, tpf_ThirdPartyVideoSource, tpf_ThirdPartyAudioSource, tpf_AddToGraph };
#pragma option pop

#pragma option push -b
enum TRecordingSize : unsigned int { rs_Default, rs_HalfSize, rs_QuarterSize };
#pragma option pop

#pragma option push -b
enum TFormatType : unsigned int { ft_VideoInfo, ft_VideoInfo2, ft_DvInfo, ft_Mpeg1Video, ft_Mpeg2Video, ft_Mpeg1Stream, ft_Mpeg2Stream, ft_MpegStreamType, ft_MpegCustom, ft_WaveFormatEx, ft_Mpeg1Audio, ft_Mpeg2Audio, ft_Mpeg3Audio, ft_OGG, ft_Unknown };
#pragma option pop

typedef TFormatType *pFormatType;

#pragma option push -b
enum TAudioFormat : unsigned int { af_default, af_8000_8b_1ch, af_8000_8b_2ch, af_8000_16b_1ch, af_8000_16b_2ch, af_11025_8b_1ch, af_11025_8b_2ch, af_11025_16b_1ch, af_11025_16b_2ch, af_16000_8b_1ch, af_16000_8b_2ch, af_16000_16b_1ch, af_16000_16b_2ch, af_22050_8b_1ch, af_22050_8b_2ch, af_22050_16b_1ch, af_22050_16b_2ch, af_32000_8b_1ch, af_32000_8b_2ch, af_32000_16b_1ch, af_32000_16b_2ch, af_44100_8b_1ch, af_44100_8b_2ch, af_44100_16b_1ch, af_44100_16b_2ch, af_48000_8b_1ch, af_48000_8b_2ch, af_48000_16b_1ch, af_48000_16b_2ch };
#pragma option pop

#pragma option push -b
enum TAudioChannelRenderMode : unsigned int { acrm_Normal, acrm_RenderLeft, acrm_RenderRight, acrm_MuteLeft, acrm_MuteRight, acrm_Mute_All, acrm_MixLeftAndRight, acrm_PassThru };
#pragma option pop

#pragma option push -b
enum TVideoRenderer : unsigned int { vr_AutoSelect, vr_EVR, vr_VMR9, vr_VMR7, vr_StandardRenderer, vr_OverlayRenderer, vr_RecordingPriority, vr_None };
#pragma option pop

#pragma option push -b
enum TVideoRendererExternal : unsigned int { vre_None, vre_Matrox_PRO, vre_Decklink_SD, vre_Decklink_Extreme, vre_Pinnacle_MovieBoard, vre_BlackMagic_Decklink };
#pragma option pop

#pragma option push -b
enum TRawSampleCaptureLocation : unsigned int { rl_SourceFormat, rl_AfterCompression };
#pragma option pop

#pragma option push -b
enum TMainConceptFiltersVersion : unsigned int { mc_Version4, mc_Version8 };
#pragma option pop

#pragma option push -b
enum TPointGreyConfig : unsigned int { pgr_SetRegister, pgr_GetRegister, pgr_SetBufferSize, pgr_GetBufferSize, pgr_SetFormat, pgr_GetFormat };
#pragma option pop

#pragma option push -b
enum TAuthenticationType : unsigned int { at_PublishingPoint, at_IPCamera, at_StreamingUrl };
#pragma option pop

#pragma option push -b
enum TIPCameraSetting : unsigned int { ips_ConnectionTimeout, ips_ReceiveTimeout };
#pragma option pop

#pragma option push -b
enum TSynchronizationRole : unsigned int { sr_Master, sr_Slave };
#pragma option pop

#pragma option push -b
enum TTrackbarAction : unsigned int { tba_MouseDown, tba_MouseUp, tba_KeyDown, tba_KeyUp };
#pragma option pop

#pragma option push -b
enum TVideoSource : unsigned int { vs_VideoCaptureDevice, vs_ScreenRecording, vs_VideoFileOrURL, vs_JPEGsOrBitmaps, vs_IPCamera, vs_Mixer, vs_VideoFromImages, vs_ThirdPartyFilter };
#pragma option pop

#pragma option push -b
enum TAudioSource : unsigned int { as_Default, as_UseExternalAudio };
#pragma option pop

#pragma option push -b
enum TVuMeter : unsigned int { vu_Disabled, vu_Analog, vu_Bargraph };
#pragma option pop

#pragma option push -b
enum TASFDeinterlaceMode : unsigned int { adm_NotInterlaced, adm_DeinterlaceNormal, adm_DeinterlaceHalfSize, adm_DeinterlaceHalfSizeDoubleRate, adm_DeinterlaceInverseTelecine, adm_DeinterlaceVerticalHalfSizeDoubleRate };
#pragma option pop

#pragma option push -b
enum TASFProfileVersion : unsigned int { apv_ProfileVersion_8, apv_ProfileVersion_9 };
#pragma option pop

#pragma option push -b
enum TFileSort : unsigned int { fs_TimeAsc, fs_TimeDesc, fs_NameAsc, fs_NameDesc };
#pragma option pop

#pragma option push -b
enum TTunerInputType : unsigned int { TunerInputCable, TunerInputAntenna };
#pragma option pop

#pragma option push -b
enum TRGBSelector : unsigned int { rs_Red, rs_Green, rs_Blue };
#pragma option pop

#pragma option push -b
enum TCameraControl : unsigned int { cc_Pan, cc_Tilt, cc_Roll, cc_Zoom, cc_Exposure, cc_Iris, cc_Focus };
#pragma option pop

#pragma option push -b
enum TPlaylist : unsigned int { pl_Add, pl_Remove, pl_Clear, pl_Loop, pl_NoLoop, pl_Play, pl_Stop, pl_Next, pl_Previous, pl_SortAlpha, pl_SortRevAlpha, pl_Random, pl_Sequential, pl_SpecifyPositions, pl_Transition };
#pragma option pop

#pragma option push -b
enum TVideoQuality : unsigned int { vq_Brightness, vq_Contrast, vq_Hue, vq_Saturation, vq_Sharpness, vq_Gamma, vq_ColorEnable, vq_WhiteBalance, vq_BacklightCompensation, vq_Gain };
#pragma option pop

#pragma option push -b
enum TMiscDeviceControl : unsigned int { mdc_GPIO, mdc_VPD, mdc_VPD_Data };
#pragma option pop

#pragma option push -b
enum TAVIMuxConfig : unsigned int { avmx_SetInterleavingMode, avmx_SetInterleave, avmx_SetPreroll };
#pragma option pop

#pragma option push -b
enum TApplicationPriority : unsigned int { ap_default, ap_idle, ap_normal, ap_high, ap_realtime };
#pragma option pop

#pragma option push -b
enum TRecordingMethod : unsigned int { rm_AVI, rm_ASF, rm_SendToDV, rm_MKV, rm_FLV, rm_MP4, rm_WebM, rm_MPG, rm_Multiplexer };
#pragma option pop

#pragma option push -b
enum TNetworkStreaming : unsigned int { ns_Disabled, ns_ASFDirectNetworkStreaming, ns_ASFStreamingToPublishingPoint };
#pragma option pop

#pragma option push -b
enum TNetworkStreamingType : unsigned int { nst_AudioVideoStreaming, nst_VideoStreaming, nst_AudioStreaming };
#pragma option pop

#pragma option push -b
enum TSyncPreview : unsigned int { sp_Auto, sp_Disabled, sp_Enabled };
#pragma option pop

#pragma option push -b
enum TGraphState : unsigned int { gs_Stopped, gs_Paused, gs_Running };
#pragma option pop

#pragma option push -b
enum TPlayerState : unsigned int { ps_Closed, ps_Stopped, ps_Paused, ps_Playing, ps_PlayingBackward, ps_FastForwarding, ps_FastRewinding, ps_Downloading, ps_DownloadCompleted, ps_DownloadCancelled };
#pragma option pop

#pragma option push -b
enum TRecordingTimer : unsigned int { rt_Disabled, rt_RecordToNewFile, rt_StopRecording, rt_StartRecording };
#pragma option pop

#pragma option push -b
enum TAero : unsigned int { ae_Default, ae_AutoBestRenderingQuality, ae_ForceOnWhenStartingVideo, ae_ForceOffWhenStartingVideo, ae_ForceOnImmediately, ae_ForceOffImmediately };
#pragma option pop

#pragma option push -b
enum TMPEGProgramSetting : unsigned int { mps_Program_Number, mps_Program_PCR_PID, mps_VideoStream_PID, mps_AudioStream_PID, mps_VideoStream_Type, mps_AudioStream_Type, mps_VideoFormat_Width, mps_VideoFormat_Height, mps_VideoAspectRatio_X, mps_VideoAspectRatio_Y, mps_ReceiveTimeoutInSeconds };
#pragma option pop

#pragma option push -b
enum TFrameInfoId : unsigned int { fi_FrameNumber, fi_DroppedFrameCount, fi_SampleTime_Hour, fi_SampleTime_Min, fi_SampleTime_Sec, fi_SampleTime_Hs, fi_SampleTime_TotalMin, fi_DVTimeCode_IsAvailable, fi_DVTimeCode_Hour, fi_DVTimeCode_Min, fi_DVTimeCode_Sec, fi_DVTimeCode_Ff, fi_DVTimeCode_TrackNumber, fi_DVDateTime_IsAvailable, fi_DVDateTime_Year, fi_DVDateTime_Month, fi_DVDateTime_Day, fi_DVDateTime_Hour, fi_DVDateTime_Min, fi_DVDateTime_Sec };
#pragma option pop

#pragma option push -b
enum TFrameInfoStringId : unsigned int { fis_DVTimeCode, fis_DVDateTime, fis_TimeCode, fis_FrameTime, fis_FrameNumber, fis_FullInfo };
#pragma option pop
...
#pragma option push -b
enum TMultiplexedRole : unsigned int { mr_NotMultiplexed, mr_MultiplexedMosaic4, mr_MultiplexedMosaic16, mr_MultiplexedMaster, mr_MultiplexedSlave };
#pragma option pop

#pragma option push -b
enum TMpegStreamType : unsigned int { mpst_Default, mpst_Program, mpst_Program_DVD, mpst_Program_DVD_MC, mpst_Program_SVCD, mpst_MPEG1, mpst_MPEG1_VCD };
#pragma option pop

#pragma option push -b
enum TLogType : unsigned int { e_add_filter, e_add_source_filter, e_audio_compressor_not_suitable, e_bind_moniker_to_filter, e_compressor_possibly_not_suitable, e_create_instance, e_ddraw_caps_not_suitable, e_device_in_use_in_another_graph, e_disk_full, e_failed, e_failed_to_allocate_recording_file, e_failed_to_bind_codec, e_failed_to_connect_crossbar_pin, e_failed_to_connect_to_server, e_failed_to_create_directory, e_failed_to_create_file, e_failed_to_create_temp, e_failed_to_bind_frame_grabber, e_failed_to_load_ASF_profile, e_failed_to_load_ASF_profile_custom_file, e_failed_to_load_set_of_bitmaps, e_failed_to_set_image_overlay, e_failed_to_set_logo, e_failed_to_play_backwards, e_failed_to_render_file, e_failed_to_renew_recording_file, 
...
#pragma option push -b
enum TRegistryRoot : unsigned int { RR_HKEY_CURRENT_USER, RR_HKEY_LOCAL_MACHINE };
#pragma option pop

#pragma option push -b
enum TAspectRatio : unsigned int { ar_Box, ar_NoResize, ar_Stretch, ar_PanScan };
#pragma option pop

#pragma option push -b
enum TTextOverlayAlign : unsigned int { tf_Left, tf_Center, tf_Right };
#pragma option pop

#pragma option push -b
enum TVUMeterSetting : unsigned int { vu_Handle, vu_WarningPercent, vu_PeakPercent, vu_BkgndColor, vu_NormalColor, vu_WarningColor, vu_PeakColor, vu_TickSize, vu_TickInterval, vu_NeedleThickness };
#pragma option pop

#pragma option push -b
enum TVMR9ImageAdjustment : unsigned int { vmr9_Brightness, vmr9_Contrast, vmr9_Hue, vmr9_Saturation, vmr9_Alpha };
#pragma option pop

#pragma option push -b
enum TVideoWindowNotify : unsigned int { vwActive, vwVisible, vwAutoSize, vwEmbedded, vwColorKeyEnabled, vwAlphaBlendEnabled, vwFullScreen, vwStayOnTop, vwMouseMovesWindow, vwVideoPortEnabled, vwMonitor, vwAspectRatio, vwVideoWidth, vwVideoHeight, vwPanScanRatio, vwColorKeyValue, vwAlphaBlendValue, vwLeft, vwTop, vwLocation };
#pragma option pop

#pragma option push -b
enum TTunerMode : unsigned int { tm_TVTuner, tm_FMRadioTuner, tm_AMRadioTuner, tm_DigitalSatelliteTuner };
#pragma option pop
...
private:
	...
	Vcl::Imaging::Jpeg::TJPEGPerformance __fastcall GetJPEGPerformance(void);
	...
	void __fastcall SetJPEGPerformance(Vcl::Imaging::Jpeg::TJPEGPerformance Value);
...
__published:
	...
	__property Vcl::Imaging::Jpeg::TJPEGPerformance JPEGPerformance = {read=GetJPEGPerformance, write=SetJPEGPerformance, default=0};
	...
	__property System::Uitypes::TColor TextOverlay_ShadowColor = {read=GetTextOverlayShadowColor, write=SetTextOverlayShadowColor, default=0};
	...
	__property System::Uitypes::TColor TextOverlay_BkColor = {read=GetTextOverlayBkColor, write=SetTextOverlayBkColor, default=16777215};
	__property TTextOverlayAlign TextOverlay_Align = {read=GetTextOverlayAlign, write=SetTextOverlayAlign, default=0};
	__property Vcl::Graphics::TFont* TextOverlay_Font = {read=GetTextOverlayFont, write=SetTextOverlayFont, default=0};
...
//-- var, const, procedure ---------------------------------------------------
#define BuildID L"4375"
#define TVideoGrabberVersionID L"8.5"
#define TVideoGrabberVersionNumber L"8.5.3.1"
#define TVideoGrabberVersion L"v8.5.3.1 (build 4375) - October 10, 2011 - Copyright \u00a9"\
	L"2002-2011 Datastead"
...
static const System::Int8 DEF_ASFVideoQuality = System::Int8(0x50);
...
static const System::Byte DEF_Display_Height = System::Byte(0xf0);
...
static const System::Word DEF_Display_Width = System::Word(0x140);
...
static const System::Word DEF_IPCameraConnectionTimeout = System::Word(0xea60);
static const System::Word DEF_IPCameraReceiveTimeout = System::Word(0x1388);
...
static const Vcl::Imaging::Jpeg::TJPEGPerformance DEF_JPEGPerformance = (Vcl::Imaging::Jpeg::TJPEGPerformance)(0);
...
static const System::Int8 DEF_RecordingTimerInterval = System::Int8(0x0);
...
static const System::Int8 DEF_TextOverlay_Selector = System::Int8(0x0);
...
static const System::Int8 DEF_VUNotificationFps = System::Int8(0xa);
