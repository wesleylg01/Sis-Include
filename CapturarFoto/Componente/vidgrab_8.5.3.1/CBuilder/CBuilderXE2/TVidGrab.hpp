...
// (DO NOT EDIT: machine generated header) 'TVidGrab.pas' rev: 23.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_TVIDGRAB)
