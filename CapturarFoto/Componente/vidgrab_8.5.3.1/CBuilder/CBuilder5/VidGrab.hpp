...
// (DO NOT EDIT: machine generated header) 'VidGrab.pas' rev: 5.00
...
#pragma option push -b
enum TTVChannelInfo { tci_Channel, tci_DefaultVideoFrequency, tci_OverriddenVideoFrequency, tci_TunerVideoFrequency, 
	tci_TunerAudioFrequency, tci_Locked };
#pragma option pop
...
#pragma option push -b
enum TAVIInfoType { av_Duration, av_FrameCount, av_VideoWidth, av_VideoHeight, av_VideoFrameRateFps, 
	av_VideoCodec, av_AudioCodec, av_AvgBitRate, av_AudioChannels, av_AudioSamplesPerSec, av_AudioBitsPerSample, 
	av_FileSizeInKB, av_AudioStreams };
#pragma option pop

#pragma option push -b
enum TDVDInfoType { dvd_NumberOfVolumes, dvd_TotalDuration, dvd_NumberOfTitles, dvd_TitleDuration, dvd_TitleFrameRate, 
	dvd_SourceResolutionX, dvd_SourceResolutionY, dvd_TitleFrameCount };
#pragma option pop

#pragma option push -b
enum THeaderAttribute { ha_Title, ha_Description, ha_Author, ha_Copyright, ha_AlbumArtist, ha_AlbumTitle, 
	ha_Composer, ha_ContentDistributor, ha_Director, ha_EncodingTime, ha_Genre, ha_Language, ha_ParentalRating, 
	ha_Producer, ha_Provider, ha_ToolName, ha_ToolVersion, ha_Writer, ha_IARL, ha_ICMS, ha_ICMT, ha_ICRD, 
	ha_ICRP, ha_IDIM, ha_IDPI, ha_IENG, ha_IGNR, ha_IKEY, ha_ILGT, ha_IMED, ha_IPLT, ha_IPRD, ha_ISFT, 
	ha_ISHP, ha_ISRC, ha_ISRF, ha_ITCH };
#pragma option pop

#pragma option push -b
enum TDVCommand { dv_Play, dv_Stop, dv_Freeze, dv_Thaw, dv_Ff, dv_Rew, dv_Record, dv_RecordFreeze, dv_RecordStrobe, 
	dv_StepFwd, dv_StepRev, dv_ModeShuttle, dv_PlayFastestFwd, dv_PlaySlowestFwd, dv_PlayFastestRev, dv_PlaySlowestRev 
	};
#pragma option pop

#pragma option push -b
enum TDialog { dlg_VideoDevice, dlg_VideoCompressor, dlg_AudioCompressor, dlg_StreamConfig, dlg_VfwFormat, 
	dlg_VfwSource, dlg_vfwDisplay, dlg_VideoCrossbar, dlg_AudioCrossbar, dlg_TVTuner, dlg_TVAudio, dlg_AudioDevice, 
	dlg_NetShowConfig, dlg_DScaler, dlg_FFDShowVideo, dlg_FFDShowAudio, dlg_Multiplexer, dlg_None };
#pragma option pop
...
#pragma option push -b
enum TCardinalDirection { cd_North, cd_NorthEast, cd_East, cd_SouthEast, cd_South, cd_SouthWest, cd_West, 
	cd_NorthWest, cd_Center };
#pragma option pop

#pragma option push -b
enum TVideoRotation { rt_0_deg, rt_90_deg, rt_180_deg, rt_270_deg, rt_0_deg_mirror, rt_90_deg_mirror, 
	rt_180_deg_mirror, rt_270_deg_mirror, rt_custom_angle, rt_custom_angle_mirror };
#pragma option pop

#pragma option push -b
enum TVideoDeinterlacing { di_Disabled, di_HalfSize, di_FullSize, di_DScaler, di_AVISynth, di_FFDShow, 
	di_ThirdPartyDeinterlacer };
#pragma option pop

#pragma option push -b
enum TThirdPartyFilterList { tpf_VideoSource, tpf_VideoPreview, tpf_VideoRecording, tpf_AudioSource, 
	tpf_AudioRendering, tpf_AudioRecording, tpf_VideoRendering, tpf_VideoRenderer, tpf_AudioRenderer, tpf_ThirdPartyVideoSource, 
	tpf_ThirdPartyAudioSource, tpf_AddToGraph };
#pragma option pop
...
#pragma option push -b
enum TFormatType { ft_VideoInfo, ft_VideoInfo2, ft_DvInfo, ft_Mpeg1Video, ft_Mpeg2Video, ft_Mpeg1Stream, 
	ft_Mpeg2Stream, ft_MpegStreamType, ft_MpegCustom, ft_WaveFormatEx, ft_Mpeg1Audio, ft_Mpeg2Audio, ft_Mpeg3Audio, 
	ft_OGG, ft_Unknown };
#pragma option pop
...
enum TAudioFormat { af_default, af_8000_8b_1ch, af_8000_8b_2ch, af_8000_16b_1ch, af_8000_16b_2ch, af_11025_8b_1ch, 
	af_11025_8b_2ch, af_11025_16b_1ch, af_11025_16b_2ch, af_16000_8b_1ch, af_16000_8b_2ch, af_16000_16b_1ch, 
	af_16000_16b_2ch, af_22050_8b_1ch, af_22050_8b_2ch, af_22050_16b_1ch, af_22050_16b_2ch, af_32000_8b_1ch, 
	af_32000_8b_2ch, af_32000_16b_1ch, af_32000_16b_2ch, af_44100_8b_1ch, af_44100_8b_2ch, af_44100_16b_1ch, 
	af_44100_16b_2ch, af_48000_8b_1ch, af_48000_8b_2ch, af_48000_16b_1ch, af_48000_16b_2ch };
#pragma option pop

#pragma option push -b
enum TAudioChannelRenderMode { acrm_Normal, acrm_RenderLeft, acrm_RenderRight, acrm_MuteLeft, acrm_MuteRight, 
	acrm_Mute_All, acrm_MixLeftAndRight, acrm_PassThru };
#pragma option pop

#pragma option push -b
enum TVideoRenderer { vr_AutoSelect, vr_EVR, vr_VMR9, vr_VMR7, vr_StandardRenderer, vr_OverlayRenderer, 
	vr_RecordingPriority, vr_None };
#pragma option pop

#pragma option push -b
enum TVideoRendererExternal { vre_None, vre_Matrox_PRO, vre_Decklink_SD, vre_Decklink_Extreme, vre_Pinnacle_MovieBoard, 
	vre_BlackMagic_Decklink };
#pragma option pop
...
#pragma option push -b
enum TPointGreyConfig { pgr_SetRegister, pgr_GetRegister, pgr_SetBufferSize, pgr_GetBufferSize, pgr_SetFormat, 
	pgr_GetFormat };
#pragma option pop
...
#pragma option push -b
enum TVideoSource { vs_VideoCaptureDevice, vs_ScreenRecording, vs_VideoFileOrURL, vs_JPEGsOrBitmaps, 
	vs_IPCamera, vs_Mixer, vs_VideoFromImages, vs_ThirdPartyFilter };
#pragma option pop
...
#pragma option push -b
enum TASFDeinterlaceMode { adm_NotInterlaced, adm_DeinterlaceNormal, adm_DeinterlaceHalfSize, adm_DeinterlaceHalfSizeDoubleRate, 
	adm_DeinterlaceInverseTelecine, adm_DeinterlaceVerticalHalfSizeDoubleRate };
#pragma option pop
...
#pragma option push -b
enum TPlaylist { pl_Add, pl_Remove, pl_Clear, pl_Loop, pl_NoLoop, pl_Play, pl_Stop, pl_Next, pl_Previous, 
	pl_SortAlpha, pl_SortRevAlpha, pl_Random, pl_Sequential, pl_SpecifyPositions, pl_Transition };
#pragma option pop

#pragma option push -b
enum TVideoQuality { vq_Brightness, vq_Contrast, vq_Hue, vq_Saturation, vq_Sharpness, vq_Gamma, vq_ColorEnable, 
	vq_WhiteBalance, vq_BacklightCompensation, vq_Gain };
#pragma option pop
...
#pragma option push -b
enum TPlayerState { ps_Closed, ps_Stopped, ps_Paused, ps_Playing, ps_PlayingBackward, ps_FastForwarding, 
	ps_FastRewinding, ps_Downloading, ps_DownloadCompleted, ps_DownloadCancelled };
#pragma option pop
...
#pragma option push -b
enum TAero { ae_Default, ae_AutoBestRenderingQuality, ae_ForceOnWhenStartingVideo, ae_ForceOffWhenStartingVideo, 
	ae_ForceOnImmediately, ae_ForceOffImmediately };
#pragma option pop

#pragma option push -b
enum TMPEGProgramSetting { mps_Program_Number, mps_Program_PCR_PID, mps_VideoStream_PID, mps_AudioStream_PID, 
	mps_VideoStream_Type, mps_AudioStream_Type, mps_VideoFormat_Width, mps_VideoFormat_Height, mps_VideoAspectRatio_X, 
	mps_VideoAspectRatio_Y, mps_ReceiveTimeoutInSeconds };
#pragma option pop

#pragma option push -b
enum TFrameInfoId { fi_FrameNumber, fi_DroppedFrameCount, fi_SampleTime_Hour, fi_SampleTime_Min, fi_SampleTime_Sec, 
	fi_SampleTime_Hs, fi_SampleTime_TotalMin, fi_DVTimeCode_IsAvailable, fi_DVTimeCode_Hour, fi_DVTimeCode_Min, 
	fi_DVTimeCode_Sec, fi_DVTimeCode_Ff, fi_DVTimeCode_TrackNumber, fi_DVDateTime_IsAvailable, fi_DVDateTime_Year, 
	fi_DVDateTime_Month, fi_DVDateTime_Day, fi_DVDateTime_Hour, fi_DVDateTime_Min, fi_DVDateTime_Sec };
	
#pragma option pop

#pragma option push -b
enum TFrameInfoStringId { fis_DVTimeCode, fis_DVDateTime, fis_TimeCode, fis_FrameTime, fis_FrameNumber, 
	fis_FullInfo };
#pragma option pop
...
#pragma option push -b
enum TMultiplexedRole { mr_NotMultiplexed, mr_MultiplexedMosaic4, mr_MultiplexedMosaic16, mr_MultiplexedMaster, 
	mr_MultiplexedSlave };
#pragma option pop

#pragma option push -b
enum TMpegStreamType { mpst_Default, mpst_Program, mpst_Program_DVD, mpst_Program_DVD_MC, mpst_Program_SVCD, 
	mpst_MPEG1, mpst_MPEG1_VCD };
#pragma option pop

#pragma option push -b
enum TLogType { e_add_filter, e_add_source_filter, e_audio_compressor_not_suitable, e_bind_moniker_to_filter, 
	e_compressor_possibly_not_suitable, e_create_instance, e_ddraw_caps_not_suitable, e_device_in_use_in_another_graph, 
	e_disk_full, e_failed, e_failed_to_allocate_recording_file, e_failed_to_bind_codec, e_failed_to_connect_crossbar_pin, 
	e_failed_to_connect_to_server, e_failed_to_create_directory, e_failed_to_create_file, e_failed_to_create_temp, 
	e_failed_to_bind_frame_grabber, e_failed_to_load_ASF_profile, e_failed_to_load_ASF_profile_custom_file, 
	e_failed_to_load_set_of_bitmaps, e_failed_to_set_image_overlay, e_failed_to_set_logo, e_failed_to_play_backwards, 
	e_failed_to_render_file, e_failed_to_renew_recording_file, e_failed_to_set_player_speed_ratio_with_audio, 
	e_failed_to_setup_network_streaming, e_failed_to_start_preview, e_failed_to_start_recording, e_file_in_use, 
	e_file_name_not_specified, e_file_not_found, e_get_audio_format, e_get_interface, e_get_video_format, 
	e_graph_error, e_graph_cant_run, e_graph_must_be_restarted, e_hw_deinterlace_not_supported, e_incompatible_options, 
	e_index_out_of_range, e_invalid_directory, e_library_not_found, e_load_filter, e_no_audio_In_device, 
	e_no_device_available, e_no_dialog, e_no_stream_control, e_no_tv_tuner, e_no_device_selected, e_no_video_input_device, 
	e_not_allowed_during_network_streaming, e_not_allowed_with_streaming_URL, e_not_assigned, e_not_multiplexed_master, 
	e_not_previewing, e_not_recording, e_not_reencoding, e_not_streaming, e_out_of_memory, e_pause_resume_disabled, 
	e_pin_not_found, e_interface_not_assigned, e_query_config_avi_mux, e_reencoding, e_recording_cannot_pause, 
	e_render_audio_stream, e_render_video_stream, e_must_restart_master, e_recording_on_motion_failed, 
	e_sendtodv_device_index_out_of_bound, e_sendtodv_deviceindex_and_videodevice_have_same_value, e_sendtodv_failed_to_bind_dv_device, 
	e_set_filter_graph, e_set_interleaving_mode, e_set_master_stream, e_set_output_compatibility_index, 
	e_set_output_file_name, e_set_format, e_start_preview_first, e_stop_player_first, e_stop_preview_first, 
	e_stop_recording_first, e_stop_reencoding_first, e_storage_path_read_only, e_streaming_type_not_specified, 
	e_third_party_filter_already_inserted, e_third_party_filter_error, e_trace_log, e_tv_command_not_allowed_during_tv_tuning, 
	e_tuner_input_not_selected, e_TVideoGrabber_Filter_obsolete, e_value_out_of_range, e_video_compressor_not_suitable, 
	e_window_transparency_failed, e_invalid_size, e_invalid_window_handle, e_tuner_mode_not_supported, 
	e_publishing_point_connection_failed, e_speaker_control_disabled, i_audio_device_associated_to_video_device, 
	i_begin_discovering_device, i_binding_device_or_compressor, i_discovering_device, i_end_discovering_device, 
	i_preallocated_file_size_large_enough, i_preallocated_file_size_changed, i_preallocated_file_not_suitable, 
	i_streaming_to_publishing_point, i_third_party_filter_inserted, i_using_ASF_Profile, i_recording_videosubtype, 
	i_ismpegstream, i_new_recording_filename, i_using_property_group, i_streaming_client_connected, i_streaming_client_disconnected, 
	i_refreshing_preview, i_recording_on_motion, i_window_found, i_limiting_preview, i_codec_recommended, 
	i_tuner_mode, i_DV_date_time_discontinuity, w_cannot_connect_thirdparty_filter, w_cannot_connect_thirdparty_renderer, 
	w_cannot_instantiate_thirdparty_filter, w_cannot_route_crossbar, w_cannot_use_color_key, w_command_delayed, 
	w_does_not_apply_to_dv, w_find_audio_device, w_filter_does_not_save_properties, w_frame_grabber_requires_CPU, 
	w_hold_recording, w_information, w_not_playing, w_player_audio_should_be_disabled, w_recording_cancelled_by_user, 
	w_can_pause_and_ASF_incompatible, w_set_audio_format, w_storage_path_on_network, w_tv_tuner, w_using_nearest_video_size, 
	w_divx_codec_not_installed, w_codec_does_not_support_debugger, w_divx_codec_profile, w_device_partially_supported, 
	w_excessive_grid_size, w_grid_too_large_for_dialog, w_operation_may_lock, w_audio_streaming_needs_audiorecording_property_enabled, 
	w_network_streaming_disabled, w_server_lost_next_retry, w_overlay_mixer_not_available, w_network_streaming_change_requires_application_to_be_restarted, 
	w_standard_renderer_recommended, w_window_transparency_and_recording_not_recommended, w_clip_not_seekable, 
	w_only_WMV_recording_during_network_streaming, w_check_analog_video_standard, w_recording_timer_set, 
	w_stream_time_beyong_script_time, w_generate_new_file, w_hires_timer_not_available, w_applies_to_the_current_recording_method, 
...
#pragma option push -b
enum TVUMeterSetting { vu_Handle, vu_WarningPercent, vu_PeakPercent, vu_BkgndColor, vu_NormalColor, 
	vu_WarningColor, vu_PeakColor, vu_TickSize, vu_TickInterval, vu_NeedleThickness };
#pragma option pop
...
#pragma option push -b
enum TVideoWindowNotify { vwActive, vwVisible, vwAutoSize, vwEmbedded, vwColorKeyEnabled, vwAlphaBlendEnabled, 
	vwFullScreen, vwStayOnTop, vwMouseMovesWindow, vwVideoPortEnabled, vwMonitor, vwAspectRatio, vwVideoWidth, 
	vwVideoHeight, vwPanScanRatio, vwColorKeyValue, vwAlphaBlendValue, vwLeft, vwTop, vwLocation };
#pragma option pop
...
typedef void __fastcall (__closure *TOnAudioPeak)(System::TObject* Sender, double Left_Percent, double 
	Left_DB, double Right_Percent, double Right_DB);

typedef void __fastcall (__closure *TOnClientConnection)(System::TObject* Sender, bool Connected, AnsiString 
	ClientInfo);
...
typedef void __fastcall (__closure *TOnLog)(System::TObject* Sender, TLogType LogType, AnsiString Severity
	, AnsiString InfoMsg);

typedef void __fastcall (__closure *TOnSourceFileToDestFileStarted)(System::TObject* Sender, AnsiString 
	SourceFile, AnsiString DestFile);

typedef void __fastcall (__closure *TOnSourceFileToDestFileCompleted)(System::TObject* Sender, AnsiString 
	SourceFile, AnsiString DestFile, bool Success);

typedef void __fastcall (__closure *TOnFileNotification)(System::TObject* Sender, AnsiString FileName
	);

typedef void __fastcall (__closure *TOnCreatePreallocatedFileCompleted)(System::TObject* Sender, AnsiString 
...
typedef void __fastcall (__closure *TOnRecordingCompleted)(System::TObject* Sender, AnsiString FileName
	, bool Success);

typedef void __fastcall (__closure *TOnEnumerateWindows)(System::TObject* Sender, int WindowHandle, 
	AnsiString WindowName, AnsiString WindowClass);

typedef void __fastcall (__closure *TOnVideoFromBitmapsNextFrameNeeded)(System::TObject* Sender, bool 
	FirstSample);

typedef void __fastcall (__closure *TOnDVCommandCompleted)(System::TObject* Sender, int NewStateValue
	, AnsiString NewStateLabel);

typedef void __fastcall (__closure *TOnDeviceArrivalOrRemoval)(System::TObject* Sender, bool IsDeviceArrival
	, bool IsVideoDevice, AnsiString DeviceName, int DeviceIndex);

typedef void __fastcall (__closure *TOnPlayerBufferingData)(System::TObject* Sender, bool StartingToBuffer
	);

typedef void __fastcall (__closure *TOnDirectNetworkStreamingHostUrl)(System::TObject* Sender, AnsiString 
	HostUrl, AnsiString HostName, int HostPort);

typedef void __fastcall (__closure *TOnAuthenticationNeeded)(System::TObject* Sender, TAuthenticationType 
	AuthenticationType, AnsiString Realm, AnsiString Server, AnsiString &Username, AnsiString &Password
	);

typedef void __fastcall (__closure *TOnVideoCompressionSettings)(System::TObject* Sender, bool CanKeyFrameRate
	, bool CanPFramesPerKeyFrame, bool CanQuality, bool CanWindowSize, bool CanSpecifyDataRate, int DefaultFrameRate
	, int DefaultPFramesPerKey, double DefaultQuality, int DefaultWindowSize, int DefaultDataRate);

typedef void __fastcall (__closure *TOnColorKeyChange)(System::TObject* Sender, Graphics::TColor ColorKey
	);

typedef void __fastcall (__closure *TOnPlayerStateChanged)(System::TObject* Sender, TPlayerState OldPlayerState
	, TPlayerState NewPlayerState);

typedef void __fastcall (__closure *TOnTVChannelSelected)(System::TObject* Sender, int Channel, bool 
	Locked, int DefaultVideoFrequency, int OverriddenVideoFrequency, int TunerVideoFrequency, int TunerAudioFrequency
	);

typedef void __fastcall (__closure *TOnTVChannelScanStarted)(System::TObject* Sender, int MinChannel
	, int MaxChannel);

typedef void __fastcall (__closure *TOnThirdPartyFilterConnected)(System::TObject* Sender, TThirdPartyFilterList 
	Location, _di_IUnknown Intf);

typedef void __fastcall (__closure *TOnFilterSelected)(System::TObject* Sender, AnsiString FilterName
	, bool &RejectFilter);

typedef void __fastcall (__closure *TOnFrameCaptureCompleted)(System::TObject* Sender, void * FrameBitmap
	, int BitmapWidth, int BitmapHeight, unsigned FrameNumber, __int64 FrameTime, TFrameCaptureDest DestType
	, AnsiString FileName, bool Success, int FrameId);

typedef void __fastcall (__closure *TOnFrameProgress)(System::TObject* Sender, unsigned FrameNumber, 
	__int64 FrameTime, int FrameId);

typedef void __fastcall (__closure *TOnAVIDurationUpdated)(System::TObject* Sender, AnsiString FileName
	, unsigned FrameCount, double &FrameRate, __int64 &Duration);

typedef void __fastcall (__closure *TOnMotionDetected)(System::TObject* Sender, double GlobalMotionRatio
	, int MaxMotionCellX, int MaxMotionCellY, void * FrameBitmap, unsigned FrameNumber, __int64 FrameTime
	, int FrameId, bool &CaptureFrame);

typedef void __fastcall (__closure *TOnMotionNotDetected)(System::TObject* Sender, void * FrameBitmap
	, unsigned FrameNumber, __int64 FrameTime, int FrameId, bool &CaptureFrame);

typedef void __fastcall (__closure *TOnProgress)(System::TObject* Sender, int Percent, __int64 Position
	, __int64 Duration);

typedef void __fastcall (__closure *TOnProgressCommented)(System::TObject* Sender, int Percent, __int64 
	Position, __int64 Duration, AnsiString Comment);

typedef void __fastcall (__closure *TOnFrameOverlayUsingDC)(System::TObject* Sender, HDC Dc, unsigned 
	FrameNumber, __int64 FrameTime, int FrameId);

typedef void __fastcall (__closure *TOnFrameOverlayUsingDIB)(System::TObject* Sender, HBITMAP FrameBitmapHandle
	, unsigned FrameNumber, __int64 FrameTime, int FrameId);

typedef void __fastcall (__closure *TOnFrameOverlayUsingVIDEOHDR)(System::TObject* Sender, unsigned 
	FrameNumber, __int64 FrameTime, int FrameId, const TVideoHdr &VideoHdr);

typedef void __fastcall (__closure *TOnRawAudioSample)(System::TObject* Sender, void * pSampleBuffer
	, int SampleBufferSize, int SampleDataLength, TFormatType FormatType, void * pFormat, void * pWaveFormatEx
	, __int64 SampleStartTime, __int64 SampleStopTime);

typedef void __fastcall (__closure *TOnRawVideoSample)(System::TObject* Sender, void * pSampleBuffer
	, int SampleBufferSize, int SampleDataLength, TFormatType FormatType, void * pFormat, void * pBitmapInfoHeader
	, __int64 SampleStartTime, __int64 SampleStopTime);

typedef void __fastcall (__closure *TOnVideoKeyPress)(System::TObject* Sender, int VideoWindow, char 
	&Key, int PhysicalKey, Classes::TShiftState ShiftState);

typedef void __fastcall (__closure *TOnVideoMouseUpDown)(System::TObject* Sender, int VideoWindow, Controls::TMouseButton 
	Button, Classes::TShiftState Shift, int X, int Y);

typedef void __fastcall (__closure *TOnVideoMouseMove)(System::TObject* Sender, int VideoWindow, Classes::TShiftState 
	Shift, int X, int Y);

typedef void __fastcall (__closure *TOnMouseWheel)(System::TObject* Sender, int VideoWindow, bool DirectionUp
	, int X, int Y);

typedef void __fastcall (__closure *TOnTextOverlayScrollingCompleted)(System::TObject* Sender, int TextOverlayIndex
	);

typedef void __fastcall (__closure *TOnFrameBitmap)(System::TObject* Sender, pFrameInfo FrameInfo, pFrameBitmapInfo 
	BitmapInfo);
...
private:
	...
	AnsiString __fastcall GetASFMediaServerPublishingPoint();
	AnsiString __fastcall GetASFMediaServerTemplatePublishingPoint();
	...
	AnsiString __fastcall GetASFProfileFromCustomFile();
	...
	AnsiString __fastcall GetAutoFilePrefix();
	...
	AnsiString __fastcall GetCaptureFileExt();
	...
	AnsiString __fastcall GetIPCameraURL();
	...
	AnsiString __fastcall GetLicenseString();
	bool __fastcall GetLogoDisplayed(void);
	TLogoLayout __fastcall GetLogoLayout(void);
	AnsiString __fastcall GetMotionDetector_Grid();
	...
	AnsiString __fastcall GetPlayerFileName();
	AnsiString __fastcall GetPlayerForcedCodec();
	...
	AnsiString __fastcall GetPreallocCapFileName();
	...
	AnsiString __fastcall GetRecordingFileName();
	...
	AnsiString __fastcall GetReencodingNewVideoClip();
	AnsiString __fastcall GetReencodingSourceVideoClip();
	...
	AnsiString __fastcall GetStoragePath();
	...
	AnsiString __fastcall GetTextOverlayString();
	int __fastcall GetTextOverlayTop(void);
	bool __fastcall GetTextOverlayTransparent(void);
	AnsiString __fastcall GetThirdPartyDeinterlacer();
	...
	AnsiString __fastcall GetVideoFromImages_SourceDirectory();
	TFileSort __fastcall GetVideoFromImages_BitmapsSortedBy(void);
	AnsiString __fastcall GetVideoFromImages_TemporaryFile();
	...
	AnsiString __fastcall GetVideoSource_FileOrURL();
	...
	void __fastcall SetASFMediaServerPublishingPoint(AnsiString Value);
	void __fastcall SetASFMediaServerTemplatePublishingPoint(AnsiString Value);
	...
	void __fastcall SetASFProfileFromCustomFile(AnsiString Value);
	...
	void __fastcall SetAutoFilePrefix(AnsiString Value);
	...
	void __fastcall SetCaptureFileExt(AnsiString Value);
	...
	void __fastcall SetIPCameraURL(AnsiString Value);
	...
	void __fastcall SetLicenseString(AnsiString Value);
	void __fastcall SetLogoDisplayed(bool Value);
	void __fastcall SetLogoLayout(TLogoLayout Value);
	void __fastcall SetMotionDetector_Grid(AnsiString Value);
	...
	void __fastcall SetPlayerFileName(AnsiString Value);
	void __fastcall SetPlayerForcedCodec(AnsiString Value);
	...
	void __fastcall SetPreallocCapFileName(AnsiString Value);
	...
	void __fastcall SetRecordingFileName(AnsiString Value);
	...
	void __fastcall SetReencodingNewVideoClip(AnsiString Value);
	void __fastcall SetReencodingSourceVideoClip(AnsiString Value);
	...
	void __fastcall SetStoragePath(AnsiString Value);
	...
	void __fastcall SetTextOverlayString(AnsiString Value);
	void __fastcall SetTextOverlayTop(int Value);
	void __fastcall SetTextOverlayTransparent(bool Value);
	void __fastcall SetThirdPartyDeinterlacer(AnsiString Value);
	...
	void __fastcall SetVideoFromImages_SourceDirectory(AnsiString Value);
	void __fastcall SetVideoFromImages_TemporaryFile(AnsiString Value);
	...
	void __fastcall SetVideoSource_FileOrURL(AnsiString Value);
	...
	AnsiString __fastcall GetDirectShowFilters();
	...
	AnsiString __fastcall GetAudioCompressors();
	int __fastcall GetAudioCompressorsCount(void);
	AnsiString __fastcall GetAudioDevices();
	int __fastcall GetAudioDevicesCount(void);
	AnsiString __fastcall GetAudioRenderers();
	...
	AnsiString __fastcall GetLast_BurstFrameCapture_FileName();
	AnsiString __fastcall GetLast_CaptureFrameTo_FileName();
	AnsiString __fastcall GetLast_Recording_FileName();
	AnsiString __fastcall GetLast_Clip_Played();
	...
	AnsiString __fastcall GetMultiplexerName();
	AnsiString __fastcall GetMultiplexers();
	...
	AnsiString __fastcall GetPropertyPageSaverGroup();
	...
	AnsiString __fastcall GetRecordingFourCC();
	...
	AnsiString __fastcall GetStreamingURL();
	AnsiString __fastcall GetSystemTempPath();
	...
	AnsiString __fastcall GetVideoCompressorName();
	AnsiString __fastcall GetVideoCompressors();
	int __fastcall GetVideoCompressorsCount(void);
	AnsiString __fastcall GetVideoDevices();
	AnsiString __fastcall GetVideoDevicesId();
	int __fastcall GetVideoDevicesCount(void);
	AnsiString __fastcall GetVideoFormats();
	int __fastcall GetVideoFormatsCount(void);
	AnsiString __fastcall GetVideoInputs();
	int __fastcall GetVideoInputsCount(void);
	AnsiString __fastcall GetVideoDeviceName();
	AnsiString __fastcall GetVideoSizes();
	...
	AnsiString __fastcall GetVideoSources();
	int __fastcall GetVideoSourcesCount(void);
	AnsiString __fastcall GetVideoSubtypes();
	...
	void __fastcall SetPropertyPageSaverGroup(AnsiString Value);
...
public:
	...
	int __fastcall AnalogVideoStandardIndex(AnsiString Value);
	AnsiString __fastcall ASFStreaming_GetAuthorizationList();
	AnsiString __fastcall ASFStreaming_GetConnectedClients();
	int __fastcall ASFStreaming_GetConnectedClientsCount(void);
	bool __fastcall ASFStreaming_ResetAuthorizations(void);
	bool __fastcall ASFStreaming_SetAuthorization(bool Allowed, AnsiString IP, AnsiString Mask);
	bool __fastcall AssociateMultiplexedSlave(int InputNumber, int SlaveUniqueID);
	int __fastcall AudioCompressorIndex(AnsiString Value);
	int __fastcall AudioDeviceIndex(AnsiString Value);
	int __fastcall AudioRendererIndex(AnsiString Value);
	int __fastcall AudioInputIndex(AnsiString Value);
	AnsiString __fastcall AVIInfo2(AnsiString AVIFile, TAVIInfoType AVIInfoType);
	AnsiString __fastcall AVIHeaderInfo(AnsiString AVIFile, THeaderAttribute HeaderAttribute);
	...
	bool __fastcall CaptureFrameSyncTo(TFrameCaptureDest Dest, AnsiString FileName);
	void __fastcall ClearHeaderAttributes(void);
	void __fastcall ClosePlayer(void);
	void __fastcall ContinueProcessing(void);
	HBITMAP __fastcall GetLastFrameAsHBITMAP(int BufferIndex, bool WithOverlays, int SrcLeftLocation, int 
		SrcTopLocation, int SrcWidth, int SrcHeight, int DestWidth, int DestHeight, int BitmapColorBitCount
		);
	Graphics::TBitmap* __fastcall GetLastFrameAsTBitmap(int BufferIndex, bool WithOverlays, int SrcLeftLocation
		, int SrcTopLocation, int SrcWidth, int SrcHeight, int DestWidth, int DestHeight, int BitmapColorBitCount
		);
	bool __fastcall CreatePreallocCapFile(void);
	double __fastcall DVDInfo(AnsiString DVDRootDirectory, TDVDInfoType DVDInfoType, int TitleNumber);
	...
	bool __fastcall DrawBitmapOverFrame(Graphics::TBitmap* Bitmap, bool Stretched, int LeftLocation, int 
		TopLocation, int bmWidth, int bmHeight, bool Transparent, bool UseTransparentColor, Graphics::TColor 
		TransparentColorValue, bool AlphaBlend, int AlphaBlendValue, bool ChromaKey, int ChromaKeyRGBColor
		, int ChromaKeyLeewayPercent);
	...
	int __fastcall FindIndexInListByName(AnsiString List, AnsiString SearchedString, bool IsSubString, 
		bool IgnoreCase);
	AnsiString __fastcall GetAudioCodec();
	unsigned __fastcall GetFrameInfo(int FrameId, TFrameInfoId FrameInfoId);
	AnsiString __fastcall GetFrameInfoString(TFrameInfoStringId FrameInfoStringId);
	AnsiString __fastcall GetItemNameFromList(AnsiString List, int ItemIndex);
	int __fastcall GetMiscDeviceControl(TMiscDeviceControl MiscDeviceControl, int Index);
	AnsiString __fastcall GetLogString(TLogType Value);
	...
	AnsiString __fastcall GetPlaylist();
	bool __fastcall GetTranslatedCoordinates(int DisplayIndex, int NativeX, int NativeY, int &TranslatedX
		, int &TranslatedY);
	int __fastcall GetTVChannelInfo(TTVChannelInfo Value);
	AnsiString __fastcall GetVideoCodec();
	int __fastcall GetVideoWidthFromIndex(int Index);
	int __fastcall GetVideoHeightFromIndex(int Index);
	void __fastcall GetNearestVideoSize(int PreferredVideoWidth, int PreferredVideoHeight, /* out */ int 
		&NearestVideoWidth, /* out */ int &NearestVideoHeight);
	bool __fastcall GetVMR9ImageAdjustmentBounds(bool MainDisplay, TVMR9ImageAdjustment VMR9ControlSetting
		, /* out */ int &MinValue, /* out */ int &MaxValue, /* out */ int &StepSize, /* out */ int &DefaultValue
		, /* out */ int &CurrentValue);
	bool __fastcall GetVideoSizeFromIndex(int Index, /* out */ int &_VideoWidth, /* out */ int &_VideoHeight
		);
	bool __fastcall AVIDuration(AnsiString AVIFile, /* out */ __int64 &Duration, /* out */ __int64 &FrameCount
		);
	bool __fastcall AVIInfo(AnsiString AVIFile, /* out */ __int64 &Duration, /* out */ __int64 &FrameCount
		, /* out */ int &_VideoWidth, /* out */ int &_VideoHeight, /* out */ double &VideoFrameRateFps, /* out */ 
		int &AvgBitRate, /* out */ int &AudioChannels, /* out */ int &AudioSamplesPerSec, /* out */ int &AudioBitsPerSample
		, /* out */ AnsiString &VideoCodec, /* out */ AnsiString &AudioCodec);
	bool __fastcall GetVideoCompressionSettings(/* out */ int &DataRate, /* out */ int &KeyFrameRate, /* out */ 
		int &PFramesPerKeyFrame, /* out */ int &WindowSize, /* out */ double &Quality, /* out */ bool &CanQuality
		, /* out */ bool &CanCrunch, /* out */ bool &CanKeyFrame, /* out */ bool &CanBFrame, /* out */ bool 
		&CanWindow);
	...
	bool __fastcall IsVideoSignalDetected(bool DetectConnexantBlueScreen, bool DetectCustomRGB, int CustomR
		, int CustomG, int CustomB, bool UseAsMaxValues);
	bool __fastcall IsDVDevice(int Index);
	bool __fastcall LoadCompressorSettingsFromDataString(bool IsVideoCompressor, int CompressorIndex, AnsiString 
		DataString);
	bool __fastcall LoadCompressorSettingsFromTextFile(bool IsVideoCompressor, int CompressorIndex, AnsiString 
		FileName);
	bool __fastcall MixAudioSamples(void * pSampleBuffer, int SampleBufferSize, int SampleDataLength, TFormatType 
		SampleFormatType, void * pFormat, __int64 SampleStartTime, __int64 SampleStopTime);
	...
	AnsiString __fastcall MotionDetector_Get2DTextGrid();
	AnsiString __fastcall MotionDetector_Get2DTextMotion();
	...
	bool __fastcall MotionDetector_UseThisReferenceSample(Graphics::TBitmap* Bitmap, AnsiString BMPFile
		, AnsiString JPEGFile);
	int __fastcall MultiplexerIndex(AnsiString Value);
	...
	BOOL __fastcall OpenPlayerAtFramePositions(__int64 StartFrame, __int64 StopFrame, bool KeepBounds, 
		bool CloseAndReopenIfAlreadyOpened);
	BOOL __fastcall OpenPlayerAtTimePositions(__int64 StartTime, __int64 StopTime, bool KeepBounds, bool 
		CloseAndReopenIfAlreadyOpened);
	bool __fastcall PauseRecording(void);
	void __fastcall PausePlayer(void);
	bool __fastcall PlayerFrameStep(int FrameCount);
	bool __fastcall Playlist(TPlaylist PlaylistAction, AnsiString VideoClip);
	unsigned __fastcall RecordingKBytesWrittenToDisk(void);
	bool __fastcall ReencodeVideoClip(AnsiString SourceVideoClip, AnsiString NewVideoClip, bool IncludeVideoStream
		, bool IncludeAudioStream, bool UseFrameGrabber, bool UseCurrentVideoCompressor, bool UseCurrentAudioCompressor
		);
	...
	int __fastcall VideoCompressorIndex(AnsiString Value);
	int __fastcall VideoDeviceIndex(AnsiString Value);
	int __fastcall VideoFormatIndex(AnsiString Value);
	int __fastcall VideoInputIndex(AnsiString Value);
	int __fastcall VideoSizeIndex(AnsiString Value);
	int __fastcall VideoSubtypeIndex(AnsiString Value);
	bool __fastcall SendDVCommand(TDVCommand DVCommand);
	bool __fastcall SendIPCameraCommand(AnsiString IPCameraCommand);
	void __fastcall SetAuthentication(TAuthenticationType AuthenticationType, AnsiString UserName, AnsiString 
		Password);
	int __fastcall Mixer_AddToMixer(int SourceUniqueID, int SourceVideoInput, int MosaicLine, int MosaicColumn
		, int AlternatedGroup, int AlternatedTimeIntervalInMs, bool ReplacePreviouslyAdded, bool CanEraseBackground
		);
	...
	int __fastcall Mixer_SetupPIPFromSource(int SourceUniqueID, int Source_Left, int Source_Top, int Source_Width
		, int Source_Height, bool ActivatePIP, int PIP_Left, int PIP_Top, int PIP_Width, int PIP_Height, bool 
		MoveToTop);
	...
	AnsiString __fastcall SaveCompressorSettingsToDataString(bool IsVideoCompressor, int CompressorIndex
		);
	bool __fastcall SaveCompressorSettingsToTextFile(bool IsVideoCompressor, int CompressorIndex, AnsiString 
		FileName);
	...
	void __fastcall SetMultiplexerFilterByName(AnsiString Value);
	void __fastcall SetTextOverlayCustomVar(int TextOverlaySelector, int VarIndex, AnsiString VarText);
		
	bool __fastcall SetVideoCompressionDefaults(void);
	bool __fastcall SetVideoCompressionSettings(int DataRate, int KeyFrameRate, int PFramesPerKeyFrame, 
		int WindowSize, double Quality);
	bool __fastcall SetVideoControlMode(bool FlipHorizontal, bool FlipVertical, bool ExternalTriggerEnable
		, bool Trigger);
	bool __fastcall SetVideoQuality(TVideoQuality Setting, bool SetAuto, bool SetDefault, int SetValue)
		;
	bool __fastcall SetVMR9ImageAdjustmentValue(bool MainDisplay, TVMR9ImageAdjustment VMR9ControlSetting
		, int Value, bool FixRange);
	...
	int __fastcall PointGreyConfig(TPointGreyConfig ConfigType, unsigned &PGRActionValue, unsigned ulRegister
		, unsigned ulMode, unsigned ulLeft, unsigned ulTop, unsigned ulWidth, unsigned ulHeight, unsigned 
		ulPercentage, unsigned ulFormat);
	bool __fastcall ResetPreview(void);
	bool __fastcall ResumePreview(void);
	bool __fastcall RecordToNewFileNow(AnsiString NewRecordingFileName, bool ResetStreamTime);
	void __fastcall RetrieveInitialXYAfterRotation(int X, int Y, int &OriginalX, int &OriginalY);
	bool __fastcall SendImageToVideoFromBitmaps(AnsiString ImageFilePath, unsigned BitmapHandle, bool CanFreeBitmapHandle
		, bool EndOfData);
	void __fastcall SetHeaderAttribute(THeaderAttribute HeaderAttribute, AnsiString Value);
	void __fastcall SetImageOverlayAttributes(int LeftLocation, int TopLocation, int StretchedWidth, int 
		StretchedHeight, bool Transparent, bool UseTransparentColor, int TransparentColorValue, bool AlphaBlend
		, int AlphaBlendValue);
	bool __fastcall SetImageOverlayFromImageFile(AnsiString FileName);
	bool __fastcall SetImageOverlayFromBMPFile(AnsiString FileName);
	bool __fastcall SetImageOverlayFromJPEGFile(AnsiString FileName);
	...
	bool __fastcall SetLogoFromBMPFile(AnsiString FileName);
	bool __fastcall SetLogoFromJPEGFile(AnsiString FileName);
	...
	bool __fastcall ScreenRecordingUsingCoordinates(bool FunctionEnabled, int scLeft, int scTop, int scWidth
		, int scHeight);
	...
	bool __fastcall SetWindowRecordingByName(AnsiString WindowName, bool ExactMatch);
	...
	bool __fastcall TextOverlay_CreateCustomFont(int fHeight, int fWidth, int fEscapement, int fOrientation
		, int fWeight, bool fItalic, bool fUnderline, bool fStrikeOut, unsigned fCharSet, unsigned fOutputPrecision
		, unsigned fClipPrecision, unsigned fQuality, unsigned fPitchAndFamily, AnsiString FontFacename);
	bool __fastcall ThirdPartyFilter_AddToList(TThirdPartyFilterList Location, AnsiString GUIDString, AnsiString 
		OptionalDLLFilePath, AnsiString FilterName, bool Enable, bool CanSaveFilterState);
	bool __fastcall ThirdPartyFilter_ClearList(void);
	bool __fastcall ThirdPartyFilter_Enable(TThirdPartyFilterList Location, AnsiString GUIDString, bool 
		Enable);
	bool __fastcall ThirdPartyFilter_RemoveFromList(TThirdPartyFilterList Location, AnsiString GUIDString
		);
	bool __fastcall ThirdPartyFilter_ShowDialog(TThirdPartyFilterList Location, AnsiString GUIDString);
	...
	bool __fastcall WriteScriptCommand(AnsiString ScriptType, AnsiString ScriptArgument);
...
public:
	...
	__property AnsiString AnalogVideoStandards = {read=GetAnalogVideoStandards};
	__property int AnalogVideoStandardsCount = {read=GetAnalogVideoStandardsCount, nodefault};
	__property AnsiString ASFProfiles = {read=GetASFProfiles};
	...
	__property AnsiString AudioCompressorName = {read=GetAudioCompressorName};
	__property AnsiString AudioCompressors = {read=GetAudioCompressors};
	...
	__property AnsiString AudioInputs = {read=GetAudioInputs};
	__property int AudioInputsCount = {read=GetAudioInputsCount, nodefault};
	__property AnsiString AudioDeviceName = {read=GetAudioDeviceName};
	__property AnsiString AudioDevices = {read=GetAudioDevices};
	__property int AudioDevicesCount = {read=GetAudioDevicesCount, nodefault};
	__property AnsiString AudioFormats = {read=GetAudioFormats};
	__property AnsiString AudioRendererName = {read=GetAudioRendererName};
	__property AnsiString AudioRenderers = {read=GetAudioRenderers};
	...
	__property AnsiString RecordingFourCC = {read=GetRecordingFourCC};
	...
	__property AnsiString DirectShowFilters = {read=GetDirectShowFilters};
	...
	__property TFrameGrabberRGBFormat FrameGrabberCurrentRGBFormat = {read=GetFrameGrabberCurrentRGBFormat
		, nodefault};
	__property bool HoldRecording = {read=GetHoldRecording, write=SetHoldRecording, nodefault};
	__property int ImageOverlaySelector = {read=GetImageOverlaySelector, write=SetImageOverlaySelector, 
		nodefault};
	...
	__property AnsiString Last_BurstFrameCapture_FileName = {read=GetLast_BurstFrameCapture_FileName};
	__property AnsiString Last_CaptureFrameTo_FileName = {read=GetLast_CaptureFrameTo_FileName};
	__property AnsiString Last_Recording_FileName = {read=GetLast_Recording_FileName};
	__property AnsiString Last_Clip_Played = {read=GetLast_Clip_Played};
	...
	__property AnsiString MultiplexerName = {read=GetMultiplexerName};
	__property AnsiString Multiplexers = {read=GetMultiplexers};
	...
	__property AnsiString PlayerAudioCodec = {read=GetAudioCodec};
	...
	__property AnsiString PlayerVideoCodec = {read=GetVideoCodec};
	__property AnsiString PropertyPageSaverGroup = {read=GetPropertyPageSaverGroup, write=SetPropertyPageSaverGroup
		};
	__property int RecordingBacktimedFramesCount = {read=GetRecordingBacktimedFramesCount, write=SetRecordingBacktimedFramesCount
		, nodefault};
	...
	__property int SendToDV_DeviceIndex = {read=GetSendToDV_DeviceIndex, write=SetSendToDV_DeviceIndex, 
		nodefault};
	...
	__property AnsiString StreamingURL = {read=GetStreamingURL};
	__property AnsiString SystemTempPath = {read=GetSystemTempPath};
	...
	__property TTunerInputType TVTunerInputType = {read=GetTVTunerInputType, write=SetTVTunerInputType, 
		nodefault};
	...
	__property bool VCRHorizontalLocking = {read=GetVCRHorizontalLocking, write=SetVCRHorizontalLocking
		, nodefault};
	__property AnsiString VideoCompressorName = {read=GetVideoCompressorName};
	__property AnsiString VideoCompressors = {read=GetVideoCompressors};
	__property int VideoCompressorsCount = {read=GetVideoCompressorsCount, nodefault};
	__property AnsiString VideoFormats = {read=GetVideoFormats};
	__property int VideoFormatsCount = {read=GetVideoFormatsCount, nodefault};
	__property AnsiString VideoInputs = {read=GetVideoInputs};
	__property int VideoInputsCount = {read=GetVideoInputsCount, nodefault};
	__property AnsiString VideoDeviceName = {read=GetVideoDeviceName};
	__property AnsiString VideoDevices = {read=GetVideoDevices};
	__property AnsiString VideoDevicesId = {read=GetVideoDevicesId};
	...
	__property AnsiString VideoSizes = {read=GetVideoSizes};
	__property int VideoSizesCount = {read=GetVideoSizesCount, nodefault};
	__property AnsiString VideoSources = {read=GetVideoSources};
	__property int VideoSourcesCount = {read=GetVideoSourcesCount, nodefault};
	__property AnsiString VideoSubtypes = {read=GetVideoSubtypes};
...
__published:
	...
	__property bool AdjustOverlayAspectRatio = {read=GetAdjustOverlayAspectRatio, write=SetAdjustOverlayAspectRatio
		, default=1};
	__property bool AdjustPixelAspectRatio = {read=GetAdjustPixelAspectRatio, write=SetAdjustPixelAspectRatio
		, default=1};
	...
	__property TApplicationPriority ApplicationPriority = {read=GetApplicationPriority, write=SetApplicationPriority
		, default=0};
	...
	__property TASFDeinterlaceMode ASFDeinterlaceMode = {read=GetASFDeinterlaceMode, write=SetASFDeinterlaceMode
		, default=0};
	__property bool ASFFixedFrameRate = {read=GetASFFixedFrameRate, write=SetASFFixedFrameRate, default=1
		};
	__property AnsiString ASFMediaServerPublishingPoint = {read=GetASFMediaServerPublishingPoint, write=
		SetASFMediaServerPublishingPoint};
	__property AnsiString ASFMediaServerTemplatePublishingPoint = {read=GetASFMediaServerTemplatePublishingPoint
		, write=SetASFMediaServerTemplatePublishingPoint};
	__property bool ASFMediaServerRemovePublishingPointAfterDisconnect = {read=GetASFMediaServerRemovePublishingPointAfterDisconnect
		, write=SetASFMediaServerRemovePublishingPointAfterDisconnect, default=0};
	...
	__property AnsiString ASFProfileFromCustomFile = {read=GetASFProfileFromCustomFile, write=SetASFProfileFromCustomFile
		};
	__property TASFProfileVersion ASFProfileVersion = {read=GetASFProfileVersion, write=SetASFProfileVersion
		, default=0};
	...
	__property int ASFVideoMaxKeyFrameSpacing = {read=GetASFVideoMaxKeyFrameSpacing, write=SetASFVideoMaxKeyFrameSpacing
		, default=-1};
	...
	__property bool AssociateAudioAndVideoDevices = {read=GetAssociateAudioAndVideoDevices, write=SetAssociateAudioAndVideoDevices
		, default=0};
	__property bool AVIDurationUpdated = {read=GetAVIDurationUpdated, write=SetAVIDurationUpdated, default=1
		};
	__property TAudioChannelRenderMode AudioChannelRenderMode = {read=GetAudioChannelRenderMode, write=
		SetAudioChannelRenderMode, default=0};
	...
	__property bool AudioDeviceRendering = {read=GetAudioDeviceRendering, write=SetAudioDeviceRendering
		, default=0};
	...
	__property bool AudioSyncAdjustmentEnabled = {read=GetAudioSyncAdjustmentEnabled, write=SetAudioSyncAdjustmentEnabled
		, default=0};
	...
	__property bool AutoConnectRelatedPins = {read=GetAutoConnectRelatedPins, write=SetAutoConnectRelatedPins
		, default=1};
	__property TAutoFileName AutoFileName = {read=GetAutoFileName, write=SetAutoFileName, default=0};
	__property int AutoFileNameMinDigits = {read=GetAutoFileNameMinDigits, write=SetAutoFileNameMinDigits
		, default=6};
	__property AnsiString AutoFilePrefix = {read=GetAutoFilePrefix, write=SetAutoFilePrefix};
	...
	__property bool AVIFormatOpenDML = {read=GetAVIFormatOpenDML, write=SetAVIFormatOpenDML, default=1}
		;
	__property bool AVIFormatOpenDMLCompatibilityIndex = {read=GetAVIFormatOpenDMLCompatibilityIndex, write=
		SetAVIFormatOpenDMLCompatibilityIndex, default=1};
	...
	__property bool CameraControlSettings = {read=GetCameraControlSettings, write=SetCameraControlSettings
		, default=1};
	__property AnsiString CaptureFileExt = {read=GetCaptureFileExt, write=SetCaptureFileExt};
	...
	__property bool Display_Active = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties, index=0
		, default=1};
	__property bool Display_AlphaBlendEnabled = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties
		, index=5, default=0};
	__property int Display_AlphaBlendValue = {read=GetDisplayLongProperties, write=SetDisplayLongProperties
		, index=16, default=180};
	__property bool Display_AutoSize = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties, 
		index=2, default=0};
	__property TAspectRatio Display_AspectRatio = {read=GetDisplayAspectRatio, write=SetDisplayAspectRatio
		, index=0, default=2};
	__property bool Display_Embedded = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties, 
		index=3, default=1};
	__property bool Display_FullScreen = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties
		, index=6, default=0};
	__property int Display_Height = {read=GetDisplayLongProperties, write=SetDisplayLongProperties, index=13
		, default=240};
	__property int Display_Left = {read=GetDisplayLongProperties, write=SetDisplayLongProperties, index=17
		, default=10};
	__property int Display_Monitor = {read=GetDisplayLongProperties, write=SetDisplayLongProperties, index=10
		, default=0};
	__property bool Display_MouseMovesWindow = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties
		, index=8, default=1};
	__property int Display_PanScanRatio = {read=GetDisplayLongProperties, write=SetDisplayLongProperties
		, index=14, default=50};
	__property bool Display_StayOnTop = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties, 
		index=7, default=0};
	__property int Display_Top = {read=GetDisplayLongProperties, write=SetDisplayLongProperties, index=18
		, default=10};
	__property bool Display_TransparentColorEnabled = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties
		, index=4, default=0};
	__property int Display_TransparentColorValue = {read=GetDisplayLongProperties, write=SetDisplayLongProperties
		, index=15, default=255};
	__property bool Display_VideoPortEnabled = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties
		, index=9, default=1};
	__property bool Display_Visible = {read=GetDisplayBoolProperties, write=SetDisplayBoolProperties, index=1
		, default=1};
	__property int Display_Width = {read=GetDisplayLongProperties, write=SetDisplayLongProperties, index=12
		, default=320};
	__property bool DoubleBuffered = {read=GetVideoDoubleBuffered, write=SetVideoDoubleBuffered, default=0
		};
	__property int DroppedFramesPollingInterval = {read=GetDroppedFramesPollingInterval, write=SetDroppedFramesPollingInterval
		, default=-1};
	__property bool DualDisplay_Active = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=0, default=0};
	__property bool DualDisplay_AlphaBlendEnabled = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=5, default=0};
	__property int DualDisplay_AlphaBlendValue = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties
		, index=16, default=180};
	__property bool DualDisplay_TransparentColorEnabled = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=4, default=0};
	__property int DualDisplay_TransparentColorValue = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties
		, index=15, default=255};
	__property bool DualDisplay_AutoSize = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=2, default=0};
	__property TAspectRatio DualDisplay_AspectRatio = {read=GetDisplayAspectRatio, write=SetDisplayAspectRatio
		, index=1, default=2};
	__property bool DualDisplay_Embedded = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=3, default=0};
	__property bool DualDisplay_FullScreen = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=6, default=0};
	__property int DualDisplay_Height = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties
		, index=13, default=240};
	__property int DualDisplay_Left = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties, 
		index=17, default=20};
	__property int DualDisplay_Monitor = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties
		, index=10, default=0};
	__property bool DualDisplay_MouseMovesWindow = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=8, default=1};
	__property int DualDisplay_PanScanRatio = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties
		, index=14, default=50};
	__property bool DualDisplay_StayOnTop = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=7, default=0};
	__property int DualDisplay_Top = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties, 
		index=18, default=400};
	__property bool DualDisplay_VideoPortEnabled = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=9, default=0};
	__property bool DualDisplay_Visible = {read=GetDisplay2BoolProperties, write=SetDisplay2BoolProperties
		, index=1, default=1};
	__property int DualDisplay_Width = {read=GetDisplay2LongProperties, write=SetDisplay2LongProperties
		, index=12, default=320};
	...
	__property int DVDiscontinuityMinimumInterval = {read=GetDVDiscontinuityMinimumInterval, write=SetDVDiscontinuityMinimumInterval
		, default=3};
	__property TDVVideoFormat DVEncoder_VideoFormat = {read=GetDVEncoder_VideoFormat, write=SetDVEncoder_VideoFormat
		, default=1};
	__property TDVSize DVEncoder_VideoResolution = {read=GetDVEncoder_VideoResolution, write=SetDVEncoder_VideoResolution
		, default=0};
	__property TDVVideoStandard DVEncoder_VideoStandard = {read=GetDVEncoder_VideoStandard, write=SetDVEncoder_VideoStandard
		, default=0};
	...
	__property bool DVRecordingInNativeFormatSeparatesStreams = {read=GetDVRecordingInNativeFormatSeparatesStreams
		, write=SetDVRecordingInNativeFormatSeparatesStreams, default=0};
	__property bool DVTimeCodeEnabled = {read=GetDVTimeCodeEnabled, write=SetDVTimeCodeEnabled, default=1
		};
	__property bool EventNotificationSynchrone = {read=GetEventNotificationSynchrone, write=SetEventNotificationSynchrone
		, default=1};
	...
	__property bool FixFlickerOrBlackCapture = {read=GetFixFlickerOrBlackCapture, write=SetFixFlickerOrBlackCapture
		, default=0};
	__property bool FrameCaptureWithoutOverlay = {read=GetFrameCaptureWithoutOverlay, write=SetFrameCaptureWithoutOverlay
		, default=0};
	...
	__property int FrameCaptureZoomSize = {read=GetFrameCaptureZoomSize, write=SetFrameCaptureZoomSize, 
		default=100};
	__property TFrameGrabber FrameGrabber = {read=GetFrameGrabber, write=SetFrameGrabber, default=0};
	__property TFrameGrabberRGBFormat FrameGrabberRGBFormat = {read=GetFrameGrabberRGBFormat, write=SetFrameGrabberRGBFormat
		, default=0};
	__property bool FrameNumberStartsFromZero = {read=GetFrameNumberStartsFromZero, write=SetFrameNumberStartsFromZero
		, default=0};
	__property double FrameRate = {read=GetFrameRate, write=SetFrameRate};
	__property bool ImageOverlay_AlphaBlend = {read=GetImageOverlay_AlphaBlend, write=SetImageOverlay_AlphaBlend
		, default=0};
	__property int ImageOverlay_AlphaBlendValue = {read=GetImageOverlay_AlphaBlendValue, write=SetImageOverlay_AlphaBlendValue
		, default=180};
	__property bool ImageOverlay_ChromaKey = {read=GetImageOverlay_ChromaKey, write=SetImageOverlay_ChromaKey
		, default=0};
	__property int ImageOverlay_ChromaKeyLeewayPercent = {read=GetImageOverlay_ChromaKeyLeewayPercent, 
		write=SetImageOverlay_ChromaKeyLeewayPercent, default=25};
	__property int ImageOverlay_ChromaKeyRGBColor = {read=GetImageOverlay_ChromaKeyRGBColor, write=SetImageOverlay_ChromaKeyRGBColor
		, default=0};
	__property int ImageOverlay_Height = {read=GetImageOverlay_Height, write=SetImageOverlay_Height, default=-1
		};
	__property int ImageOverlay_LeftLocation = {read=GetImageOverlay_LeftLocation, write=SetImageOverlay_LeftLocation
		, default=10};
	__property double ImageOverlay_RotationAngle = {read=GetImageOverlay_RotationAngle, write=SetImageOverlay_RotationAngle
		};
	__property bool ImageOverlay_StretchToVideoSize = {read=GetImageOverlay_StretchToVideoSize, write=SetImageOverlay_StretchToVideoSize
		, default=0};
	__property int ImageOverlay_TopLocation = {read=GetImageOverlay_TopLocation, write=SetImageOverlay_TopLocation
		, default=10};
	__property bool ImageOverlay_Transparent = {read=GetImageOverlay_Transparent, write=SetImageOverlay_Transparent
		, default=0};
	__property int ImageOverlay_TransparentColorValue = {read=GetImageOverlay_TransparentColorValue, write=
		SetImageOverlay_TransparentColorValue, default=0};
	__property bool ImageOverlay_UseTransparentColor = {read=GetImageOverlay_UseTransparentColor, write=
		SetImageOverlay_UseTransparentColor, default=0};
	...
	__property AnsiString IPCameraURL = {read=GetIPCameraURL, write=SetIPCameraURL};
	__property Jpeg::TJPEGPerformance JPEGPerformance = {read=GetJPEGPerformance, write=SetJPEGPerformance
		, default=0};
	__property bool JPEGProgressiveDisplay = {read=GetJPEGProgressiveDisplay, write=SetJPEGProgressiveDisplay
		, default=0};
	__property int JPEGQuality = {read=GetJPEGQuality, write=SetJPEGQuality, default=100};
	__property AnsiString LicenseString = {read=GetLicenseString, write=SetLicenseString};
	...
	__property int MixAudioSamples_CurrentSourceLevel = {read=GetMixAudioSamplesLevel, write=SetMixAudioSamplesLevel
		, index=0, default=100};
	__property int MixAudioSamples_ExternalSourceLevel = {read=GetMixAudioSamplesLevel, write=SetMixAudioSamplesLevel
		, index=1, default=100};
	...
	__property bool MotionDetector_CompareBlue = {read=GetMotionDetector_CompareBlue, write=SetMotionDetector_CompareBlue
		, default=1};
	__property bool MotionDetector_CompareGreen = {read=GetMotionDetector_CompareGreen, write=SetMotionDetector_CompareGreen
		, default=1};
	__property bool MotionDetector_GreyScale = {read=GetMotionDetector_GreyScale, write=SetMotionDetector_GreyScale
		, default=0};
	__property bool MotionDetector_CompareRed = {read=GetMotionDetector_CompareRed, write=SetMotionDetector_CompareRed
		, default=1};
	__property bool MotionDetector_Enabled = {read=GetMotionDetector_Enabled, write=SetMotionDetector_Enabled
		, default=0};
	__property AnsiString MotionDetector_Grid = {read=GetMotionDetector_Grid, write=SetMotionDetector_Grid
		};
	__property double MotionDetector_MaxDetectionsPerSecond = {read=GetMotionDetector_MaxDetectionsPerSecond
		, write=SetMotionDetector_MaxDetectionsPerSecond};
	__property int MotionDetector_ReduceCPULoad = {read=GetMotionDetector_ReduceCPULoad, write=SetMotionDetector_ReduceCPULoad
		, default=1};
	__property bool MotionDetector_ReduceVideoNoise = {read=GetMotionDetector_ReduceVideoNoise, write=SetMotionDetector_ReduceVideoNoise
		, default=0};
	__property bool MotionDetector_Triggered = {read=GetMotionDetector_Triggered, write=SetMotionDetector_Triggered
		, default=0};
	__property bool MouseWheelEventEnabled = {read=GetMouseWheelEventEnabled, write=SetMouseWheelEventEnabled
		, default=0};
	__property bool MultiplexedInputEmulation = {read=GetMultiplexedInputEmulation, write=SetMultiplexedInputEmulation
		, default=1};
	...
	__property TNetworkStreaming NetworkStreaming = {read=GetNetworkStreaming, write=SetNetworkStreaming
		, default=0};
	__property TNetworkStreamingType NetworkStreamingType = {read=GetNetworkStreamingType, write=SetNetworkStreamingType
		, default=0};
	__property TNotificationMethod NotificationMethod = {read=GetNotificationMethod, write=SetNotificationMethod
		, default=1};
	__property int NotificationSleepTime = {read=GetNotificationSleepTime, write=SetNotificationSleepTime
		, default=-1};
	__property Classes::TThreadPriority NotificationPriority = {read=GetNotificationPriority, write=SetNotificationPriority
		, default=3};
	__property bool OverlayAfterTransform = {read=GetOverlayAfterTransform, write=SetOverlayAfterTransform
		, default=0};
	__property bool PlayerAudioRendering = {read=GetPlayerAudioRendering, write=SetPlayerAudioRendering
		, default=1};
	__property TDVSize PlayerDVSize = {read=GetPlayerDVSize, write=SetPlayerDVSize, default=0};
	__property int PlayerFastSeekSpeedRatio = {read=GetPlayerFastSeekSpeedRatio, write=SetPlayerFastSeekSpeedRatio
		, default=4};
	__property AnsiString PlayerFileName = {read=GetPlayerFileName, write=SetPlayerFileName};
	__property AnsiString PlayerForcedCodec = {read=GetPlayerForcedCodec, write=SetPlayerForcedCodec};
	__property bool PlayerRefreshPausedDisplay = {read=GetPlayerRefreshPausedDisplay, write=SetPlayerRefreshPausedDisplay
		, default=0};
	__property double PlayerRefreshPausedDisplayFrameRate = {read=GetPlayerRefreshPausedDisplayFrameRate
		, write=SetPlayerRefreshPausedDisplayFrameRate};
	...
	__property bool PlayerTrackBarSynchrone = {read=GetPlayerTrackBarSynchrone, write=SetPlayerTrackBarSynchrone
		, default=0};
	__property bool PreallocCapFileCopiedAfterRecording = {read=GetPreallocCapFileCopiedAfterRecording, 
		write=SetPreallocCapFileCopiedAfterRecording, default=1};
	__property bool PreallocCapFileEnabled = {read=GetPreallocCapFileEnabled, write=SetPreallocCapFileEnabled
		, default=0};
	__property AnsiString PreallocCapFileName = {read=GetPreallocCapFileName, write=SetPreallocCapFileName
		};
	__property int PreallocCapFileSizeInMB = {read=GetPreallocCapFileSizeInMB, write=SetPreallocCapFileSizeInMB
		, default=100};
	__property int PreviewZoomSize = {read=GetPreviewZoomSize, write=SetPreviewZoomSize, default=100};
	__property int RecordingAudioBitRate = {read=GetRecordingAudioBitRate, write=SetRecordingAudioBitRate
		, default=-1};
	__property int RecordingVideoBitRate = {read=GetRecordingVideoBitRate, write=SetRecordingVideoBitRate
		, default=-1};
	__property AnsiString RecordingFileName = {read=GetRecordingFileName, write=SetRecordingFileName};
	__property bool RecordingInNativeFormat = {read=GetRecordingInNativeFormat, write=SetRecordingInNativeFormat
		, default=1};
	__property TRecordingMethod RecordingMethod = {read=GetRecordingMethod, write=SetRecordingMethod, default=0
		};
	__property bool RecordingPauseCreatesNewFile = {read=GetRecordingPauseCreatesNewFile, write=SetRecordingPauseCreatesNewFile
		, default=0};
	__property bool RecordingOnMotion_Enabled = {read=GetRecordingOnMotion_Enabled, write=SetRecordingOnMotion_Enabled
		, default=0};
	__property double RecordingOnMotion_MotionThreshold = {read=GetRecordingOnMotion_MotionThreshold, write=
		SetRecordingOnMotion_MotionThreshold};
	__property TRecordingTimer RecordingTimer = {read=GetRecordingTimer, write=SetRecordingTimer, default=0
		};
	__property int RecordingTimerInterval = {read=GetRecordingTimerInterval, write=SetRecordingTimerInterval
		, default=0};
	__property int RecordingOnMotion_NoMotionPauseDelayMs = {read=GetRecordingOnMotion_NoMotionPauseDelayMs
		, write=SetRecordingOnMotion_NoMotionPauseDelayMs, default=5000};
	__property AnsiString Reencoding_NewVideoClip = {read=GetReencodingNewVideoClip, write=SetReencodingNewVideoClip
		};
	__property AnsiString Reencoding_SourceVideoClip = {read=GetReencodingSourceVideoClip, write=SetReencodingSourceVideoClip
		};
	__property __int64 Reencoding_StartTime = {read=GetReencodingStartTime, write=SetReencodingStartTime
		, default=-1};
	__property __int64 Reencoding_StartFrame = {read=GetReencodingStartFrame, write=SetReencodingStartFrame
		, default=-1};
	__property __int64 Reencoding_StopTime = {read=GetReencodingStopTime, write=SetReencodingStopTime, 
		default=-1};
	__property __int64 Reencoding_StopFrame = {read=GetReencodingStopFrame, write=SetReencodingStopFrame
		, default=-1};
	__property bool Reencoding_IncludeAudioStream = {read=GetReencodingIncludeAudioStream, write=SetReencodingIncludeAudioStream
		, default=1};
	__property bool Reencoding_IncludeVideoStream = {read=GetReencodingIncludeVideoStream, write=SetReencodingIncludeVideoStream
		, default=1};
	__property TRecordingMethod Reencoding_Method = {read=GetReencodingMethod, write=SetReencodingMethod
		, default=0};
	__property bool Reencoding_UseAudioCompressor = {read=GetReencodingUseAudioCompressor, write=SetReencodingUseAudioCompressor
		, default=0};
	__property bool Reencoding_UseFrameGrabber = {read=GetReencodingUseFrameGrabber, write=SetReencodingUseFrameGrabber
		, default=1};
	__property bool Reencoding_UseVideoCompressor = {read=GetReencodingUseVideoCompressor, write=SetReencodingUseVideoCompressor
		, default=0};
	__property bool Reencoding_WMVOutput = {read=GetReencodingWMVOutput, write=SetReencodingWMVOutput, 
		default=0};
	__property bool QuickDeviceInitialization = {read=GetQuickDeviceInitialization, write=SetQuickDeviceInitialization
		, default=0};
	__property bool RawAudioSampleCapture = {read=GetRawAudioSampleCapture, write=SetRawAudioSampleCapture
		, default=0};
	__property bool RawCaptureAsyncEvent = {read=GetRawCaptureAsyncEvent, write=SetRawCaptureAsyncEvent
		, default=1};
	__property TRawSampleCaptureLocation RawSampleCaptureLocation = {read=GetRawSampleCaptureLocation, 
		write=SetRawSampleCaptureLocation, default=0};
	__property bool RawVideoSampleCapture = {read=GetRawVideoSampleCapture, write=SetRawVideoSampleCapture
		, default=0};
	__property TRecordingSize RecordingSize = {read=GetRecordingSize, write=SetRecordingSize, default=0
		};
	__property bool ScreenRecordingLayeredWindows = {read=GetScreenRecordingLayeredWindows, write=SetScreenRecordingLayeredWindows
		, default=0};
	__property int ScreenRecordingMonitor = {read=GetScreenRecordingMonitor, write=SetScreenRecordingMonitor
		, default=0};
	__property bool ScreenRecordingNonVisibleWindows = {read=GetScreenRecordingNonVisibleWindows, write=
		SetScreenRecordingNonVisibleWindows, default=0};
	__property bool ScreenRecordingThroughClipboard = {read=GetScreenRecordingThroughClipboard, write=SetScreenRecordingThroughClipboard
		, default=0};
	__property bool ScreenRecordingWithCursor = {read=GetScreenRecordingWithCursor, write=SetScreenRecordingWithCursor
		, default=1};
	...
	__property AnsiString StoragePath = {read=GetStoragePath, write=SetStoragePath, stored=false};
	__property bool StoreDeviceSettingsInRegistry = {read=GetStoreDeviceSettingsInRegistry, write=SetStoreDeviceSettingsInRegistry
		, default=1};
	__property TSynchronizationRole SynchronizationRole = {read=GetSynchronizationRole, write=SetSynchronizationRole
		, default=0};
	...
	__property bool TextOverlay_Scrolling = {read=GetTextOverlayScrolling, write=SetTextOverlayScrolling
		, default=0};
	__property int TextOverlay_ScrollingSpeed = {read=GetTextOverlayScrollingSpeed, write=SetTextOverlayScrollingSpeed
		, default=1};
	__property bool TextOverlay_Shadow = {read=GetTextOverlayShadow, write=SetTextOverlayShadow, default=1
		};
	__property Graphics::TColor TextOverlay_ShadowColor = {read=GetTextOverlayShadowColor, write=SetTextOverlayShadowColor
		, default=0};
	__property TCardinalDirection TextOverlay_ShadowDirection = {read=GetTextOverlayShadowDirection, write=
		SetTextOverlayShadowDirection, default=7};
	__property Graphics::TColor TextOverlay_BkColor = {read=GetTextOverlayBkColor, write=SetTextOverlayBkColor
		, default=16777215};
	__property TTextOverlayAlign TextOverlay_Align = {read=GetTextOverlayAlign, write=SetTextOverlayAlign
		, default=0};
	__property Graphics::TFont* TextOverlay_Font = {read=GetTextOverlayFont, write=SetTextOverlayFont, 
		default=0};
	__property AnsiString TextOverlay_String = {read=GetTextOverlayString, write=SetTextOverlayString};
		
	__property bool TextOverlay_Transparent = {read=GetTextOverlayTransparent, write=SetTextOverlayTransparent
		, default=1};
	__property AnsiString ThirdPartyDeinterlacer = {read=GetThirdPartyDeinterlacer, write=SetThirdPartyDeinterlacer
		};
	__property bool TranslateMouseCoordinates = {read=GetTranslateMouseCoordinates, write=SetTranslateMouseCoordinates
		, default=1};
	__property bool TVUseFrequencyOverrides = {read=GetTVUseFrequencyOverrides, write=SetTVUseFrequencyOverrides
		, default=0};
	...
	__property int VideoCompression_DataRate = {read=GetVideoCompression_DataRate, write=SetVideoCompression_DataRate
		, default=-1};
	__property int VideoCompression_KeyFrameRate = {read=GetVideoCompression_KeyFrameRate, write=SetVideoCompression_KeyFrameRate
		, default=15};
	__property int VideoCompression_PFramesPerKeyFrame = {read=GetVideoCompression_PFramesPerKeyFrame, 
		write=SetVideoCompression_PFramesPerKeyFrame, default=0};
	__property double VideoCompression_Quality = {read=GetVideoCompression_Quality, write=SetVideoCompression_Quality
		};
	__property int VideoCompression_WindowSize = {read=GetVideoCompression_WindowSize, write=SetVideoCompression_WindowSize
		, default=-1};
	__property int VideoCompressor = {read=GetVideoCompressor, write=SetVideoCompressor, nodefault};
	__property bool VideoControlSettings = {read=GetVideoControlSettings, write=SetVideoControlSettings
		, default=1};
	__property int VideoFormat = {read=GetVideoFormat, write=SetVideoFormat, default=-1};
	__property TFileSort VideoFromImages_BitmapsSortedBy = {read=GetVideoFromImages_BitmapsSortedBy, write=
		SetVideoFromImages_BitmapsSortedBy, default=0};
	__property bool VideoFromImages_RepeatIndefinitely = {read=GetVideoFromImages_RepeatIndefinitely, write=
		SetVideoFromImages_RepeatIndefinitely, default=0};
	__property AnsiString VideoFromImages_SourceDirectory = {read=GetVideoFromImages_SourceDirectory, write=
		SetVideoFromImages_SourceDirectory, stored=false};
	__property AnsiString VideoFromImages_TemporaryFile = {read=GetVideoFromImages_TemporaryFile, write=
		SetVideoFromImages_TemporaryFile};
	__property int VideoInput = {read=GetVideoInput, write=SetVideoInput, default=-1};
	__property int VideoProcessing_Brightness = {read=GetVideoProcessingBrightness, write=SetVideoProcessingBrightness
		, default=0};
	__property int VideoProcessing_Contrast = {read=GetVideoProcessingContrast, write=SetVideoProcessingContrast
		, default=0};
	__property TVideoDeinterlacing VideoProcessing_Deinterlacing = {read=GetVideoProcessingDeinterlacing
		, write=SetVideoProcessingDeinterlacing, default=0};
	__property bool VideoProcessing_FlipHorizontal = {read=GetVideoProcessingLeftRight, write=SetVideoProcessingLeftRight
		, default=0};
	__property bool VideoProcessing_FlipVertical = {read=GetVideoProcessingTopDown, write=SetVideoProcessingTopDown
		, default=0};
	__property bool VideoProcessing_GrayScale = {read=GetVideoProcessingGrayScale, write=SetVideoProcessingGrayScale
		, default=0};
	__property int VideoProcessing_Hue = {read=GetVideoProcessingHue, write=SetVideoProcessingHue, default=0
		};
	__property bool VideoProcessing_InvertColors = {read=GetVideoProcessingInvertColors, write=SetVideoProcessingInvertColors
		, default=0};
	__property int VideoProcessing_Pixellization = {read=GetVideoProcessingPixellization, write=SetVideoProcessingPixellization
		, default=1};
	__property int VideoProcessing_Saturation = {read=GetVideoProcessingSaturation, write=SetVideoProcessingSaturation
		, default=0};
	__property TVideoRotation VideoProcessing_Rotation = {read=GetVideoProcessingRotation, write=SetVideoProcessingRotation
		, default=0};
	__property double VideoProcessing_RotationCustomAngle = {read=GetVideoProcessingRotationCustomAngle
		, write=SetVideoProcessingRotationCustomAngle};
	__property bool VideoQualitySettings = {read=GetVideoQualitySettings, write=SetVideoQualitySettings
		, default=1};
	__property TVideoRenderer VideoRenderer = {read=GetVideoRenderer, write=SetVideoRenderer, default=0
		};
	__property TVideoRendererExternal VideoRendererExternal = {read=GetVideoRendererExternal, write=SetVideoRendererExternal
		, default=0};
	__property int VideoRendererExternalIndex = {read=GetVideoRendererExternalIndex, write=SetVideoRendererExternalIndex
		, default=-1};
	...
	__property AnsiString VideoSource_FileOrURL = {read=GetVideoSource_FileOrURL, write=SetVideoSource_FileOrURL
		};
	__property __int64 VideoSource_FileOrURL_StartTime = {read=GetVideoSource_FileOrURL_StartTime, write=
		SetVideoSource_FileOrURL_StartTime, default=-1};
	__property __int64 VideoSource_FileOrURL_StopTime = {read=GetVideoSource_FileOrURL_StopTime, write=
		SetVideoSource_FileOrURL_StopTime, default=-1};
	__property int VideoSubtype = {read=GetVideoSubtype, write=SetVideoSubtype, default=-1};
	__property bool VideoVisibleWhenStopped = {read=GetVideoVisibleWhenStopped, write=SetVideoVisibleWhenStopped
		, default=0};
	__property int VirtualVideoStreamControl = {read=GetVirtualVideoStreamControl, write=SetVirtualVideoStreamControl
		, default=-1};
	__property int VirtualAudioStreamControl = {read=GetVirtualAudioStreamControl, write=SetVirtualAudioStreamControl
		, default=-1};
	__property TVuMeter VuMeter = {read=GetVuMeter, write=SetVuMeter, default=0};
	__property TWebcamStillCaptureButton WebcamStillCaptureButton = {read=GetWebcamStillCaptureButton, 
		write=SetWebcamStillCaptureButton, default=0};
	...
	__property TOnEventNotification OnBacktimedFramesCountReached = {read=FOnBacktimedFramesCountReached
		, write=FOnBacktimedFramesCountReached};
	...
	__property TOnSourceFileToDestFileCompleted OnCopyPreallocDataCompleted = {read=FOnCopyPreallocDataCompleted
		, write=FOnCopyPreallocDataCompleted};
	__property TOnProgress OnCopyPreallocDataProgress = {read=FOnCopyPreallocDataProgress, write=FOnCopyPreallocDataProgress
		};
	__property TOnSourceFileToDestFileStarted OnCopyPreallocDataStarted = {read=FOnCopyPreallocDataStarted
		, write=FOnCopyPreallocDataStarted};
	__property TOnCreatePreallocatedFileCompleted OnCreatePreallocFileCompleted = {read=FOnCreatePreallocFileCompleted
		, write=FOnCreatePreallocFileCompleted};
	...
	__property TOnFileNotification OnCreatePreallocFileStarted = {read=FOnCreatePreallocFileStarted, write=
		FOnCreatePreallocFileStarted};
	__property TOnDeviceArrivalOrRemoval OnDeviceArrivalOrRemoval = {read=FOnDeviceArrivalOrRemoval, write=
		Set_OnDeviceArrivalOrRemoval};
	__property TOnEventNotification OnDeviceLost = {read=FOnDeviceLost, write=FOnDeviceLost};
	__property TOnDirectNetworkStreamingHostUrl OnDirectNetworkStreamingHostUrl = {read=FOnDirectNetworkStreamingHostUrl
		, write=FOnDirectNetworkStreamingHostUrl};
	...
	__property TOnFrameCaptureCompleted OnFrameCaptureCompleted = {read=FOnFrameCaptureCompleted, write=
		FOnFrameCaptureCompleted};
	...
	__property TOnFrameOverlayUsingVIDEOHDR OnFrameOverlayUsingVIDEOHDR = {read=FOnFrameOverlayUsingVIDEOHDR
		, write=FOnFrameOverlayUsingVIDEOHDR};
	...
	__property TOnFrameProgress OnPlayerUpdateTrackbarPosition = {read=FOnPlayerUpdateTrackbarPosition, 
		write=FOnPlayerUpdateTrackbarPosition};
	...
	__property TOnSourceFileToDestFileCompleted OnReencodingCompleted = {read=FOnReencodingCompleted, write=
		FOnReencodingCompleted};
	...
	__property TOnTextOverlayScrollingCompleted OnTextOverlayScrollingCompleted = {read=FOnTextOverlayScrollingCompleted
		, write=FOnTextOverlayScrollingCompleted};
	__property TOnThirdPartyFilterConnected OnThirdPartyFilterConnected = {read=FOnThirdPartyFilterConnected
		, write=FOnThirdPartyFilterConnected};
	...
	__property TOnVideoCompressionSettings OnVideoCompressionSettings = {read=FOnVideoCompressionSettings
		, write=FOnVideoCompressionSettings};
	__property TOnEventNotification OnVideoDeviceSelected = {read=FOnVideoDeviceSelected, write=FOnVideoDeviceSelected
		};
	__property TOnVideoFromBitmapsNextFrameNeeded OnVideoFromBitmapsNextFrameNeeded = {read=FOnVideoFromBitmapsNextFrameNeeded
		, write=FOnVideoFromBitmapsNextFrameNeeded};
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TVideoGrabber(HWND ParentWindow) : Extctrls::TCustomPanel(
		ParentWindow) { }
	#pragma option pop
...
//-- var, const, procedure ---------------------------------------------------
#define BuildID "4375"
#define TVideoGrabberVersionID "8.5"
#define TVideoGrabberVersionNumber "8.5.3.1"
#define TVideoGrabberVersion "v8.5.3.1 (build 4375) - October 10, 2011 - Copyright ©2002"\
	"-2011 Datastead"
#define APPNAME "TVideoGrabber"
static const bool DEF_AdjustOverlayAspectRatio = true;
static const bool DEF_AdjustPixelAspectRatio = true;
#define DEF_Aero (TAero)(0)
#define DEF_ApplicationPriority (TApplicationPriority)(0)
static const Shortint DEF_ASFAudioBitRate = 0xffffffff;
static const Shortint DEF_ASFAudioChannels = 0xffffffff;
static const Shortint DEF_ASFBufferWindow = 0xffffffff;
#define DEF_ASFDeinterlaceMode (TASFDeinterlaceMode)(0)
...
static const Shortint DEF_ASFNetworkPort = 0x0;
static const Shortint DEF_ASFNetworkMaxUsers = 0x5;
#define DEF_AspectRatioToUse  (-1.000000E+00)
static const Shortint DEF_ASFProfile = 0xffffffff;
#define DEF_ASFProfileVersion (TASFProfileVersion)(0)
static const Shortint DEF_ASFVideoBitRate = 0xffffffff;
static const Shortint DEF_ASFVideoHeight = 0xffffffff;
static const Shortint DEF_ASFVideoMaxKeyFrameSpacing = 0xffffffff;
static const Shortint DEF_ASFVideoQuality = 0x50;
static const Shortint DEF_ASFVideoWidth = 0xffffffff;
static const bool DEF_AssociateAudioAndVideoDevices = false;
static const Shortint DEF_AudioBalance = 0x0;
#define DEF_AudioChannelRenderMode (TAudioChannelRenderMode)(0)
static const Shortint DEF_AudioDevice = 0xffffffff;
static const Shortint DEF_AudioRenderer = 0xffffffff;
static const Word DEF_AudioVolume = 0x7fff;
static const Shortint DEF_AudioStreamNumber = 0xffffffff;
#define DEF_AudioFormat (TAudioFormat)(0)
static const bool DEF_AudioDeviceRendering = false;
static const bool DEF_AudioSyncAdjustmentEnabled = false;
static const Shortint DEF_AudioSyncAdjustment = 0x0;
static const Shortint DEF_MixAudioSamplesLevel = 0x64;
static const Shortint DEF_Mixer_MosaicColumns = 0x1;
static const Shortint DEF_Mixer_MosaicLines = 0x1;
static const bool DEF_AudioPeakEvent = false;
static const bool DEF_AudioRecording = false;
#define DEF_AudioSource (TAudioSource)(0)
#define DEF_VuMeter (TVuMeter)(0)
static const bool DEF_AutoConnectRelatedPins = true;
#define DEF_AutoFileName (TAutoFileName)(0)
static const Shortint DEF_AutoFileNameMinDigits = 0x6;
...
static const int DEF_BackgroundColor = 0x0;
static const Shortint DEF_BufferCount = 0xffffffff;
static const Shortint DEF_BurstCount = 0x3;
#define DEF_BorderStyle (Forms::TFormBorderStyle)(1)
static const Shortint DEF_BurstInterval = 0x0;
static const bool DEF_BurstMode = false;
#define DEF_BurstType (TFrameCaptureDest)(0)
static const short DEF_BusyCursor = 0xfffffff5;
static const short DEF_NormalCursor = 0x0;
...
#define DEF_CompressionMode (TCompressionMode)(0)
#define DEF_CompressionType (TCompressionType)(0)
static const short DEF_Cursor = 0x0;
static const bool DEF_Display_Active = true;
static const bool DEF_Display_AlphaBlendEnabled = false;
static const Byte DEF_Display_AlphaBlendValue = 0xb4;
static const bool DEF_Display_TransparentColorEnabled = false;
static const Byte DEF_Display_TransparentColorValue = 0xff;
static const bool DEF_Display_AutoSize = false;
#define DEF_Display_AspectRatio (TAspectRatio)(2)
static const bool DEF_Display_Embedded = true;
static const Shortint DEF_Display_ExternalRenderer = 0xffffffff;
static const bool DEF_Display_FullScreen = false;
static const Byte DEF_Display_Height = 0xf0;
static const Shortint DEF_Display_Left = 0xa;
static const bool DEF_Display_StayOnTop = false;
static const Shortint DEF_Display_Monitor = 0x0;
static const bool DEF_Display_MouseMovesWindow = true;
static const Shortint DEF_Display_PanScanRatio = 0x32;
static const Shortint DEF_Display_Top = 0xa;
static const bool DEF_Display_VideoPortEnabled = true;
static const bool DEF_Display_Visible = true;
static const Word DEF_Display_Width = 0x140;
static const bool DEF_DoubleBuffered = false;
static const bool DEF_DualDisplay_AutoSize = false;
static const Shortint DEF_DualDisplay_Left = 0x14;
static const Word DEF_DualDisplay_Top = 0x190;
static const Shortint DEF_DroppedFramesPollingInterval = 0xffffffff;
...
static const Shortint DEF_DVDTitle = 0x0;
static const Shortint DEF_DVDiscontinuityMinimumInterval = 0x3;
...
static const Shortint DEF_Cropping_Height = 0x78;
static const bool DEF_Cropping_Outbounds = true;
static const Byte DEF_Cropping_Width = 0xa0;
static const Shortint DEF_Cropping_X = 0x0;
static const Shortint DEF_Cropping_Y = 0x0;
#define DEF_Cropping_Zoom  (1.000000E+00)
#define DEF_DVEncoder_VideoFormat (TDVVideoFormat)(1)
#define DEF_DVEncoder_VideoStandard (TDVVideoStandard)(0)
#define DEF_DVEncoder_VideoResolution (TDVSize)(0)
static const bool DEF_FixFlickerOrBlackCapture = false;
static const bool DEF_FrameCaptureWithoutOverlay = false;
static const Shortint DEF_FrameCaptureZoomSize = 0x64;
static const Shortint DEF_FrameCaptureWidth = 0xffffffff;
static const Shortint DEF_FrameCaptureHeight = 0xffffffff;
static const bool DEF_FrameNumberStartsFromZero = false;
#define DEF_FrameGrabber (TFrameGrabber)(0)
#define DEF_FrameGrabberRGBFormat (TFrameGrabberRGBFormat)(0)
static const Word DEF_IPCameraConnectionTimeout = 0xea60;
static const Word DEF_IPCameraReceiveTimeout = 0x1388;
...
static const Byte DEF_ImageOverlay_AlphaBlendValue = 0xb4;
static const Shortint DEF_ImageOverlay_ChromaKeyLeewayPercent = 0x19;
static const Shortint DEF_ImageOverlay_ChromaKeyRGBColor = 0x0;
static const Shortint DEF_ImageOverlay_Height = 0xffffffff;
static const Shortint DEF_ImageOverlay_LeftLocation = 0xa;
static const bool DEF_ImageOverlay_StretchToVideoSize = false;
static const Shortint DEF_ImageOverlay_TopLocation = 0xa;
static const bool DEF_ImageOverlay_Transparent = false;
static const Shortint DEF_ImageOverlay_TransparentColorValue = 0x0;
static const bool DEF_ImageOverlay_UseTransparentColor = false;
static const Shortint DEF_ImageOverlay_Width = 0xffffffff;
static const bool DEF_ImageOverlayEnabled = false;
#define DEF_JPEGPerformance (Jpeg::TJPEGPerformance)(0)
static const bool DEF_JPEGProgressiveDisplay = false;
static const Shortint DEF_JPEGQuality = 0x64;
static const bool DEF_LogoDisplayed = false;
#define DEF_LogoLayout (TLogoLayout)(1)
...
static const Shortint DEF_MotionDetector_MaxDetectionsPerSecond = 0x0;
static const Shortint DEF_MotionDetector_ReduceCPULoad = 0x1;
...
#define DEF_MultiplexedRole (TMultiplexedRole)(0)
static const Shortint DEF_MultiplexedSwitchDelay = 0x0;
static const Shortint DEF_MultiplexedStabilizationDelay = 0x64;
static const Shortint DEF_Multiplexer = 0xffffffff;
static const bool DEF_MuteAudioRendering = false;
#define DEF_NetworkStreaming (TNetworkStreaming)(0)
#define DEF_NetworkStreamingType (TNetworkStreamingType)(0)
#define DEF_NotificationMethod (TNotificationMethod)(1)
static const Shortint DEF_NotificationSleepTime = 0xffffffff;
#define DEF_NotificationPriority (Classes::TThreadPriority)(3)
...
#define DEF_PlayerDVSize (TDVSize)(0)
static const Shortint DEF_PlayerFastSeekSpeedRatio = 0x4;
static const bool DEF_PlayerRefreshPausedDisplay = false;
#define DEF_PlayerRefreshPausedDisplayFrameRate  (0.000000E+00)
static const Shortint DEF_PlayerSpeedRatio = 0x1;
...
static const Shortint DEF_PreallocCapFileSizeInMB = 0x64;
static const Shortint DEF_PreviewZoomSize = 0x64;
...
#define DEF_RawSampleCaptureLocation (TRawSampleCaptureLocation)(0)
static const bool DEF_RawVideoSampleCapture = false;
static const Shortint DEF_RecordingAudioBitRate = 0xffffffff;
static const Shortint DEF_RecordingVideoBitRate = 0xffffffff;
static const bool DEF_RecordingInNativeFormat = true;
#define DEF_RecordingMethod (TRecordingMethod)(0)
static const bool DEF_RecordingPauseCreatesNewFile = false;
static const bool DEF_RecordingOnMotion_Enabled = false;
static const Shortint DEF_RecordingOnMotion_MotionThreshold = 0x0;
static const Word DEF_RecordingOnMotion_NoMotionPauseDelayMs = 0x1388;
#define DEF_RecordingTimer (TRecordingTimer)(0)
static const Shortint DEF_RecordingTimerInterval = 0x0;
static const Shortint DEF_NoTimeSpecified = 0xffffffff;
static const bool DEF_Reencoding_IncludeAudioStream = true;
static const bool DEF_Reencoding_IncludeVideoStream = true;
#define DEF_Reencoding_Method (TRecordingMethod)(0)
...
#define DEF_RecordingSize (TRecordingSize)(0)
static const Shortint DEF_ScreenRecordingMonitor = 0x0;
...
static const Shortint DEF_ServerLostRetryCount = 0x0;
static const Shortint DEF_ServerLostRetryInterval = 0x5;
static const Shortint DEF_SendToDV_DeviceIndex = 0xffffffff;
...
#define DEF_SynchronizationRole (TSynchronizationRole)(0)
static const bool DEF_SyncCommands = true;
#define DEF_SyncPreview (TSyncPreview)(0)
static const bool DEF_TextOverlay_Enabled = false;
#define DEF_TextOverlay_Font (void *)(0x0)
static const int DEF_TextOverlay_FontColor = 0xffff00;
static const Shortint DEF_TextOverlay_Left = 0x0;
static const Shortint DEF_TextOverlay_Top = 0x0;
static const Shortint DEF_TextOverlay_Right = 0xffffffff;
static const bool DEF_TextOverlay_Scrolling = false;
static const Shortint DEF_TextOverlay_ScrollingSpeed = 0x1;
static const bool DEF_TextOverlay_Shadow = true;
static const int DEF_TextOverlay_ShadowColor = 0x0;
#define DEF_TextOverlay_ShadowDirection (TCardinalDirection)(7)
static const Shortint DEF_TextOverlay_Selector = 0x0;
static const int DEF_TextOverlay_BkColor = 0xffffff;
#define DEF_TextOverlay_Align (TTextOverlayAlign)(0)
...
static const Shortint DEF_TunerFrequency = 0xffffffff;
#define DEF_TunerMode (TTunerMode)(0)
static const bool DEF_UseClock = true;
static const Shortint DEF_VideoDevice = 0xffffffff;
static const Shortint DEF_VideoCompression_DataRate = 0xffffffff;
static const Shortint DEF_VideoCompression_KeyFrameRate = 0xf;
static const Shortint DEF_VideoCompression_PFramesPerKeyFrame = 0x0;
static const Shortint DEF_VideoCompression_Quality = 0x1;
static const Shortint DEF_VideoCompression_WindowSize = 0xffffffff;
static const Shortint DEF_StoredValueDefaults = 0xffffffff;
static const bool DEF_VideoControlSettings = true;
#define DEF_VideoFromImages_BitmapsSortedBy (TFileSort)(0)
static const bool DEF_VideoFromImages_RepeatIndefinitely = false;
static const Shortint DEF_VideoProcessing_Brightness = 0x0;
static const Shortint DEF_VideoProcessing_Contrast = 0x0;
#define DEF_VideoProcessing_Deinterlacing (TVideoDeinterlacing)(0)
...
static const Shortint DEF_VideoProcessing_Hue = 0x0;
static const bool DEF_VideoProcessing_InvertColors = false;
static const Shortint DEF_VideoProcessing_Pixellization = 0x1;
static const Shortint DEF_VideoProcessing_Saturation = 0x0;
#define DEF_VideoProcessing_Rotation (TVideoRotation)(0)
#define DEF_VideoProcessing_RotationCustomAngle  (4.550000E+01)
static const bool DEF_VideoQualitySettings = true;
#define DEF_VideoRenderer (TVideoRenderer)(0)
#define DEF_VideoRendererExternal (TVideoRendererExternal)(0)
static const Shortint DEF_VideoRendererExternalIndex = 0xffffffff;
#define DEF_VideoSource (TVideoSource)(0)
static const bool DEF_VideoVisibleWhenStopped = false;
static const Shortint DEF_VirtualVideoStreamControl = 0xffffffff;
static const Shortint DEF_VirtualAudioStreamControl = 0xffffffff;
#define DEF_WebcamStillCaptureButton (TWebcamStillCaptureButton)(0)
static const Shortint DEF_VUNotificationFps = 0xa;
static const Shortint DEF_ZoomYCenter = 0x0;
static const Shortint DEF_ZoomXCenter = 0x0;
static const Word DEF_ZoomCoeff = 0x3e8;
#define DATASTEADREGENTRY "\\Software\\Datastead\\"
#define USERMODEID "UserMode"
#define FILTERPARAM1ID "FilterParam1="
#define VCLID "VCLId:"
#define VALID "VALId:"
#define DESIGNMODEID "DesignMode"
#define IDEXCEPTIONSENABLED "ExceptionsEnabled"
#define IDEXCEPTIONSDISABLED "ExceptionsDisabled"
#define DEFAULTREGIDNAME "\\Software\\Datastead\\TVideoGrabber\\"
#define IDRESETCOUNTER "RESETCOUNTER"
...
extern PACKAGE AnsiString RegKeyId;
extern PACKAGE bool VfwDriversEnabled;
extern PACKAGE GUID *CustomEnClsid;
extern PACKAGE Extended __fastcall StrToFloatDef(const AnsiString S, const Extended Default_);
