...
// (DO NOT EDIT: machine generated header) 'VidGrab.pas' rev: 6.00
...
typedef void __fastcall (__closure *TOnClientConnection)(System::TObject* Sender, bool Connected, AnsiString ClientInfo);
...
typedef void __fastcall (__closure *TOnLog)(System::TObject* Sender, TLogType LogType, AnsiString Severity, AnsiString InfoMsg);

typedef void __fastcall (__closure *TOnSourceFileToDestFileStarted)(System::TObject* Sender, AnsiString SourceFile, AnsiString DestFile);

typedef void __fastcall (__closure *TOnSourceFileToDestFileCompleted)(System::TObject* Sender, AnsiString SourceFile, AnsiString DestFile, bool Success);

typedef void __fastcall (__closure *TOnFileNotification)(System::TObject* Sender, AnsiString FileName);

typedef void __fastcall (__closure *TOnCreatePreallocatedFileCompleted)(System::TObject* Sender, AnsiString FileName, bool Success);

typedef void __fastcall (__closure *TOnResizeVideo)(System::TObject* Sender, int SourceWidth, int SourceHeight);

typedef void __fastcall (__closure *TOnRecordingCompleted)(System::TObject* Sender, AnsiString FileName, bool Success);

typedef void __fastcall (__closure *TOnEnumerateWindows)(System::TObject* Sender, int WindowHandle, AnsiString WindowName, AnsiString WindowClass);

typedef void __fastcall (__closure *TOnVideoFromBitmapsNextFrameNeeded)(System::TObject* Sender, bool FirstSample);

typedef void __fastcall (__closure *TOnDVCommandCompleted)(System::TObject* Sender, int NewStateValue, AnsiString NewStateLabel);

typedef void __fastcall (__closure *TOnDeviceArrivalOrRemoval)(System::TObject* Sender, bool IsDeviceArrival, bool IsVideoDevice, AnsiString DeviceName, int DeviceIndex);

typedef void __fastcall (__closure *TOnPlayerBufferingData)(System::TObject* Sender, bool StartingToBuffer);

typedef void __fastcall (__closure *TOnDirectNetworkStreamingHostUrl)(System::TObject* Sender, AnsiString HostUrl, AnsiString HostName, int HostPort);

typedef void __fastcall (__closure *TOnAuthenticationNeeded)(System::TObject* Sender, TAuthenticationType AuthenticationType, AnsiString Realm, AnsiString Server, AnsiString &Username, AnsiString &Password);
...
typedef void __fastcall (__closure *TOnFilterSelected)(System::TObject* Sender, AnsiString FilterName, bool &RejectFilter);

typedef void __fastcall (__closure *TOnFrameCaptureCompleted)(System::TObject* Sender, void * FrameBitmap, int BitmapWidth, int BitmapHeight, unsigned FrameNumber, __int64 FrameTime, TFrameCaptureDest DestType, AnsiString FileName, bool Success, int FrameId);
...
typedef void __fastcall (__closure *TOnAVIDurationUpdated)(System::TObject* Sender, AnsiString FileName, unsigned FrameCount, double &FrameRate, __int64 &Duration);
...
typedef void __fastcall (__closure *TOnProgressCommented)(System::TObject* Sender, int Percent, __int64 Position, __int64 Duration, AnsiString Comment);
...
public:
	...
	int __fastcall FindIndexInListByName(AnsiString List, AnsiString SearchedString, bool IsSubString, bool IgnoreCase);
	...
	bool __fastcall AVIInfo(AnsiString AVIFile, /* out */ __int64 &Duration, /* out */ __int64 &FrameCount, /* out */ int &_VideoWidth, /* out */ int &_VideoHeight, /* out */ double &VideoFrameRateFps, /* out */ int &AvgBitRate, /* out */ int &AudioChannels, /* out */ int &AudioSamplesPerSec, /* out */ int &AudioBitsPerSample, /* out */ AnsiString &VideoCodec, /* out */ AnsiString &AudioCodec);
	...
	bool __fastcall LoadCompressorSettingsFromDataString(bool IsVideoCompressor, int CompressorIndex, AnsiString DataString);
	bool __fastcall LoadCompressorSettingsFromTextFile(bool IsVideoCompressor, int CompressorIndex, AnsiString FileName);
	...
	bool __fastcall MotionDetector_UseThisReferenceSample(Graphics::TBitmap* Bitmap, AnsiString BMPFile, AnsiString JPEGFile);
	...
	bool __fastcall ReencodeVideoClip(AnsiString SourceVideoClip, AnsiString NewVideoClip, bool IncludeVideoStream, bool IncludeAudioStream, bool UseFrameGrabber, bool UseCurrentVideoCompressor, bool UseCurrentAudioCompressor);
	...
	void __fastcall SetAuthentication(TAuthenticationType AuthenticationType, AnsiString UserName, AnsiString Password);
	...
	bool __fastcall SaveCompressorSettingsToTextFile(bool IsVideoCompressor, int CompressorIndex, AnsiString FileName);
	...
	bool __fastcall SendImageToVideoFromBitmaps(AnsiString ImageFilePath, unsigned BitmapHandle, bool CanFreeBitmapHandle, bool EndOfData);
	...
	bool __fastcall TextOverlay_CreateCustomFont(int fHeight, int fWidth, int fEscapement, int fOrientation, int fWeight, bool fItalic, bool fUnderline, bool fStrikeOut, unsigned fCharSet, unsigned fOutputPrecision, unsigned fClipPrecision, unsigned fQuality, unsigned fPitchAndFamily, AnsiString FontFacename);
	bool __fastcall ThirdPartyFilter_AddToList(TThirdPartyFilterList Location, AnsiString GUIDString, AnsiString OptionalDLLFilePath, AnsiString FilterName, bool Enable, bool CanSaveFilterState);
	bool __fastcall ThirdPartyFilter_ClearList(void);
	bool __fastcall ThirdPartyFilter_Enable(TThirdPartyFilterList Location, AnsiString GUIDString, bool Enable);
...
__published:
	...
	__property AnsiString ASFMediaServerPublishingPoint = {read=GetASFMediaServerPublishingPoint, write=SetASFMediaServerPublishingPoint};
	__property AnsiString ASFMediaServerTemplatePublishingPoint = {read=GetASFMediaServerTemplatePublishingPoint, write=SetASFMediaServerTemplatePublishingPoint};
	...
	__property AnsiString VideoFromImages_SourceDirectory = {read=GetVideoFromImages_SourceDirectory, write=SetVideoFromImages_SourceDirectory, stored=false};
	__property AnsiString VideoFromImages_TemporaryFile = {read=GetVideoFromImages_TemporaryFile, write=SetVideoFromImages_TemporaryFile};
