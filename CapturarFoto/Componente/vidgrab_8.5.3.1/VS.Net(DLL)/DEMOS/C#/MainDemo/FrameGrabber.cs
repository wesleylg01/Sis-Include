...
namespace MainDemo
{
	...
	public class FrameGrabber : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{
			SetRadioButtonInGroupUsingTag(rgdFrameGrabber, (short) cMainForm.VideoGrabber1.FrameGrabber);
			SetRadioButtonInGroupUsingTag(rgdFrameGrabberFormat, (short) cMainForm.VideoGrabber1.FrameGrabberRGBFormat);
			SetRadioButtonInGroupUsingTag(rdgAutoFileName, (short) cMainForm.VideoGrabber1.AutoFileName);

			edtAVIAutoFilePrefix.Text = cMainForm.VideoGrabber1.AutoFilePrefix;

			edtBurstCount.Text = cMainForm.VideoGrabber1.BurstCount.ToString();
			edtBurstInterval.Text = cMainForm.VideoGrabber1.BurstInterval.ToString();
			tbrCaptureZoomSize.Value = cMainForm.VideoGrabber1.FrameCaptureZoomSize;
			edtFrameCaptureWidth.Text = cMainForm.VideoGrabber1.FrameCaptureWidth.ToString();
			edtFrameCaptureHeight.Text = cMainForm.VideoGrabber1.FrameCaptureHeight.ToString();
		}

		private void btnBurstModeBMPFile_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.BurstType = VidGrab.TFrameCaptureDest.fc_BmpFile;
			cMainForm.VideoGrabber1.BurstMode = true;
		...
		{
			cMainForm.VideoGrabber1.BurstType = VidGrab.TFrameCaptureDest.fc_JpegFile;
			cMainForm.VideoGrabber1.BurstMode = true;
			// The frame capture starts when BurstMode is set to true.;
			// if (BurstCount = 0 the frame capture won"t stop.;
		...
		{
			cMainForm.VideoGrabber1.BurstType = VidGrab.TFrameCaptureDest.fc_Clipboard;
			cMainForm.VideoGrabber1.BurstMode = true;
			// The frame capture starts when BurstMode is set to true.;
			// if (BurstCount = 0 the frame capture won"t stop.;
		...
		{
			cMainForm.VideoGrabber1.BurstMode = false;
		}

		private void btnBurstModeTBitmap_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.BurstType = VidGrab.TFrameCaptureDest.fc_TBitmap;
			cMainForm.VideoGrabber1.BurstMode = true;
			// The frame capture starts when BurstMode is set to true.;
			// if (BurstCount = 0 the frame capture won"t stop.;
			// Captured frames will be returned by the OnFrameCaptureCompleted event.;
		...
		private void btnOneShotJPEGFile_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.CaptureFrameTo(VidGrab.TFrameCaptureDest.fc_JpegFile, edtUseThisFileName.Text);
			}
			else {
				cMainForm.VideoGrabber1.CaptureFrameTo(VidGrab.TFrameCaptureDest.fc_JpegFile, "");
			}
		...
		private void btnOneShotBMPFile_Click(object sender, System.EventArgs e)
		{
			if (chkUseThisFileName.Checked) 
			{
				cMainForm.VideoGrabber1.CaptureFrameTo(VidGrab.TFrameCaptureDest.fc_BmpFile, edtUseThisFileName.Text);
			}
			else 
			{
				cMainForm.VideoGrabber1.CaptureFrameTo(VidGrab.TFrameCaptureDest.fc_BmpFile, "");
			}
			// note 1: passing an empty file name let TVideoGrabber generate it automatically in the StoragePath directory;
			// note 2: using CaptureFrameSyncTo instead of CaptureFrameTo waits for frame capture completion and returns true upon success;
		}
		...
		{
			cMainForm.VideoGrabber1.CaptureFrameTo(VidGrab.TFrameCaptureDest.fc_Clipboard, "");
		}

		private void btnOneShotTBitmap_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.CaptureFrameTo(VidGrab.TFrameCaptureDest.fc_TBitmap, "");
		}
		...
		{
			cMainForm.VideoGrabber1.AutoFilePrefix = edtAVIAutoFilePrefix.Text;
		}
		...
		private void edtBurstCount_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.BurstCount = Convert.ToInt32 (edtBurstCount.Text);
			};
		}
		...
		private void edtBurstInterval_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.BurstInterval = Convert.ToInt32 (edtBurstInterval.Text);
			};
		}
		...
		private void rdgAutoFileName1_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.AutoFileName = VidGrab.TAutoFileName.fn_Sequential;
			};
		}
		...
		private void rdgAutoFileName2_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.AutoFileName = VidGrab.TAutoFileName.fn_DateTime;
			};
		}
		...
		private void btnResetCaptureZoomSize_Click(object sender, System.EventArgs e)
		{
            ...
            cMainForm.VideoGrabber1.FrameCaptureZoomSize = tbrCaptureZoomSize.Value;
		...
		private void edtFrameCaptureWidth_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.FrameCaptureWidth = Convert.ToInt32 (edtFrameCaptureWidth.Text);
			}
		}
		...
		private void edtFrameCaptureHeight_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.FrameCaptureHeight = Convert.ToInt32 (edtFrameCaptureHeight.Text);
			}
		}
		...
		private void rgdFrameGrabber_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.FrameGrabber = (VidGrab.TFrameGrabber) Convert.ToInt32 ((sender as Control).Tag);
				RefreshControls();
			}
		...
		private void rgdFrameGrabberFormat_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.FrameGrabberRGBFormat = (VidGrab.TFrameGrabberRGBFormat) Convert.ToInt32 ((sender as Control).Tag);
			}
        ...
        private void rdgAutoFileName3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                cMainForm.VideoGrabber1.AutoFileName = VidGrab.TAutoFileName.fn_Counter;
            };
