...
namespace MainDemo
{
											...
											// destroyed when closed, and includes also some additional tools.
	{
		...
		private void InitTrackBar(CheckBox chkAuto, Button btnDefault, TrackBar tbrValue, VidGrab.TVideoQuality Setting)
		{
			...
			if (! cMainForm.VideoGrabber1.IsVideoQualitySettingAvailable(Setting)) 
			{
			...
			else 
			{
				...
				chkAuto.Checked = cMainForm.VideoGrabber1.VideoQualityAuto(Setting);
				tbrValue.Enabled = ! chkAuto.Checked;
				btnDefault.Enabled = ! chkAuto.Checked;

                int MinValue = cMainForm.VideoGrabber1.VideoQualityMin(Setting);
                int MaxValue = cMainForm.VideoGrabber1.VideoQualityMax(Setting);
                int CurrentValue = cMainForm.VideoGrabber1.VideoQualityValue(Setting);
                ...
                tbrValue.TickFrequency = cMainForm.VideoGrabber1.VideoQualityStep(Setting);
		...
		private void tbrSetValue (System.Object sender, System.EventArgs e)
		{
			...
			cMainForm.VideoGrabber1.SetVideoQuality((VidGrab.TVideoQuality) Setting, FSettingGroup[Setting].chkAuto.Checked, false, FSettingGroup[Setting].tbrValue.Value);
		...
		private void btnSetDefault (System.Object sender, System.EventArgs e)
		{
			...
			cMainForm.VideoGrabber1.SetVideoQuality((VidGrab.TVideoQuality) Setting, FSettingGroup[Setting].chkAuto.Checked, true, FSettingGroup[Setting].tbrValue.Value);
			FSettingGroup[Setting].tbrValue.Value = cMainForm.VideoGrabber1.VideoQualityValue((VidGrab.TVideoQuality) Setting);
		}
