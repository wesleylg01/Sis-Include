...
namespace MainDemo
{
	...
	public class NetworkStreaming : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{
			SetRadioButtonInGroupUsingTag((rdgNetworkStreaming), (short) cMainForm.VideoGrabber1.NetworkStreaming);
			SetRadioButtonInGroupUsingTag((rdgNetworkStreamingType), (short) cMainForm.VideoGrabber1.NetworkStreamingType);

			if (cMainForm.VideoGrabber1.ASFProfileVersion == VidGrab.TASFProfileVersion.apv_ProfileVersion_8) 
			{
				rgdWMV8.Checked = true;
			}
			if (cMainForm.VideoGrabber1.ASFProfileVersion == VidGrab.TASFProfileVersion.apv_ProfileVersion_9) 
			{
				rdgWMV9.Checked = true;
			}

			if (cMainForm.VideoGrabber1.ASFProfileFromCustomFile !=  null) 
			{
				edtWMV9profile.Text = cMainForm.VideoGrabber1.ASFProfileFromCustomFile;
			}
			edtPublishingPoint.Text = cMainForm.VideoGrabber1.ASFMediaServerPublishingPoint;
			edtNetworkPort.Text = cMainForm.VideoGrabber1.ASFNetworkPort.ToString();
			edtNetworkMaxUsers.Text = cMainForm.VideoGrabber1.ASFNetworkMaxUsers.ToString();

			edtASFVideoWidth.Text = cMainForm.VideoGrabber1.ASFVideoWidth.ToString();
			edtASFVideoHeight.Text = cMainForm.VideoGrabber1.ASFVideoHeight.ToString();
			edtASFVideoBitRate.Text = cMainForm.VideoGrabber1.ASFVideoBitRate.ToString();
			edtASFVideoMaxKeyFrameSpacing.Text = cMainForm.VideoGrabber1.ASFVideoMaxKeyFrameSpacing.ToString();
			edtASFVideoQuality.Text = cMainForm.VideoGrabber1.ASFVideoQuality.ToString();
			edtASFAudioChannels.Text = cMainForm.VideoGrabber1.ASFAudioChannels.ToString();
			chkASFFixedFrameRate.Checked = cMainForm.VideoGrabber1.ASFFixedFrameRate;
			cmbASFDeinterlaceMode.SelectedIndex = (int) cMainForm.VideoGrabber1.ASFDeinterlaceMode;

			edtProfileIndex.Text = cMainForm.VideoGrabber1.ASFProfile.ToString();
		}
		...
		private void btnShowProfilesList_Click(object sender, System.EventArgs e)
		{
			if (cMainForm.VideoGrabber1.ASFProfileVersion == VidGrab.TASFProfileVersion.apv_ProfileVersion_8) 
			{
				LoadTextBox(lsbProfiles, cMainForm.VideoGrabber1.ASFProfiles);
			}
			else 
			{
        ...
        private void lsbProfiles_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                cMainForm.VideoGrabber1.ASFProfile = lsbProfiles.SelectedIndex;
                edtProfileIndex.Text =Convert.ToString(cMainForm.VideoGrabber1.ASFProfile);
            }
        }
		...
		private void edtProfileIndex_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.ASFProfile = Convert.ToInt32(edtProfileIndex.Text);
			}
		}

		private void rdgNetworkStreamingDisabled_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.NetworkStreaming = VidGrab.TNetworkStreaming.ns_Disabled;
		...
		{
			cMainForm.VideoGrabber1.NetworkStreaming = VidGrab.TNetworkStreaming.ns_ASFDirectNetworkStreaming;
		...
		{
			cMainForm.VideoGrabber1.NetworkStreaming = VidGrab.TNetworkStreaming.ns_ASFStreamingToPublishingPoint;
            btnViewDirectNetworkStreaming.Enabled = false;
		}

		private void rdgNetworkStreamingTypeAudioVideo_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.NetworkStreamingType = VidGrab.TNetworkStreamingType.nst_AudioVideoStreaming;
		}

		private void rdgNetworkStreamingTypeVideo_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.NetworkStreamingType = VidGrab.TNetworkStreamingType.nst_VideoStreaming;
		}

		private void rdgNetworkStreamingTypeAudio_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.NetworkStreamingType = VidGrab.TNetworkStreamingType.nst_AudioStreaming;
		}

		private void btnViewDirectNetworkStreaming_Click(object sender, System.EventArgs e)
		{
			if (cMainForm.VideoGrabber1.StreamingURL != "") 
			{
				ShellExecute((System.IntPtr) 0, "open", cMainForm.VideoGrabber1.StreamingURL, "", "", ShowCommands.SW_SHOWNORMAL);
			}
		}

		private void chkASFFixedFrameRate_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.ASFFixedFrameRate = chkASFFixedFrameRate.Checked;
		}

		private void cmbASFDeinterlaceMode_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.ASFDeinterlaceMode = (VidGrab.TASFDeinterlaceMode) cmbASFDeinterlaceMode.SelectedIndex;
		}
		...
		private void edtASFAudioChannels_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.ASFAudioChannels = Convert.ToInt32 (edtASFAudioChannels.Text);
			}
		}
		...
		private void edtASFVideoBitRate_TextChanged(object sender, System.EventArgs e)
		{
			if (IsNumeric(edtASFVideoBitRate.Text)) 
			{
				...
				{
					cMainForm.VideoGrabber1.ASFVideoBitRate = Convert.ToInt32 (edtASFVideoBitRate.Text);
				}
			}
		}
		...
		private void edtASFVideoHeight_TextChanged(object sender, System.EventArgs e)
		{
			if (IsNumeric(edtASFVideoHeight.Text)) 
			{
				...
				{
					cMainForm.VideoGrabber1.ASFVideoHeight = Convert.ToInt32(edtASFVideoHeight.Text);
				}
			}
		}
		...
		private void edtASFVideoMaxKeyFrameSpacing_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.ASFVideoMaxKeyFrameSpacing = Convert.ToInt32(edtASFVideoMaxKeyFrameSpacing.Text);
			}
		}
		...
		private void edtASFVideoQuality_TextChanged(object sender, System.EventArgs e)
		{
			if (IsNumeric(edtASFVideoQuality.Text)) 
			{
				...
				{
					cMainForm.VideoGrabber1.ASFVideoQuality = Convert.ToInt32(edtASFVideoQuality.Text);
				}
			}
		}
		...
		private void edtASFVideoWidth_TextChanged(object sender, System.EventArgs e)
		{
			if (IsNumeric(edtASFVideoWidth.Text)) 
			{
				...
				{
					cMainForm.VideoGrabber1.ASFVideoWidth = Convert.ToInt32(edtASFVideoWidth.Text);
				}
			}
		}
		...
		private void edtNetworkMaxUsers_TextChanged(object sender, System.EventArgs e)
		{
			if (IsNumeric(edtNetworkMaxUsers.Text)) 
			{
				...
				{
					cMainForm.VideoGrabber1.ASFNetworkMaxUsers = Convert.ToInt32(edtNetworkMaxUsers.Text);
				}
			}
		}
		...
		private void edtNetworkPort_TextChanged(object sender, System.EventArgs e)
		{
			if (IsNumeric(edtNetworkPort.Text)) 
			{
				...
				{
					cMainForm.VideoGrabber1.ASFNetworkPort = Convert.ToInt32(edtNetworkPort.Text);
				}
			}
		}
		...
		{
			cMainForm.VideoGrabber1.ASFMediaServerPublishingPoint = edtPublishingPoint.Text;
		}

        private void edtPublishingPointUsername_TextChanged(object sender, System.EventArgs e)
        {
            cMainForm.VideoGrabber1.SetAuthentication (VidGrab.TAuthenticationType.at_PublishingPoint, edtPublishingPointUsername.Text, edtPublishingPointPassword.Text);
        }
		...
		{
			cMainForm.VideoGrabber1.ASFProfileFromCustomFile = edtWMV9profile.Text;
		}

		private void rgdWMV8_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.ASFProfileVersion = VidGrab.TASFProfileVersion.apv_ProfileVersion_8;
		}

		private void rdgWMV9_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.ASFProfileVersion = VidGrab.TASFProfileVersion.apv_ProfileVersion_9;
		}
