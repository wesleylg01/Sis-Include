...
namespace MainDemo
{
	...
	public class MotionDetection : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{
			chkMotionDetectionEnabled.Checked = cMainForm.VideoGrabber1.MotionDetector_Enabled;
			chkCompareRed.Checked = cMainForm.VideoGrabber1.MotionDetector_CompareRed;
			chkCompareGreen.Checked = cMainForm.VideoGrabber1.MotionDetector_CompareGreen;
			chkCompareBlue.Checked = cMainForm.VideoGrabber1.MotionDetector_CompareBlue;
			chk_GreyScale.Checked = cMainForm.VideoGrabber1.MotionDetector_GreyScale;
			chkReduceVideoNoise.Checked = cMainForm.VideoGrabber1.MotionDetector_ReduceVideoNoise;
			edtGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Grid;
			mmoSensitivityGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Get2DTextGrid();
			updGridColCount.Value = cMainForm.VideoGrabber1.MotionDetector_GridXCount;
			updGridRowCount.Value = cMainForm.VideoGrabber1.MotionDetector_GridYCount;
			lblMotionDetectorRequiresFrameGrabber.Visible = cMainForm.VideoGrabber1.FrameGrabber == VidGrab.TFrameGrabber.fg_Disabled;
		...
		{
			cMainForm.VideoGrabber1.MotionDetector_SetGridSize(Convert.ToInt32(updGridColCount.Value), Convert.ToInt32(updGridRowCount.Value));
			edtGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Grid;
			mmoSensitivityGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Get2DTextGrid();
		}
		...
		{
			cMainForm.VideoGrabber1.MotionDetector_SetCellSensitivity(Convert.ToInt32(updXCell.Value), Convert.ToInt32(updYCell.Value), Convert.ToInt32(updCellSensitivity.Value));
			edtGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Grid;
			mmoSensitivityGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Get2DTextGrid();
		}
		...
		private void btnShowGridDialog_Click(object sender, System.EventArgs e)
		{
			...
			if (! cMainForm.VideoGrabber1.MotionDetector_Enabled) 
			{
			...
			if ((cMainForm.VideoGrabber1.MotionDetector_GridXCount > 30) || (cMainForm.VideoGrabber1.MotionDetector_GridYCount > 30)) 
			{
                MessageBox.Show("the grid will be too dense to be edited through the dialog, you should use SetGridCell",
                            "DataStead TVideoGrabber C#.NET OCX Demo", MessageBoxButtons.OK);
			}
			cMainForm.VideoGrabber1.MotionDetector_ShowGridDialog();
			edtGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Grid;
			mmoSensitivityGrid.Text = cMainForm.VideoGrabber1.MotionDetector_Get2DTextGrid();
		}
		...
		{
			cMainForm.VideoGrabber1.MotionDetector_Triggered = chk_triggered.Checked;
		}

		private void btn_TriggerNow_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_TriggerNow();
		}

		private void chk_GreyScale_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_GreyScale = chk_GreyScale.Checked;
		}

		private void chkCompareBlue_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_CompareBlue = chkCompareBlue.Checked;
		}

		private void chkCompareGreen_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_CompareGreen = chkCompareGreen.Checked;
		}

		private void chkCompareRed_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_CompareRed = chkCompareRed.Checked;
		}

		private void chkMotionDetectionEnabled_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_Enabled = chkMotionDetectionEnabled.Checked;
            MotionDetected = false;
		}

		private void chkReduceVideoNoise_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_ReduceVideoNoise = chkReduceVideoNoise.Checked;
		}

		private void edtGrid_TextChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MotionDetector_Grid = edtGrid.Text;
			if (cMainForm.VideoGrabber1.MotionDetector_IsGridValid) 
			{
		...
		private void updGlobalGridSensitivity_ValueChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.MotionDetector_GloballyIncOrDecSensitivity(1);
			}
			else 
			{
				cMainForm.VideoGrabber1.MotionDetector_GloballyIncOrDecSensitivity(-1);
