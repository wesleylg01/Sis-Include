...
namespace MainDemo
{
	...
	public class Display : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		public void RefreshControls()
		{
			...
			SetRadioButtonInGroupUsingTag(rdgVideoRenderer, (short) cMainForm.VideoGrabber1.VideoRenderer);
			
            chkAdjustPixelAspectRatio.Checked = cMainForm.VideoGrabber1.AdjustPixelAspectRatio;

			chk1stVisible.Checked = cMainForm.VideoGrabber1.Display_Visible;
			chk1stVideoWindowActive.Checked = cMainForm.VideoGrabber1.Display_Active;
			chk1stEmbedded.Checked = cMainForm.VideoGrabber1.Display_Embedded;
			chk1stFullScreen.Checked = cMainForm.VideoGrabber1.Display_FullScreen;
			chk1stStayOnTop.Checked = cMainForm.VideoGrabber1.Display_StayOnTop;
			chk1stUseVideoPort.Checked = cMainForm.VideoGrabber1.Display_VideoPortEnabled;
			chk1stMouseMovesWindow.Checked = cMainForm.VideoGrabber1.Display_MouseMovesWindow;
			chk1stAutoSize.Checked = cMainForm.VideoGrabber1.Display_AutoSize;
			SetRadioButtonInGroupUsingTag(rdg1stDisplayedOn, (short) cMainForm.VideoGrabber1.Display_Monitor);
			SetRadioButtonInGroupUsingTag(rdg1AspectRatio, (short) cMainForm.VideoGrabber1.Display_AspectRatio);
			tbr1PanScan.Value = cMainForm.VideoGrabber1.Display_PanScanRatio;

			grbMainVideoWindow.Enabled = cMainForm.VideoGrabber1.Display_Active;

			if (cMainForm.VideoGrabber1.Display_Active) {
				chk1stStayOnTop.Enabled = (! cMainForm.VideoGrabber1.Display_Embedded) || cMainForm.VideoGrabber1.Display_FullScreen;
				chk1stMouseMovesWindow.Enabled = ! cMainForm.VideoGrabber1.Display_Embedded;
				rdg1stDisplayedOn.Enabled = ! cMainForm.VideoGrabber1.Display_Embedded;
				btnEG1stNewLocation.Enabled = ! cMainForm.VideoGrabber1.Display_Embedded;
				btnEG1stNewLocation2.Enabled = ! cMainForm.VideoGrabber1.Display_Embedded;
				chk1stUseVideoPort.Enabled = cMainForm.VideoGrabber1.IsVideoPortAvailable;
			}

			chk2ndVisible.Checked = cMainForm.VideoGrabber1.DualDisplay_Visible;
			chk2ndVideoWindowActive.Checked = cMainForm.VideoGrabber1.DualDisplay_Active;
			chk2ndEmbedded.Checked = cMainForm.VideoGrabber1.DualDisplay_Embedded;
			chk2ndFullScreen.Checked = cMainForm.VideoGrabber1.DualDisplay_FullScreen;
			chk2ndStayOnTop.Checked = cMainForm.VideoGrabber1.DualDisplay_StayOnTop;
			chk2ndUseVideoPort.Checked = cMainForm.VideoGrabber1.DualDisplay_VideoPortEnabled;
			chk2ndMouseMovesWindow.Checked = cMainForm.VideoGrabber1.DualDisplay_MouseMovesWindow;
			chk2ndAutoSize.Checked = cMainForm.VideoGrabber1.DualDisplay_AutoSize;
			SetRadioButtonInGroupUsingTag(rdg2ndDisplayedOn, (short) cMainForm.VideoGrabber1.DualDisplay_Monitor);
			SetRadioButtonInGroupUsingTag(rdg2AspectRatio, (short) cMainForm.VideoGrabber1.DualDisplay_AspectRatio);
			tbr2PanScan.Value = cMainForm.VideoGrabber1.DualDisplay_PanScanRatio;

			grb2ndVideoWindow.Enabled = cMainForm.VideoGrabber1.DualDisplay_Active;

			if (cMainForm.VideoGrabber1.DualDisplay_Active) {
				chk2ndStayOnTop.Enabled = (! cMainForm.VideoGrabber1.DualDisplay_Embedded) || cMainForm.VideoGrabber1.DualDisplay_FullScreen;
				chk2ndMouseMovesWindow.Enabled = ! cMainForm.VideoGrabber1.DualDisplay_Embedded;
				rdg2ndDisplayedOn.Enabled = ! cMainForm.VideoGrabber1.DualDisplay_Embedded;
				btnEG2ndNewLocation.Enabled = ! cMainForm.VideoGrabber1.DualDisplay_Embedded;
				btnEG2ndNewLocation.Enabled = ! cMainForm.VideoGrabber1.DualDisplay_Embedded;
				chk2ndUseVideoPort.Enabled = cMainForm.VideoGrabber1.IsVideoPortAvailable;
			}
		}

		private void btnEG1stNewLocation_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_AutoSize = true; // the component"s video size will be used
			cMainForm.VideoGrabber1.Display_Embedded = false; // detach from component
			cMainForm.VideoGrabber1.Display_SetLocation(10, 10, 320, 240); // 320 and 240 are not used because of AutoSize above
			RefreshControls();
		}

		private void btnEG1stNewLocation2_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_AutoSize = false; // we will specify the size below
			cMainForm.VideoGrabber1.Display_Embedded = false; // detach from component
			cMainForm.VideoGrabber1.Display_SetLocation(20, 20, 480, 200); // new size: 480 x 360
			RefreshControls();
		}

		private void btnEG2ndNewLocation_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_AutoSize = true; // the component's video size will be used
			cMainForm.VideoGrabber1.DualDisplay_Embedded = false; // detach from component
			cMainForm.VideoGrabber1.DualDisplay_SetLocation(510, 10, 320, 240); // 320 and 240 are ! used because of AutoSize above
			RefreshControls();
		}

		private void btnEG2ndNewLocation2_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_AutoSize = false; // we will specify the size below
			cMainForm.VideoGrabber1.DualDisplay_Embedded = false; // detach from component
			cMainForm.VideoGrabber1.DualDisplay_SetLocation(520, 30, 480, 200); // new size: 480 x 360
			RefreshControls();
		}

		private void chk1stAutoSize_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_AutoSize = chk1stAutoSize.Checked;
			RefreshControls();
            ...
            if (!cMainForm.VideoGrabber1.Display_AutoSize)
            {
                if (cMainForm.VideoGrabber1.Display_Embedded)
                {
                    cMainForm.VideoGrabber1.Width = cMainForm.StartupVGWidth;
                    cMainForm.VideoGrabber1.Height = cMainForm.StartupVGHeight;
                }
                else
                {
                    cMainForm.VideoGrabber1.Display_Width = cMainForm.StartupVGWidth;
                    cMainForm.VideoGrabber1.Display_Height = cMainForm.StartupVGHeight;
                }
            }
		...
		{
			cMainForm.VideoGrabber1.Display_Visible = chk1stVisible.Checked;
		}

		private void chk1stEmbedded_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_Embedded = chk1stEmbedded.Checked;
			RefreshControls();
		}

		private void chk1stFullScreen_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_FullScreen = chk1stFullScreen.Checked;
			RefreshControls();
		}

		private void chk1stMouseMovesWindow_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_MouseMovesWindow = chk1stMouseMovesWindow.Checked;
			RefreshControls();
		}

		private void chk1stStayOnTop_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_StayOnTop = chk1stStayOnTop.Checked;
			RefreshControls();
		}

		private void chk1stUseVideoPort_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_VideoPortEnabled = chk1stUseVideoPort.Checked;
			RefreshControls();
		}

		private void chk2ndAutoSize_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_AutoSize = chk2ndAutoSize.Checked;
			RefreshControls();
            ...
            if (!cMainForm.VideoGrabber1.DualDisplay_AutoSize)
            {
                if (cMainForm.VideoGrabber1.DualDisplay_Embedded)
                {
                    cMainForm.VideoGrabber1.Width = cMainForm.StartupVGWidth;
                    cMainForm.VideoGrabber1.Height = cMainForm.StartupVGHeight;
                }
                ...
                {
                    cMainForm.VideoGrabber1.DualDisplay_Width = cMainForm.StartupVGWidth;
                    cMainForm.VideoGrabber1.DualDisplay_Height = cMainForm.StartupVGHeight;
                }
            }
		...
		{
			cMainForm.VideoGrabber1.DualDisplay_Visible = chk2ndVisible.Checked;
		}

		private void chk2ndEmbedded_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_Embedded = chk2ndEmbedded.Checked;
			RefreshControls();
		}

		private void chk2ndFullScreen_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_FullScreen = chk2ndFullScreen.Checked;
			RefreshControls();
		}

		private void chk2ndMouseMovesWindow_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_MouseMovesWindow = chk2ndMouseMovesWindow.Checked;
			RefreshControls();
		}

		private void chk2ndStayOnTop_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_StayOnTop = chk2ndStayOnTop.Checked;
			RefreshControls();
		}

		private void chk2ndUseVideoPort_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_VideoPortEnabled = chk2ndUseVideoPort.Checked;
			RefreshControls();
		}
        ...
        private void chkBlackMagicOutput_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                cMainForm.VideoGrabber1.VideoRendererExternal = VidGrab.TVideoRendererExternal.vre_BlackMagic_Decklink;
            }
            else
            {
                cMainForm.VideoGrabber1.VideoRendererExternal = VidGrab.TVideoRendererExternal.vre_None;
            }
        }

		private void chkVideoVisibleWhenStopped_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.VideoVisibleWhenStopped = chkVideoVisibleWhenStopped.Checked;
		}

        private void chkAdjustPixelAspectRatio_CheckedChanged(object sender, System.EventArgs e)
        {
            cMainForm.VideoGrabber1.AdjustPixelAspectRatio = chkAdjustPixelAspectRatio.Checked;
        }
		...
		private void chkBorder_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.BorderStyle = BorderStyle.Fixed3D;
			}
			else {
				cMainForm.VideoGrabber1.BorderStyle = BorderStyle.None;
			}
#endif
		}
		...
		private void chkChangeCursor_CheckedChanged(object sender, System.EventArgs e)
		{
			if (chkChangeCursor.Checked) {
				cMainForm.VideoGrabber1.VideoCursor = VidGrab.TCursors.cr_cross;
			}
			else {
				cMainForm.VideoGrabber1.VideoCursor = VidGrab.TCursors.cr_Default;
			}
		}

		private void chk2ndVideoWindowActive_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_Active = chk2ndVideoWindowActive.Checked;
			RefreshControls();
		}

		private void chk1stVideoWindowActive_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_Active = chk1stVideoWindowActive.Checked;
			RefreshControls();
		}
		...
		private void chkSetLogo_CheckedChanged(object sender, System.EventArgs e)
		{
			if (chkSetLogo.Checked) {
                ...
                cMainForm.VideoGrabber1.LogoLayout = VidGrab.TLogoLayout.lg_Stretched;
                cMainForm.VideoGrabber1.SetLogoFromHBitmap(CreateBitmapHandleFromPictureBox (imgLogo));
                cMainForm.VideoGrabber1.LogoDisplayed = true;
			}
            else {
                cMainForm.VideoGrabber1.LogoDisplayed = false;
            }
        }

		private void chkTransparency_CheckedChanged(object sender, System.EventArgs e)
		{
            frmTransparentWindow.TransparencyKey= Color.FromArgb((int) cMainForm.VideoGrabber1.ColorKey);
		...
		private void rdgVideoRenderer_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.VideoRenderer = (VidGrab.TVideoRenderer) Convert.ToInt32 ((sender as Control).Tag);
			}
		...
		private void rdg1DisplayAspectRatio_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.Display_AspectRatio = (VidGrab.TAspectRatio) Convert.ToInt32 ((sender as Control).Tag);
			}
		}

		private void tbr1PanScan_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.Display_PanScanRatio = tbr1PanScan.Value;
		}
		...
		private void btnTestPanScan_Click(object sender, System.EventArgs e)
		{
            ...
            cMainForm.VideoGrabber1.Display_Embedded = true;
            chkAdjustPixelAspectRatio.Checked = false;
            cMainForm.VideoGrabber1.AdjustPixelAspectRatio = false;

            chk1stAutoSize.Checked = false;
            cMainForm.VideoGrabber1.Display_AutoSize = false;
            ...
            if (boolPanScan)
            {
                cMainForm.VideoGrabber1.Width = PanScanVGWidth;
                cMainForm.VideoGrabber1.Height = PanScanVGHeight;
            }
            else
            {
                Single h = 9;
                Single w = 16;
                PanScanVGWidth = cMainForm.VideoGrabber1.Width;
                PanScanVGHeight = cMainForm.VideoGrabber1.Height;
                cMainForm.VideoGrabber1.Width =Convert.ToInt32(Convert.ToSingle( cMainForm.VideoGrabber1.Height) * (w / h));
            }
            boolPanScan = !boolPanScan;

            // setting Display_AspectRatio to ar_PanScan (pan and scan)
            rdg1DisplayAspectRatioPanScan.Checked = true;
            cMainForm.VideoGrabber1.Display_AspectRatio = VidGrab.TAspectRatio.ar_PanScan;
		...
		private void rdg2DisplayAspectRatio_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.DualDisplay_AspectRatio = (VidGrab.TAspectRatio) Convert.ToInt32 ((sender as Control).Tag);
			}
		}

		private void tbr2PanScan_Scroll(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DualDisplay_PanScanRatio = tbr2PanScan.Value;
		}
		...
		private void rdg1stDisplayedOn_CheckedChanged (object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.Display_Monitor = Convert.ToInt32 ((sender as Control).Tag);
				RefreshControls();
			}
		}
		...
		private void rdg2ndDisplayedOn_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.DualDisplay_Monitor = Convert.ToInt32 ((sender as Control).Tag);
				RefreshControls();
			}
		}
