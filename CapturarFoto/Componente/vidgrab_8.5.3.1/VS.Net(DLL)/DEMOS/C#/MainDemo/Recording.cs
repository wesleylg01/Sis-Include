...
namespace MainDemo
{
	...
	public class Recording : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{
			SetRadioButtonInGroupUsingTag((rdgRecordingMethod), (short) cMainForm.VideoGrabber1.RecordingMethod);
			SetRadioButtonInGroupUsingTag((rdgCompressMode), (short) cMainForm.VideoGrabber1.CompressionMode);
			SetRadioButtonInGroupUsingTag((rdgCompressType), (short) cMainForm.VideoGrabber1.CompressionType);
            SetRadioButtonInGroupUsingTag((rdgRecordingTimer), (short)cMainForm.VideoGrabber1.RecordingTimer);

			edtPreallocSize.Text = cMainForm.VideoGrabber1.PreallocCapFileSizeInMB.ToString();
			chkRecordingCanPause.Checked = cMainForm.VideoGrabber1.RecordingCanPause;
			chkPauseCreatesNewFile.Checked = cMainForm.VideoGrabber1.RecordingPauseCreatesNewFile;
			chkRecordingOnMotion.Checked = cMainForm.VideoGrabber1.RecordingOnMotion_Enabled;

			chkPreallocFile.Checked = cMainForm.VideoGrabber1.PreallocCapFileEnabled;
			chkOpenDML.Checked = cMainForm.VideoGrabber1.AVIFormatOpenDML;
			chkPreserveNativeFormat.Checked = cMainForm.VideoGrabber1.RecordingInNativeFormat;

			chkAudioRecording.Checked = cMainForm.VideoGrabber1.AudioRecording;

			AssignListToComboBox((cboVideoCompressors), cMainForm.VideoGrabber1.VideoCompressors, cMainForm.VideoGrabber1.VideoCompressor);
			AssignListToComboBox((cboAudioCompressors), cMainForm.VideoGrabber1.AudioCompressors, cMainForm.VideoGrabber1.AudioCompressor);
            AssignListToComboBox((cboMultiplexers), cMainForm.VideoGrabber1.Multiplexers, cMainForm.VideoGrabber1.Multiplexer);

            AssignListToComboBox(cboAudioFormats, cMainForm.VideoGrabber1.AudioFormats, (int) cMainForm.VideoGrabber1.AudioFormat);

            btnPauseRecording.Enabled = cMainForm.VideoGrabber1.RecordingCanPause;
			btnResumeRecording.Enabled = cMainForm.VideoGrabber1.RecordingCanPause;

			rdgCompressMode.Enabled = true;
			rdgCompressType.Enabled = true;

            chkScreenRecordWindow.Enabled = ((cMainForm.VideoGrabber1.VideoSource == VidGrab.TVideoSource.vs_ScreenRecording) ? true : false);

			if (! cMainForm.VideoGrabber1.AudioRecording) 
			{
				rdgCompressType.Enabled = false;
			}
			
            chkOpenDML.Enabled = cMainForm.VideoGrabber1.RecordingMethod == VidGrab.TRecordingMethod.rm_AVI;

            bool CanUseCompressors = (cMainForm.VideoGrabber1.RecordingMethod != VidGrab.TRecordingMethod.rm_ASF) 
                                        && (cMainForm.VideoGrabber1.RecordingMethod != VidGrab.TRecordingMethod.rm_SendToDV);

            bool CanUseMultiplexer = CanUseCompressors && (cMainForm.VideoGrabber1.RecordingMethod != VidGrab.TRecordingMethod.rm_AVI); // AVI uses the Microsoft's AVI mux 
        ...
        {
            cMainForm.VideoGrabber1.ShowDialog(VidGrab.TDialog.dlg_VideoCompressor);
        }

        private void btnAudioCompressorSettings_Click(object sender, System.EventArgs e)
        {
            cMainForm.VideoGrabber1.ShowDialog(VidGrab.TDialog.dlg_AudioCompressor);
        }

        private void btnMultiplexerSettings_Click(object sender, EventArgs e)
        {
            cMainForm.VideoGrabber1.ShowDialog(VidGrab.TDialog.dlg_Multiplexer);
        }
        ...
        private void btnSaveVideoCompressorSettings_Click(object sender, EventArgs e)
        {
            ...
            SaveDlg.FileName = cMainForm.VideoGrabber1.VideoCompressorName + " (" + cMainForm.VideoGrabber1.RecordingMethod.ToString() + ").txt";
            if (SaveDlg.ShowDialog() == DialogResult.OK)
            {
                // be sure to have selected the RecordingMethod and VideoCompressor before invoking SaveCompressorSettings...

                cMainForm.VideoGrabber1.SaveCompressorSettingsToTextFile(true, cMainForm.VideoGrabber1.VideoCompressor, SaveDlg.FileName);
        ...
        private void btnSaveAudioCompressorSettings_Click(object sender, EventArgs e)
        {
            ...
            SaveDlg.FileName = cMainForm.VideoGrabber1.AudioCompressorName + " (" + cMainForm.VideoGrabber1.RecordingMethod.ToString() + ").txt";
            if (SaveDlg.ShowDialog() == DialogResult.OK)
            {
                // be sure to have selected the RecordingMethod and VideoCompressor before invoking SaveCompressorSettings...

                cMainForm.VideoGrabber1.SaveCompressorSettingsToTextFile(false, cMainForm.VideoGrabber1.AudioCompressor, SaveDlg.FileName);
        ...
        private void btnReloadVideoCompressorSettings_Click(object sender, EventArgs e)
        {
            ...
            {
                cMainForm.VideoGrabber1.LoadCompressorSettingsFromTextFile(true, cMainForm.VideoGrabber1.VideoCompressor, OpenDlg.FileName);
        ...
        private void btnReloadAudioCompressorSettings_Click(object sender, EventArgs e)
        {
            ...
            if (OpenDlg.ShowDialog() == DialogResult.OK)
            {
                cMainForm.VideoGrabber1.LoadCompressorSettingsFromTextFile(false, cMainForm.VideoGrabber1.AudioCompressor, OpenDlg.FileName);
		...
		{
			cMainForm.VideoGrabber1.CreatePreallocCapFile();
		}
		...
		{
			cMainForm.VideoGrabber1.PauseRecording();
		}
		...
		private void btnRenewRecordingFile_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.RecordingFileName = edtRecordingFileName.Text;
			}
			else 
			{
				cMainForm.VideoGrabber1.RecordingFileName = "";
			}
			cMainForm.VideoGrabber1.RecordToNewFileNow("", true);
		}

		private void btnResumeRecording_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.ResumeRecording();
		}
		...
		private void btnStartRecordingControlled_Click(object sender, System.EventArgs e)
		{
			...
			cMainForm.VideoGrabber1.HoldRecording = true;
			cMainForm.VideoGrabber1.StartRecording();
            ...
            if ((cMainForm.VideoGrabber1.RecordingTimer == VidGrab.TRecordingTimer.rt_StartRecording) & (cMainForm.VideoGrabber1.VideoSource == VidGrab.TVideoSource.vs_ScreenRecording) & (chkScreenRecordWindow.Checked == true) & (cMainForm.lngScreenRecordingWindow > 0))
            {
        ...
        {
            cMainForm.VideoGrabber1.RecordingTimer = VidGrab.TRecordingTimer.rt_Disabled;
        }

        private void rdgRecordingTimer2_CheckedChanged(object sender, EventArgs e)
        {
            cMainForm.VideoGrabber1.RecordingTimer = VidGrab.TRecordingTimer.rt_RecordToNewFile;
        }

        private void rdgRecordingTimer3_CheckedChanged(object sender, EventArgs e)
        {
            cMainForm.VideoGrabber1.RecordingTimer = VidGrab.TRecordingTimer.rt_StopRecording;
        }

        private void rdgRecordingTimer4_CheckedChanged(object sender, EventArgs e)
        {
            cMainForm.VideoGrabber1.RecordingTimer = VidGrab.TRecordingTimer.rt_StartRecording;
        }
        ...
        private void edtRecordingTimer_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                cMainForm.VideoGrabber1.RecordingTimerInterval = Convert.ToInt32(edtRecordingTimer.Text);
            }
            else
            {
                cMainForm.VideoGrabber1.RecordingTimerInterval = 0;
            }
        }
        ...
        private void btnStartRecordingImmediately_Click(object sender, System.EventArgs e)
		{
			...
			cMainForm.VideoGrabber1.HoldRecording = false; // let's start recording as soon as the graph is built.
		...
		private void edtPreallocSize_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.PreallocCapFileSizeInMB = Convert.ToInt32 (edtPreallocSize.Text);
			}
		}
		...
		private void rdgCompressMode_CheckedChanged (object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.CompressionMode = (VidGrab.TCompressionMode) Convert.ToInt32 ((sender as Control).Tag);
			}
		}
		...
		private void rdgCompressType_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.CompressionType = (VidGrab.TCompressionType) Convert.ToInt32 ((sender as Control).Tag);
			}
		}
		...
		private void rdgRecordingMethod_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.RecordingMethod = (VidGrab.TRecordingMethod) Convert.ToInt32 ((sender as Control).Tag);
                RefreshControls();
			}
		}
