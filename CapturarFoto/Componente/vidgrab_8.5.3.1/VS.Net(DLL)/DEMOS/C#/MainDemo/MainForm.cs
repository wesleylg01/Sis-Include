...
namespace MainDemo
{
    public class MainForm : WindowsFormWithTools
    {
        ...
        public VidGrab.VideoGrabber VideoGrabber1; // modified as "public" to be accessible from the sub forms
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            //((System.ComponentModel.ISupportInitialize)(this.VideoGrabber1)).BeginInit();
            ...
            // VideoGrabber1
            // 
            this.VideoGrabber1.Location = new System.Drawing.Point(245, 329);
            this.VideoGrabber1.Name = "VideoGrabber1";
            //this.VideoGrabber1.OcxState = ((System.Windows.Forms.AxHost.State)(resources.GetObject("VideoGrabber1.OcxState")));
            this.VideoGrabber1.Size = new System.Drawing.Size(408, 312);
            this.VideoGrabber1.TabIndex = 33;
            ...
            this.VideoGrabber1.OnTVChannelScanCompleted += new System.EventHandler(this.VideoGrabber1_OnTVChannelScanCompleted);
            ...
            this.VideoGrabber1.OnTVChannelScanStarted += new VidGrab.OnTVChannelScanStartedEventHandler(this.VideoGrabber1_OnTVChannelScanStarted);
            ...
            this.VideoGrabber1.OnTVChannelSelected += new VidGrab.OnTVChannelSelectedEventHandler(this.VideoGrabber1_OnTVChannelSelected);
            ...
            //this.VideoGrabber1.OnResize += new System.EventHandler(this.VideoGrabber1_OnResize);
            ...
            //((System.ComponentModel.ISupportInitialize)(this.VideoGrabber1)).EndInit();
        ...
        private void MainForm_Load(object sender, System.EventArgs e)
        {
            ...
            VideoGrabber1.Display_AutoSize = true;   // the control will resize automatically
...

            {
                ...
                if (VideoGrabber1.CurrentState == VidGrab.TCurrentState.cs_Recording)
                {
                    ...
                    {  // every 5 seconds
                        ...
                        AddLog(mmoLog, String.Format("written to disk: {0} KB", VideoGrabber1.RecordingKBytesWrittenToDisk()));
                    }
                }
            }
        }
        ...
        private void VideoGrabber1_OnResize(object sender, System.EventArgs e)
        {
            int NewWidth;
            int NewHeight;
        ...
        private void VideoGrabber1_OnTVChannelScanCompleted(object sender, System.EventArgs e)
        {
            AddLog(frmTVTuner.mmoChannelLog, "autoscan completed.");
        }

        private void VideoGrabber1_OnTVChannelScanStarted(object sender, VidGrab.TOnTVChannelScanStartedEventArgs e)
        {
            string InputType;

            InputType = " ";
            if (VideoGrabber1.TVTunerInputType == VidGrab.TTunerInputType.TunerInputCable)
            {
            ...
            AddLog(frmTVTuner.mmoChannelLog, "scanning country code " + VideoGrabber1.TVCountryCode.ToString() + " (" + InputType + ") from channel " + e.minChannel.ToString() + " to " + e.maxChannel.ToString() + "...");
        }

        private void VideoGrabber1_OnTVChannelSelected(object sender, VidGrab.TOnTVChannelSelectedEventArgs e)
        {
        ...
        private void VideoGrabber1_OnVideoFromBitmapsNextFrameNeeded(object sender, VidGrab.TOnVideoFromBitmapsNextFrameNeededEventArgs e)
        {
            ...
            if (VideoFromImagesUsePictureBox) // VideoFromImagesUsePictureBox is set in VideoFromJPEGsOrBitmaps.cs
            {
                ...
                VideoGrabber1.SendImageToVideoFromBitmaps("", BitmapHandle, CanFreeBitmapHandle, EndOfData);
            ...
            else
            {
                ...
                VideoGrabber1.SendImageToVideoFromBitmaps(ImageFile, 0, false, EndOfData);
            }
        }
        ...
        {
            if (VideoGrabber1.SendDVCommand(DvCommand))
            {
                AddLog(mmoLog, "DV command sent...");
            }
            else
            {
                if ((VideoGrabber1.CurrentState != VidGrab.TCurrentState.cs_Preview) & (VideoGrabber1.CurrentState != VidGrab.TCurrentState.cs_Recording))
                {
        ...
        {
            VideoGrabber1.ApplicationPriority = VidGrab.TApplicationPriority.ap_default;
        }
        private void mnuPriorityIdle_Click(object sender, System.EventArgs e)
        {
            VideoGrabber1.ApplicationPriority = VidGrab.TApplicationPriority.ap_idle;
        }

        private void mnuPriorityNormal_Click(object sender, System.EventArgs e)
        {
            VideoGrabber1.ApplicationPriority = VidGrab.TApplicationPriority.ap_normal;
        }

        private void mnuPriorityHigh_Click(object sender, System.EventArgs e)
        {
            VideoGrabber1.ApplicationPriority = VidGrab.TApplicationPriority.ap_high;
        }

        private void mnuPriorityRealTime_Click(object sender, System.EventArgs e)
        {
            VideoGrabber1.ApplicationPriority = VidGrab.TApplicationPriority.ap_realtime;
        }
