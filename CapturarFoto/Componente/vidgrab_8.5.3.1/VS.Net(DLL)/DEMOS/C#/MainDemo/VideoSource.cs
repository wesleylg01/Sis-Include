...
namespace MainDemo
{
	...
	public class VideoSource : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{
			AssignListToComboBox (cboVideoSource, cMainForm.VideoGrabber1.VideoSources, (int) cMainForm.VideoGrabber1.VideoSource);
			AssignListToComboBox (cboVideoDevices, cMainForm.VideoGrabber1.VideoDevices, cMainForm.VideoGrabber1.VideoDevice);

            if (cMainForm.VideoGrabber1.VideoDevice >= 0) // if a video capture device has been selected 
            {
                AssignListToComboBox(cboAnalogVideoStandard, cMainForm.VideoGrabber1.AnalogVideoStandards, cMainForm.VideoGrabber1.AnalogVideoStandard);
                AssignListToComboBox(cboVideoSizes, cMainForm.VideoGrabber1.VideoSizes, cMainForm.VideoGrabber1.VideoSize);
                AssignListToComboBox(cboVideoSubtypes, cMainForm.VideoGrabber1.VideoSubtypes, cMainForm.VideoGrabber1.VideoSubtype);
                AssignListToComboBox(cboVideoInputs, cMainForm.VideoGrabber1.VideoInputs, cMainForm.VideoGrabber1.VideoInput);

            }
			cboAnalogVideoStandard.Enabled = cMainForm.VideoGrabber1.IsAnalogVideoDecoderAvailable;
			cboVideoInputs.Enabled = cMainForm.VideoGrabber1.IsVideoCrossbarAvailable;

            btnAutoRefreshPreview.Enabled = cMainForm.VideoGrabber1.AutoRefreshPreview;
			btnAutoRefreshPreview.Checked = cMainForm.VideoGrabber1.AutoRefreshPreview;

			cboVideoSource.SelectedIndex = (int) cMainForm.VideoGrabber1.VideoSource;

			chkScreenRecordingWithCursor.Checked = cMainForm.VideoGrabber1.ScreenRecordingWithCursor;
			edtMonitorNumber.Text = cMainForm.VideoGrabber1.ScreenRecordingMonitor.ToString();

			chkReduceDVFrameRate.Checked = cMainForm.VideoGrabber1.DVReduceFrameRate;
			chkReduceDVFrameRate.Enabled = cMainForm.VideoGrabber1.IsDigitalVideoIn;

			btnStreamDialog.Enabled = ! cMainForm.VideoGrabber1.IsDigitalVideoIn;
			btnCameraControlDialog.Enabled = cMainForm.VideoGrabber1.IsCameraControlAvailable;
			btnVideoQualityDialog.Enabled = cMainForm.VideoGrabber1.IsVideoQualityAvailable;
			btnVideoControlDialog.Enabled = cMainForm.VideoGrabber1.IsVideoControlAvailable;

			edtFrameRate.Text = cMainForm.VideoGrabber1.FrameRate.ToString ("0.00");
		...
		{
			cMainForm.VideoGrabber1.AutoRefreshPreview = btnAutoRefreshPreview.Checked;
		}

		private void btnDeviceDialog_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.ShowDialog(VidGrab.TDialog.dlg_VideoDevice);
		...
		private void btnFrameRate_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.FrameRate = Convert.ToDouble (edtFrameRate.Text);
				if (cMainForm.VideoGrabber1.CurrentState == VidGrab.TCurrentState.cs_Preview) 
				{
					AddLog((cMainForm.mmoLog), "current frame rate: " + cMainForm.VideoGrabber1.CurrentFrameRate.ToString ("0.00") + " fps.");
				}
			}
		}
		...
		{
			cMainForm.VideoGrabber1.StopPreview();
		}
		...
		private void btnStreamDialog_Click(object sender, System.EventArgs e)
		{
			...
			cMainForm.VideoGrabber1.ShowDialog(VidGrab.TDialog.dlg_StreamConfig);
			RefreshControls();
		}
		...
		private void cboVideoSource_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.VideoSource = (VidGrab.TVideoSource) cboVideoSource.SelectedIndex;
			}
			else 
			{
		...
		{
			cMainForm.VideoGrabber1.AnalogVideoStandard = cboAnalogVideoStandard.SelectedIndex;
		}

		private void cboVideoDevices_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.VideoDevice = cboVideoDevices.SelectedIndex;
		...
		{
			cMainForm.VideoGrabber1.VideoInput = cboVideoInputs.SelectedIndex;
		}

		private void cboVideoSizes_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.VideoSize = cboVideoSizes.SelectedIndex;
		}

		private void cboVideoSubtypes_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.VideoSubtype = cboVideoSubtypes.SelectedIndex;
		}

		private void chkReduceDVFrameRate_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.DVReduceFrameRate = chkReduceDVFrameRate.Checked;
		}

		private void btnScreenRecordingWindow_Click(object sender, System.EventArgs e)
		{
            
            cMainForm.VideoGrabber1.SetWindowRecordingByName(edtScreenRecordingWindow.Text, chkScreenRecordingWindow.Checked);  // set to "true" for an exact and case-sensitive match
            //
            ...
            {
                cMainForm.VideoGrabber1.EnumerateWindows();
            }
		...
		{
			cMainForm.VideoGrabber1.ScreenRecordingWithCursor = chkScreenRecordingWithCursor.Checked;
		}
		...
		private void edtMonitorNumber_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.ScreenRecordingMonitor = Convert.ToInt32 (edtMonitorNumber.Text);
			}
		}
		...
		{
			cMainForm.VideoGrabber1.VideoSource_FileOrURL = edtVideoSourceFileOrUrl.Text;
		}

        private void edtSourceFileOrUrlUserName_TextChanged(object sender, System.EventArgs e)
        {
            cMainForm.VideoGrabber1.SetAuthentication (VidGrab.TAuthenticationType.at_StreamingUrl, edtSourceFileOrUrlUserName.Text, edtSourceFileOrUrlPassword.Text);
        } 
        ...
        private void rdgPreferredVideoSize_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			if ((sender as RadioButton).Checked) 
			{
				...
				cMainForm.VideoGrabber1.UseNearestVideoSize(w, h, chkStretchPreferredVideoSize.Checked); // disables the nearest size feature, uses the device's VideoSize index in the VideoSizes list
		...
		private void chk4InputsLayout_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.MultiplexedRole = VidGrab.TMultiplexedRole.mr_MultiplexedMosaic4;
			}
			else 
			{
				cMainForm.VideoGrabber1.MultiplexedRole = VidGrab.TMultiplexedRole.mr_NotMultiplexed;
			}
		}

		private void chkMultiplexedInputEmulation_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.MultiplexedInputEmulation = chk4InputsLayout.Checked;
		}
