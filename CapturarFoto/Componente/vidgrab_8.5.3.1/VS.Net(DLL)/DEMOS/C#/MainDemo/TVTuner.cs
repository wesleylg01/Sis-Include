...
namespace MainDemo
{
	...
	public class TVTuner : SubForm // SubForm is declared in CSUtil. Unlike default forms, it is not destroyed when closed, and includes also some additional tools.
    {
		...
		{
			SetRadioButtonInGroupUsingTag(rdgTunerMode, (short) cMainForm.VideoGrabber1.TunerMode);
			SetRadioButtonInGroupUsingTag(rdgTunerInputType, (short) cMainForm.VideoGrabber1.TVTunerInputType);
			edtCountryCode.Text = cMainForm.VideoGrabber1.TVCountryCode.ToString();
			edtTVChannel.Text = cMainForm.VideoGrabber1.TVChannel.ToString();
			chkEnableFrequencyOverrides.Checked = cMainForm.VideoGrabber1.TVUseFrequencyOverrides;
            lblTVTunerAvailable.Visible = !cMainForm.VideoGrabber1.IsTVTunerAvailable;
		}
		...
		private void btnSelect_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.TVChannel = Convert.ToInt32 (edtTVChannel.Text);
			}
		}
		...
		private void btnSetCountryCode_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.TVCountryCode = Convert.ToInt32(edtCountryCode.Text);
			}
		}

		private void btnStartScan_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.TVStartAutoScan();
		}

		private void btnStopScan_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.TVStopAutoScan();
		}

		private void chkEnableFrequencyOverrides_CheckedChanged(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.TVUseFrequencyOverrides = chkEnableFrequencyOverrides.Checked;
		}
		...
		private void btnSetOverride_Click(object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.TVSetChannelFrequencyOverride(Convert.ToInt32 (edtTVChannel.Text), Convert.ToInt32 (edtChannelFrequency.Text));
			}
		}
		...
		private void btnDeleteOverride_Click(object sender, System.EventArgs e)
		{
			if (IsNumeric(edtTVChannel.Text)) 
			{
				cMainForm.VideoGrabber1.TVSetChannelFrequencyOverride(Convert.ToInt32 (edtTVChannel.Text), -1);
			};
		}
		...
		private void rdgTunerMode_CheckedChanged (object sender, System.EventArgs e)
		{
			...
			{
				cMainForm.VideoGrabber1.TunerMode = (VidGrab.TTunerMode) Convert.ToInt32 ((sender as Control).Tag);
			}
		}

		private void btnResetAllOverrides_Click(object sender, System.EventArgs e)
		{
			cMainForm.VideoGrabber1.TVClearFrequencyOverrides();
		}
		...
		private void rdgTunerInputType_CheckedChanged(object sender, System.EventArgs e)
		{
			if ((sender as RadioButton).Checked) 
			{
				cMainForm.VideoGrabber1.TVTunerInputType = (VidGrab.TTunerInputType) Convert.ToInt32((sender as Control).Tag);
			}
		}
        ...
        {
            cMainForm.VideoGrabber1.ShowDialog(VidGrab.TDialog.dlg_TVTuner);
            RefreshControls();
        }
