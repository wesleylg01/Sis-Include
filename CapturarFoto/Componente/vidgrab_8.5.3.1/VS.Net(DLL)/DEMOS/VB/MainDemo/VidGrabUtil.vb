...
Module VidGrabUtil
    ...
    Public Structure TFrameInfo
        ...
        Public currentState As VidGrab.TCurrentState
        Public graphState As VidGrab.TGraphState
        Public playerState As VidGrab.TPlayerState
    ...
    Public Structure TFrameBitmapInfo
        ...
        Public LastMouseButtonClicked As VidGrab.TMouseButton
        Public reserved0 As Int32
    End Structure
