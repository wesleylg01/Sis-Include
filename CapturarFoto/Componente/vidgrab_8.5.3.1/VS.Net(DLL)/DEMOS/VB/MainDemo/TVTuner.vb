...
#End Region
    Public Sub RefreshControls()
        SetRadioButtonInGroupUsingTag(rdgTunerMode, MainForm.DefInstance.VideoGrabber1.TunerMode)
        SetRadioButtonInGroupUsingTag(rdgTunerInputType, MainForm.DefInstance.VideoGrabber1.TVTunerInputType)
        edtCountryCode.Text = MainForm.DefInstance.VideoGrabber1.TVCountryCode
        edtTVChannel.Text = MainForm.DefInstance.VideoGrabber1.TVChannel
        chkEnableFrequencyOverrides.Checked = MainForm.DefInstance.VideoGrabber1.TVUseFrequencyOverrides
        lblTVTunerAvailable.Visible = Not MainForm.DefInstance.VideoGrabber1.IsTVTunerAvailable
    End Sub
    ...
    Private Sub btnResetAllOverrides_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnResetAllOverrides.Click
        MainForm.DefInstance.VideoGrabber1.TVClearFrequencyOverrides()
    End Sub

    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        If IsNumeric(edtTVChannel.Text) Then
            MainForm.DefInstance.VideoGrabber1.TVChannel = edtTVChannel.Text
        End If
    End Sub
    ...
    Private Sub chkEnableFrequencyOverrides_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkEnableFrequencyOverrides.CheckedChanged
        MainForm.DefInstance.VideoGrabber1.TVUseFrequencyOverrides = chkEnableFrequencyOverrides.Checked
    End Sub
    ...
    Private Sub btnSetOverride_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetOverride.Click
        If IsNumeric(edtTVChannel.Text) And IsNumeric(edtChannelFrequency.Text) Then
            MainForm.DefInstance.VideoGrabber1.TVSetChannelFrequencyOverride(edtTVChannel.Text, edtChannelFrequency.Text)
        End If
    End Sub
    ...
    Private Sub btnDeleteOverride_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteOverride.Click
        If IsNumeric(edtTVChannel.Text) Then
            MainForm.DefInstance.VideoGrabber1.TVSetChannelFrequencyOverride(edtTVChannel.Text, -1)
        End If
    End Sub
    ...
    Private Sub rdgTunerInputType_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgTunerInputTypeCable.CheckedChanged, rdgTunerInputTypeAntenna.CheckedChanged
        If CType(sender, RadioButton).Checked Then
            MainForm.DefInstance.VideoGrabber1.TVTunerInputType = sender.Tag
        End If
    End Sub
    ...
    Private Sub rdgTunerMode_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgTunerModeTV.CheckedChanged, rdgTunerModeFMRadio.CheckedChanged, rdgTunerModeAMRadio.CheckedChanged, rdgTunerModeDigitalSatellite.CheckedChanged
        If CType(sender, RadioButton).Checked Then
            MainForm.DefInstance.VideoGrabber1.TunerMode = sender.Tag
        End If
    End Sub
