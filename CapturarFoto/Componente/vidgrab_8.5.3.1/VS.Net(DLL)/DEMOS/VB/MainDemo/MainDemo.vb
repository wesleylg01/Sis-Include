...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'CType(Me.VideoGrabber1, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'VideoGrabber1
        '
        Me.VideoGrabber1.Location = New System.Drawing.Point(240, 318)
        Me.VideoGrabber1.Name = "VideoGrabber1"
        'Me.VideoGrabber1.OcxState = CType(resources.GetObject("VideoGrabber1.OcxState"), System.Windows.Forms.AxHost.State)
        Me.VideoGrabber1.Size = New System.Drawing.Size(408, 312)
        ...
        'CType(Me.VideoGrabber1, System.ComponentModel.ISupportInitialize).EndInit()
...
#End If
    ...
    Private Sub VideoGrabber1_OnMotionDetected(ByVal sender As Object, ByVal e As VidGrab.TOnMotionDetectedEventArgs) Handles VideoGrabber1.OnMotionDetected
        ...
        Dim FrameBitmap As IntPtr = New IntPtr(VideoGrabber1.GetLastFrameAsHBITMAP(0, False, 0, 0, 0, 0, frmMotionDetection.imgMotionDetected.Width, frmMotionDetection.imgMotionDetected.Height, 32))
    ...
    Private Sub VideoGrabber1_OnTVChannelScanCompleted(ByVal sender As Object, ByVal e As System.EventArgs) Handles VideoGrabber1.OnTVChannelScanCompleted
        AddLog(frmTVTuner.mmoChannelLog, "autoscan completed.")
    End Sub

    Private Sub VideoGrabber1_OnTVChannelScanStarted(ByVal sender As Object, ByVal e As VidGrab.TOnTVChannelScanStartedEventArgs) Handles VideoGrabber1.OnTVChannelScanStarted
        Dim InputType As String

        InputType = " "
        Select Case VideoGrabber1.TVTunerInputType
            Case VidGrab.TTunerInputType.TunerInputCable
                InputType = "cable input"
            Case VidGrab.TTunerInputType.TunerInputAntenna
    ...
    Private Sub VideoGrabber1_OnTVChannelSelected(ByVal sender As Object, ByVal e As VidGrab.TOnTVChannelSelectedEventArgs) Handles VideoGrabber1.OnTVChannelSelected
    ...
    Private Sub SendDVCommand(ByVal DvCommand As VidGrab.TDVCommand)
        If VideoGrabber1.SendDVCommand(DvCommand) Then
            AddLog(mmoLog, "DV command sent...")
        Else
            If (VideoGrabber1.CurrentState <> VidGrab.TCurrentState.cs_Preview) And (VideoGrabber1.CurrentState <> VidGrab.TCurrentState.cs_Recording) Then
