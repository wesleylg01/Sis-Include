...
#End Region
    ...
    Private Sub btnPanTiltHome_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPanTiltHome.Click
        MainForm.DefInstance.VideoGrabber1.SendCameraCommand(0, 0, False)
    End Sub

    Private Sub btnPanTiltUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPanTiltUp.Click
        MainForm.DefInstance.VideoGrabber1.SendCameraCommand(0, 1, True)
    End Sub
    ...
    Private Sub btnPanTiltLeft_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPanTiltLeft.Click
        MainForm.DefInstance.VideoGrabber1.SendCameraCommand(-1, 0, True)
    End Sub
    ...
    Private Sub rdgGpio0_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgGpio0off.CheckedChanged, rdgGpio0on.CheckedChanged
        ...
        If rb.Checked() Then
            If CInt(rb.Tag) = 0 Then
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 0, 0)
            Else
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 0, 1)
            End If
        End If
    End Sub
    ...
    Private Sub rdgGpio1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgGpio1off.CheckedChanged, rdgGpio1on.CheckedChanged
        ...
        If rb.Checked() Then
            If CInt(rb.Tag) = 0 Then
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 1, 0)
            Else
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 1, 1)
            End If
        End If
    End Sub
    ...
    Private Sub rdgGpio2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgGpio2off.CheckedChanged, rdgGpio2on.CheckedChanged
        ...
        If rb.Checked() Then
            If CInt(rb.Tag) = 0 Then
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 2, 0)
            Else
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 2, 1)
            End If
        End If
    End Sub
    ...
    Private Sub rdgGpio3_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdgGpio3off.CheckedChanged, rdgGpio3on.CheckedChanged
        ...
        If rb.Checked() Then
            If CInt(rb.Tag) = 0 Then
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 3, 0)
            Else
                MainForm.DefInstance.VideoGrabber1.PutMiscDeviceControl(VidGrab.TMiscDeviceControl.mdc_GPIO, 3, 1)
            End If
        End If
    End Sub
