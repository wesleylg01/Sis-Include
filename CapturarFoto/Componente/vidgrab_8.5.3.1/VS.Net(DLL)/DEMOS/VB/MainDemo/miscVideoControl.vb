...
#End Region
    ...
    Public Sub RefreshControls()
        chkFlipVert.Enabled = MainForm.DefInstance.VideoGrabber1.IsVideoControlModeAvailable(VidGrab.TVideoControl.vc_FlipHorizontal)
        chkFlipHorz.Enabled = MainForm.DefInstance.VideoGrabber1.IsVideoControlModeAvailable(VidGrab.TVideoControl.vc_FlipVertical)
        chkExternalTrigger.Enabled = MainForm.DefInstance.VideoGrabber1.IsVideoControlModeAvailable(VidGrab.TVideoControl.vc_ExternalTriggerEnable)
        chkEmulateTrigger.Enabled = MainForm.DefInstance.VideoGrabber1.IsVideoControlModeAvailable(VidGrab.TVideoControl.vc_Trigger)
    End Sub
    ...
    Private Sub chk_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkFlipVert.CheckedChanged, chkFlipHorz.CheckedChanged, chkExternalTrigger.CheckedChanged, chkEmulateTrigger.CheckedChanged
        MainForm.DefInstance.VideoGrabber1.SetVideoControlMode(chkFlipHorz.Checked, chkFlipVert.Checked, chkExternalTrigger.Checked, chkEmulateTrigger.Checked)
    End Sub
